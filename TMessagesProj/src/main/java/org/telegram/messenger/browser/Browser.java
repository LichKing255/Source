...
public class Browser
{
  ...
  public static void openUrl(Context paramContext, Uri paramUri, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if ((Build.VERSION.SDK_INT >= 15) && (paramBoolean) && (MediaController.getInstance().canCustomTabs()) && (!bool))
      {
        Intent localIntent = new Intent(ApplicationLoader.applicationContext, ShareBroadcastReceiver.class);
        localIntent.setAction("android.intent.action.SEND");
        CustomTabsIntent.Builder localBuilder = new CustomTabsIntent.Builder(getSession());
        localBuilder.setToolbarColor(MihanTheme.getThemeColor());
        localBuilder.setShowTitle(true);
        localBuilder.setActionButton(BitmapFactory.decodeResource(paramContext.getResources(), 2130837536), LocaleController.getString("ShareFile", 2131166322), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, localIntent, 0), false);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\browser\Browser.class
