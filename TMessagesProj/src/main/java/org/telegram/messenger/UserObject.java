...
public class UserObject
{
  public static String getFirstName(TLRPC.User paramUser)
  {
    ...
    return LocaleController.getString("HiddenName", 2131165794);
  }
  ...
  public static String getUserName(TLRPC.User paramUser)
  {
    Object localObject;
    if ((paramUser == null) || (isDeleted(paramUser))) {
      localObject = LocaleController.getString("HiddenName", 2131165794);
    }
    do
    {
      String str;
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\UserObject.class
