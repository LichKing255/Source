  ...
  extends IntentService
{
  ...
  protected void onHandleIntent(Intent paramIntent)
  {
    try
    {
      final String str = InstanceID.getInstance(this).getToken(getString(2131166848), "GCM", null);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\GcmRegistrationIntentService.class
