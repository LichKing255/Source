    ...
    new Thread()
    {
      public void run()
      {
        try
        {
          ...
          FileLog.e("tmessages", "response code = " + ((HttpURLConnection)localObject2).getResponseCode() + " message = " + ((HttpURLConnection)localObject2).getResponseMessage());
          return;
        }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\NativeCrashManager.class
