  ...
  implements HlsTrackSelector.Output
{
  ...
  public HlsChunkSource(boolean paramBoolean, DataSource paramDataSource, HlsPlaylist paramHlsPlaylist, HlsTrackSelector paramHlsTrackSelector, BandwidthMeter paramBandwidthMeter, PtsTimestampAdjusterProvider paramPtsTimestampAdjusterProvider, int paramInt)
  {
    this(paramBoolean, paramDataSource, paramHlsPlaylist, paramHlsTrackSelector, paramBandwidthMeter, paramPtsTimestampAdjusterProvider, paramInt, 5000L, 20000L, null, null);
  }
  
  public HlsChunkSource(boolean paramBoolean, DataSource paramDataSource, HlsPlaylist paramHlsPlaylist, HlsTrackSelector paramHlsTrackSelector, BandwidthMeter paramBandwidthMeter, PtsTimestampAdjusterProvider paramPtsTimestampAdjusterProvider, int paramInt, long paramLong1, long paramLong2)
  {
    this(paramBoolean, paramDataSource, paramHlsPlaylist, paramHlsTrackSelector, paramBandwidthMeter, paramPtsTimestampAdjusterProvider, paramInt, paramLong1, paramLong2, null, null);
  }
  
  public HlsChunkSource(boolean paramBoolean, DataSource paramDataSource, HlsPlaylist paramHlsPlaylist, HlsTrackSelector paramHlsTrackSelector, BandwidthMeter paramBandwidthMeter, PtsTimestampAdjusterProvider paramPtsTimestampAdjusterProvider, int paramInt, long paramLong1, long paramLong2, Handler paramHandler, EventListener paramEventListener)
  {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\exoplayer\hls\HlsChunkSource.class
