  ...
  extends SampleSourceTrackRenderer
{
  ...
  public MediaCodecTrackRenderer(SampleSource[] paramArrayOfSampleSource, MediaCodecSelector paramMediaCodecSelector, DrmSessionManager paramDrmSessionManager, boolean paramBoolean, Handler paramHandler, EventListener paramEventListener)
  {
    ...
    throws ExoPlaybackException
  {
    ...
    //   0: aload_0
    //   1: aconst_null
    //   2: putfield 313	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:format	Lorg/telegram/messenger/exoplayer/MediaFormat;
    //   5: aload_0
    //   6: aconst_null
    //   7: putfield 570	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:drmInitData	Lorg/telegram/messenger/exoplayer/drm/DrmInitData;
    //   10: aload_0
    //   11: invokevirtual 468	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:releaseCodec	()V
    //   14: aload_0
    //   15: getfield 491	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   18: ifeq +17 -> 35
    //   21: aload_0
    //   22: getfield 119	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:drmSessionManager	Lorg/telegram/messenger/exoplayer/drm/DrmSessionManager;
    //   25: invokeinterface 659 1 0
    //   30: aload_0
    //   31: iconst_0
    //   32: putfield 491	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   35: aload_0
    //   36: invokespecial 661	org/telegram/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   39: return
    //   40: astore_1
    //   41: aload_0
    //   42: invokespecial 661	org/telegram/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   45: aload_1
    //   46: athrow
    //   47: astore_1
    //   48: aload_0
    //   49: getfield 491	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   52: ifeq +17 -> 69
    //   55: aload_0
    //   56: getfield 119	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:drmSessionManager	Lorg/telegram/messenger/exoplayer/drm/DrmSessionManager;
    //   59: invokeinterface 659 1 0
    //   64: aload_0
    //   65: iconst_0
    //   66: putfield 491	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   69: aload_0
    //   70: invokespecial 661	org/telegram/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   73: aload_1
    //   74: athrow
    //   75: astore_1
    //   76: aload_0
    //   77: invokespecial 661	org/telegram/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   80: aload_1
    //   81: athrow
  ...
  protected void releaseCodec()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   4: ifnull +133 -> 137
    //   7: aload_0
    //   8: ldc2_w 529
    //   11: putfield 443	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecHotswapTimeMs	J
    //   14: aload_0
    //   15: iconst_m1
    //   16: putfield 291	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:inputIndex	I
    //   19: aload_0
    //   20: iconst_m1
    //   21: putfield 231	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:outputIndex	I
    //   24: aload_0
    //   25: iconst_0
    //   26: putfield 311	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:waitingForKeys	Z
    //   29: aload_0
    //   30: getfield 154	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:decodeOnlyPresentationTimestamps	Ljava/util/List;
    //   33: invokeinterface 533 1 0
    //   38: aload_0
    //   39: aconst_null
    //   40: putfield 296	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:inputBuffers	[Ljava/nio/ByteBuffer;
    //   43: aload_0
    //   44: aconst_null
    //   45: putfield 252	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:outputBuffers	[Ljava/nio/ByteBuffer;
    //   48: aload_0
    //   49: iconst_0
    //   50: putfield 539	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecReconfigured	Z
    //   53: aload_0
    //   54: iconst_0
    //   55: putfield 340	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecReceivedBuffers	Z
    //   58: aload_0
    //   59: iconst_0
    //   60: putfield 603	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecIsAdaptive	Z
    //   63: aload_0
    //   64: iconst_0
    //   65: putfield 361	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsDiscardToSpsWorkaround	Z
    //   68: aload_0
    //   69: iconst_0
    //   70: putfield 535	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsFlushWorkaround	Z
    //   73: aload_0
    //   74: iconst_0
    //   75: putfield 257	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsEosPropagationWorkaround	Z
    //   78: aload_0
    //   79: iconst_0
    //   80: putfield 537	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsEosFlushWorkaround	Z
    //   83: aload_0
    //   84: iconst_0
    //   85: putfield 479	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsMonoChannelCountWorkaround	Z
    //   88: aload_0
    //   89: iconst_0
    //   90: putfield 305	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecReceivedEos	Z
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 161	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecReconfigurationState	I
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 163	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecReinitializationState	I
    //   103: aload_0
    //   104: getfield 137	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codecCounters	Lorg/telegram/messenger/exoplayer/CodecCounters;
    //   107: astore_1
    //   108: aload_1
    //   109: aload_1
    //   110: getfield 673	org/telegram/messenger/exoplayer/CodecCounters:codecReleaseCount	I
    //   113: iconst_1
    //   114: iadd
    //   115: putfield 673	org/telegram/messenger/exoplayer/CodecCounters:codecReleaseCount	I
    //   118: aload_0
    //   119: getfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   122: invokevirtual 676	android/media/MediaCodec:stop	()V
    //   125: aload_0
    //   126: getfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   129: invokevirtual 679	android/media/MediaCodec:release	()V
    //   132: aload_0
    //   133: aconst_null
    //   134: putfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   137: return
    //   138: astore_1
    //   139: aload_0
    //   140: aconst_null
    //   141: putfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   144: aload_1
    //   145: athrow
    //   146: astore_1
    //   147: aload_0
    //   148: getfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   151: invokevirtual 679	android/media/MediaCodec:release	()V
    //   154: aload_0
    //   155: aconst_null
    //   156: putfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   159: aload_1
    //   160: athrow
    //   161: astore_1
    //   162: aload_0
    //   163: aconst_null
    //   164: putfield 233	org/telegram/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   167: aload_1
    //   168: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\exoplayer\MediaCodecTrackRenderer.class
