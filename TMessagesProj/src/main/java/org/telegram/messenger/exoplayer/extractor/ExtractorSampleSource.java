  ...
  implements SampleSource, SampleSource.SampleSourceReader, ExtractorOutput, Loader.Callback
{
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (i == 0)
      {
        ...
        if (this.extractorHolder.extractor != null)
        {
          ...
          ExtractorHolder.access$002(this.extractorHolder, null);
        }
      }
      return;
    }
  ...
  private static final class ExtractorHolder
  {
      ...
      throws ExtractorSampleSource.UnrecognizedInputFormatException, IOException, java.lang.InterruptedException
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 27	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lorg/telegram/messenger/exoplayer/extractor/Extractor;
      //   4: ifnull +8 -> 12
      //   7: aload_0
      //   8: getfield 27	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lorg/telegram/messenger/exoplayer/extractor/Extractor;
      //   11: areturn
      //   12: aload_0
      ...
      //   35: aload 5
      //   37: aload_1
      //   38: invokeinterface 45 2 0
      //   43: ifeq +34 -> 77
      //   46: aload_0
      //   47: aload 5
      //   49: putfield 27	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lorg/telegram/messenger/exoplayer/extractor/Extractor;
      //   52: aload_1
      //   53: invokeinterface 50 1 0
      //   58: aload_0
      //   59: getfield 27	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lorg/telegram/messenger/exoplayer/extractor/Extractor;
      //   62: ifnonnull +50 -> 112
      //   65: new 33	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$UnrecognizedInputFormatException
      //   68: dup
      //   69: aload_0
      ...
      //   73: invokespecial 53	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$UnrecognizedInputFormatException:<init>	([Lorg/telegram/messenger/exoplayer/extractor/Extractor;)V
      //   76: athrow
      //   77: aload_1
      //   78: invokeinterface 50 1 0
      //   83: iload_2
      //   84: iconst_1
      //   85: iadd
      //   86: istore_2
      ...
      //   90: astore 5
      //   92: aload_1
      //   93: invokeinterface 50 1 0
      //   98: goto -15 -> 83
      //   101: astore 4
      //   103: aload_1
      //   104: invokeinterface 50 1 0
      //   109: aload 4
      //   111: athrow
      //   112: aload_0
      //   113: getfield 27	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lorg/telegram/messenger/exoplayer/extractor/Extractor;
      //   116: aload_0
      ...
      //   125: aload_0
      //   126: getfield 27	org/telegram/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lorg/telegram/messenger/exoplayer/extractor/Extractor;
      //   129: areturn
      // Local variable table:
      //   start	length	slot	name	signature
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\exoplayer\extractor\ExtractorSampleSource.class
