...
final class TtmlNode
{
  ...
  public List<Cue> getCues(long paramLong, Map<String, TtmlStyle> paramMap, Map<String, TtmlRegion> paramMap1)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      paramMap.add(new Cue(cleanUpText((SpannableStringBuilder)localEntry.getValue()), null, localTtmlRegion.line, Integer.MIN_VALUE, Integer.MIN_VALUE, localTtmlRegion.position, Integer.MIN_VALUE, localTtmlRegion.width));
    }
    return paramMap;
  }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\exoplayer\text\ttml\TtmlNode.class
