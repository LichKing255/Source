...
public final class VideoFormatSelectorUtil
{
  ...
  private static boolean isFormatPlayable(Format paramFormat, String[] paramArrayOfString, boolean paramBoolean)
    ...
    throws MediaCodecUtil.DecoderQueryException
  {
    ...
    while (j < n)
    {
      ...
      int k = i;
      if (isFormatPlayable(localFormat, paramArrayOfString, paramBoolean1))
      {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\exoplayer\chunk\VideoFormatSelectorUtil.class
