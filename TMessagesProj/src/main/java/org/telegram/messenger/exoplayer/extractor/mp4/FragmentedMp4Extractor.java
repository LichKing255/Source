  ...
  implements Extractor
{
  ...
  {
    Object localObject = paramTrackBundle.fragment;
    ParsableByteArray localParsableByteArray = ((TrackFragment)localObject).sampleEncryptionData;
    int i = ((TrackFragment)localObject).header.sampleDescriptionIndex;
    int j = paramTrackBundle.track.sampleDescriptionEncryptionBoxes[i].initializationVectorSize;
    int k = localObject.sampleHasSubsampleEncryptionTable[paramTrackBundle.currentSampleIndex];
    ...
    throws IOException, InterruptedException
  {
    ...
    label585:
    label590:
    for (paramExtractorInput = localTrack.sampleDescriptionEncryptionBoxes[k].keyId;; paramExtractorInput = null)
    {
  ...
  {
    return (paramInt == Atom.TYPE_hdlr) || (paramInt == Atom.TYPE_mdhd) || (paramInt == Atom.TYPE_mvhd) || (paramInt == Atom.TYPE_sidx) || (paramInt == Atom.TYPE_stsd) || (paramInt == Atom.TYPE_tfdt) || (paramInt == Atom.TYPE_tfhd) || (paramInt == Atom.TYPE_tkhd) || (paramInt == Atom.TYPE_trex) || (paramInt == Atom.TYPE_trun) || (paramInt == Atom.TYPE_pssh) || (paramInt == Atom.TYPE_saiz) || (paramInt == Atom.TYPE_saio) || (paramInt == Atom.TYPE_senc) || (paramInt == Atom.TYPE_uuid) || (paramInt == Atom.TYPE_elst) || (paramInt == Atom.TYPE_mehd);
  }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\exoplayer\extractor\mp4\FragmentedMp4Extractor.class
