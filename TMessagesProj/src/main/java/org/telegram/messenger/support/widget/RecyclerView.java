  ...
  implements ScrollingView, NestedScrollingChild
{
  ...
  void applyEdgeEffectColor(EdgeEffectCompat paramEdgeEffectCompat)
  {
    ...
    {
      FileLog.e("tmessages", paramEdgeEffectCompat);
    }
  }
  ...
  void initAdapterManager()
  {
    this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback()
    {
      ...
      public void offsetPositionsForRemovingInvisible(int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        RecyclerView.this.mItemsAddedOrRemoved = true;
        RecyclerView.State.access$1712(RecyclerView.this.mState, paramAnonymousInt2);
      }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\support\widget\RecyclerView.class
