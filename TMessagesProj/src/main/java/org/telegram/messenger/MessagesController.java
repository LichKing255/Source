  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public HashMap<Long, CharSequence> MihanPrintingStrings = new HashMap();
  ...
  public static void MihanNotificatin(String paramString, int paramInt)
  {
    int i = (int)System.currentTimeMillis();
    SharedPreferences localSharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences("SpecialNotifications", 0);
    Object localObject = new Intent(ApplicationLoader.applicationContext, LaunchActivity.class);
    ((Intent)localObject).setAction("com.tmessages.openchat" + Math.random() + Integer.MAX_VALUE);
    ((Intent)localObject).setFlags(32768);
    ((Intent)localObject).putExtra("userId", paramInt);
    localObject = PendingIntent.getActivity(ApplicationLoader.applicationContext, i, (Intent)localObject, 0);
    localObject = new NotificationCompat.Builder(ApplicationLoader.applicationContext).setSmallIcon(2130838014).setContentTitle(LocaleController.getString("AppName", 2131165338)).setAutoCancel(true).setContentText(paramString).setContentIntent((PendingIntent)localObject);
    paramInt = localSharedPreferences.getInt("vibrate_sc", 3);
    if ((paramInt == 1) || (MediaController.getInstance().isRecordingAudio())) {
      ((NotificationCompat.Builder)localObject).setVibrate(new long[] { 0L, 0L });
    }
    for (;;)
    {
      ((NotificationCompat.Builder)localObject).setLights(localSharedPreferences.getInt("color_sc", -16711936), 1000, 1000);
      paramString = null;
      Uri localUri = Settings.System.DEFAULT_NOTIFICATION_URI;
      if (localUri != null) {
        paramString = localUri.getPath();
      }
      ((NotificationCompat.Builder)localObject).setSound(Uri.parse(localSharedPreferences.getString("sound_path_sc", paramString)));
      ((NotificationManager)ApplicationLoader.applicationContext.getSystemService("notification")).notify(i, ((NotificationCompat.Builder)localObject).build());
      return;
      if (paramInt == 2) {
        ((NotificationCompat.Builder)localObject).setVibrate(new long[] { 0L, 100L, 0L, 100L });
      } else if ((paramInt == 0) || (paramInt == 4)) {
        ((NotificationCompat.Builder)localObject).setDefaults(2);
      } else if (paramInt == 3) {
        ((NotificationCompat.Builder)localObject).setVibrate(new long[] { 0L, 1000L });
      }
    }
  }
  
  protected static void addNewGifToRecent(TLRPC.Document paramDocument, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    MediaController.SearchImage localSearchImage = new MediaController.SearchImage();
    localSearchImage.type = 2;
    localSearchImage.document = paramDocument;
    localSearchImage.date = paramInt;
    localSearchImage.id = ("" + localSearchImage.document.id);
  ...
  private String getUserNameFamilyForTyping(TLRPC.User paramUser)
  {
    Object localObject2;
    if (paramUser == null) {
      localObject2 = "";
    ...
    do
    {
      do
      {
        ...
        {
          localObject1 = localObject2;
          if (paramUser.first_name.length() > 0) {
            localObject1 = "" + paramUser.first_name;
          }
        }
        localObject2 = localObject1;
      } while (paramUser.last_name == null);
      localObject2 = localObject1;
    } while (paramUser.last_name.length() <= 0);
    if (((String)localObject1).equals("")) {
      return (String)localObject1 + paramUser.last_name;
    }
    return (String)localObject1 + " " + paramUser.last_name;
  }
  ...
  public static boolean isFeatureEnabled(String paramString, BaseFragment paramBaseFragment)
  {
    ...
    if (paramBaseFragment.getParentActivity() != null)
    {
      ...
      paramString.setPositiveButton(LocaleController.getString("OK", 2131166111), null);
  ...
  public static void openByUserName(String paramString, final BaseFragment paramBaseFragment, final int paramInt)
  {
    ...
    do
    {
      ...
      if (localObject != null)
      {
        openChatOrProfileWith((TLRPC.User)localObject, null, paramBaseFragment, paramInt);
        return;
      }
    } while (paramBaseFragment.getParentActivity() == null);
    Object localObject = new ProgressDialog(paramBaseFragment.getParentActivity());
    ((ProgressDialog)localObject).setMessage(LocaleController.getString("Loading", 2131165905));
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            do
            {
              try
              {
                MessagesController.108.this.val$progressDialog.dismiss();
                MessagesController.108.this.val$fragment.setVisibleDialog(null);
                if (paramAnonymousTL_error == null)
                {
                  ...
                  {
                    MessagesController.openChatOrProfileWith(null, (TLRPC.Chat)localTL_contacts_resolvedPeer.chats.get(0), MessagesController.108.this.val$fragment, 1);
                    return;
                  }
                }
              }
              catch (Exception localException1)
              {
                ...
                MessagesController.openChatOrProfileWith((TLRPC.User)localException1.users.get(0), null, MessagesController.108.this.val$fragment, MessagesController.108.this.val$type);
                return;
              }
            } while ((MessagesController.108.this.val$fragment == null) || (MessagesController.108.this.val$fragment.getParentActivity() == null));
            try
            {
              Toast.makeText(MessagesController.108.this.val$fragment.getParentActivity(), LocaleController.getString("NoUsernameFound", 2131166029), 0).show();
              return;
            }
    ...
    ((ProgressDialog)localObject).setButton(-2, LocaleController.getString("Cancel", 2131165426), new DialogInterface.OnClickListener()
    {
  ...
  public static void openChatOrProfileWith(TLRPC.User paramUser, TLRPC.Chat paramChat, BaseFragment paramBaseFragment, int paramInt)
  {
    ...
    do
    {
      ...
      while (localObject != null)
      {
        ...
        if (paramUser != null)
        {
          localObject = getRestrictionReason(paramUser.restriction_reason);
          bool1 = bool2;
          if (paramUser.bot)
          {
            paramInt = 1;
    ...
    } while (ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).contains("hide_" + String.valueOf(l)));
    ...
    paramBaseFragment.presentFragment(new ChatActivity((Bundle)localObject), bool1);
  }
  ...
  private void updatePrintingStrings()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      if ((i > 0) || (i == 0) || (localArrayList.size() == 1))
      {
        ...
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsRecordingAudio", 2131165838, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(1));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("RecordingAudio", 2131166206));
            localHashMap3.put(Long.valueOf(l), LocaleController.formatString("IsRecordingAudio", 2131165838, new Object[] { getUserNameFamilyForTyping((TLRPC.User)localObject2) }));
          }
        }
        if ((((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageUploadAudioAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingAudio", 2131165839, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingAudio", 2131166293));
            localHashMap3.put(Long.valueOf(l), LocaleController.formatString("IsSendingAudio", 2131165839, new Object[] { getUserNameFamilyForTyping((TLRPC.User)localObject2) }));
          }
        }
        ...
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingVideo", 2131165842, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingVideoStatus", 2131166297));
            localHashMap3.put(Long.valueOf(l), LocaleController.formatString("IsSendingVideo", 2131165842, new Object[] { getUserNameFamilyForTyping((TLRPC.User)localObject2) }));
          }
        }
        if ((((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageUploadDocumentAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingFile", 2131165840, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingFile", 2131166294));
            localHashMap3.put(Long.valueOf(l), LocaleController.formatString("IsSendingFile", 2131165840, new Object[] { getUserNameFamilyForTyping((TLRPC.User)localObject2) }));
          }
        }
        if ((((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageUploadPhotoAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingPhoto", 2131165841, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingPhoto", 2131166295));
            localHashMap3.put(Long.valueOf(l), LocaleController.formatString("IsSendingPhoto", 2131165841, new Object[] { getUserNameFamilyForTyping((TLRPC.User)localObject2) }));
          }
        }
        if (i < 0) {
          localHashMap1.put(Long.valueOf(l), String.format("%s %s", new Object[] { getUserNameForTyping((TLRPC.User)localObject2), LocaleController.getString("IsTyping", 2131165843) }));
        }
        for (;;)
        {
          localHashMap2.put(Long.valueOf(l), Integer.valueOf(0));
          break;
          localHashMap1.put(Long.valueOf(l), LocaleController.getString("Typing", 2131166417));
          localHashMap3.put(Long.valueOf(l), String.format("%s %s", new Object[] { getUserNameFamilyForTyping((TLRPC.User)localObject2), LocaleController.getString("IsTyping", 2131165843) }));
        }
      }
      i = 0;
      localObject1 = "";
      ...
      {
        if (j == 1) {
          localHashMap1.put(Long.valueOf(l), String.format("%s %s", new Object[] { localObject2, LocaleController.getString("IsTyping", 2131165843) }));
        }
        for (;;)
        {
          localHashMap2.put(Long.valueOf(l), Integer.valueOf(0));
          ...
          if (localArrayList.size() > 2) {
            ...
            localHashMap1.put(Long.valueOf(l), String.format("%s %s", new Object[] { localObject2, LocaleController.getString("AreTyping", 2131165341) }));
          }
        }
      }
    }
    ...
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        ...
        MessagesController.this.MihanPrintingStrings = localHashMap3;
      }
    });
  }
          ...
          public void run(TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
          {
            if ((bool2) && ((localInputUser instanceof TLRPC.TL_inputUserSelf))) {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.joiningToChannels.remove(Integer.valueOf(MessagesController.76.this.val$chat_id));
                }
              });
            }
            if (paramAnonymousTL_error != null)
            {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                ...
                {
                  boolean bool = true;
                  if (MessagesController.76.this.val$fragment != null)
                  {
                    str = paramAnonymousTL_error.text;
                    localBaseFragment = MessagesController.76.this.val$fragment;
                    if ((MessagesController.76.this.val$isChannel) && (!MessagesController.76.this.val$isMegagroup)) {
      ...
      public void run(TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
      {
        if (paramAnonymousTL_error != null)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              if (MessagesController.68.this.val$fragment != null) {
                AlertsCreator.showAddUserAlert(paramAnonymousTL_error.text, MessagesController.68.this.val$fragment, true);
              }
              while (!paramAnonymousTL_error.text.equals("PEER_FLOOD")) {
                return;
              }
  ...
  public void changeChatAvatar(int paramInt, TLRPC.InputFile paramInputFile)
  {
    if (ChatObject.isChannel(paramInt))
    {
      ...
      if (paramInputFile != null)
      {
        ...
        ((TLRPC.TL_channels_editPhoto)localObject).photo.crop = new TLRPC.TL_inputPhotoCropAuto();
      }
      for (;;)
      {
    ...
    if (paramInputFile != null)
    {
      ...
      ((TLRPC.TL_messages_editChatPhoto)localObject).photo.crop = new TLRPC.TL_inputPhotoCropAuto();
    }
    for (;;)
    {
      paramInputFile = (TLRPC.InputFile)localObject;
      ...
      public void run()
      {
        ...
        ConnectionsManager.getInstance().sendRequest(localTL_channels_getParticipant, new RequestDelegate()
        {
          public void run(final TLObject paramAnonymous2TLObject, TLRPC.TL_error paramAnonymous2TL_error)
          {
            ...
            paramAnonymous2TL_error.to_id.channel_id = MessagesController.95.this.val$chat_id;
            paramAnonymous2TL_error.dialog_id = (-MessagesController.95.this.val$chat_id);
            ...
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
            {
              public void run()
              {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    NotificationsController.getInstance().processNewMessages(MessagesController.95.1.2.this.val$pushMessages, true);
                  }
                });
              }
            });
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                MessagesController.this.updateInterfaceWithMessages(-MessagesController.95.this.val$chat_id, localArrayList1);
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
              }
            });
          }
          ...
          public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
          {
            ...
            for (;;)
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.checkingLastMessagesDialogs.remove(Integer.valueOf(MessagesController.56.this.val$lower_id));
                }
              });
              return;
              label272:
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  TLRPC.TL_dialog localTL_dialog = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(Long.valueOf(MessagesController.56.this.val$dialog.id));
                  if ((localTL_dialog != null) && (localTL_dialog.top_message == 0)) {
                    MessagesController.this.deleteDialog(MessagesController.56.this.val$dialog.id, 3);
                  }
                }
              });
            }
  ...
  public void cleanup()
  {
    ...
    this.MihanPrintingStrings.clear();
      ...
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        if (paramAnonymousTL_error == null)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              if (!((Activity)MessagesController.66.this.val$context).isFinishing()) {}
              try
              {
                MessagesController.66.this.val$progressDialog.dismiss();
                return;
              }
              catch (Exception localException)
              {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            {
              MessagesController.66.this.val$progressDialog.dismiss();
              AlertDialog.Builder localBuilder = new AlertDialog.Builder(MessagesController.66.this.val$context);
              localBuilder.setTitle(LocaleController.getString("AppName", 2131165338));
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                for (;;)
                {
                  ...
                  return;
                  AlertsCreator.showAddUserAlert(paramAnonymousTL_error.text, MessagesController.64.this.val$fragment, false);
                }
              }
            });
            return;
            ...
            public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
            {
              if (paramUser.id == UserConfig.getClientUserId()) {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    if (!ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).contains("return_dlg_" + String.valueOf(-MessagesController.77.this.val$chat_id))) {
                      MessagesController.this.deleteDialog(-MessagesController.77.this.val$chat_id, 0);
                    }
                  }
                });
              }
  ...
  public void deleteUserPhoto(TLRPC.InputPhoto paramInputPhoto)
  {
    if (paramInputPhoto == null)
    {
      ...
      localTL_photos_updateProfilePhoto.crop = new TLRPC.TL_inputPhotoCropAuto();
  ...
  public void didReceivedNotification(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == NotificationCenter.FileDidUpload)
    {
      ...
      if ((this.uploadingAvatar != null) && (this.uploadingAvatar.equals(localObject)))
      {
        ...
        ((TLRPC.TL_photos_uploadProfilePhoto)localObject).caption = "";
        ((TLRPC.TL_photos_uploadProfilePhoto)localObject).crop = new TLRPC.TL_inputPhotoCropAuto();
        ((TLRPC.TL_photos_uploadProfilePhoto)localObject).file = paramVarArgs;
        ((TLRPC.TL_photos_uploadProfilePhoto)localObject).geo_point = new TLRPC.TL_inputGeoPointEmpty();
        ConnectionsManager.getInstance().sendRequest((TLObject)localObject, new RequestDelegate()
        {
          public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
          {
    ...
    MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
    {
      public void run()
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            NotificationsController.getInstance().processNewMessages(MessagesController.93.this.val$pushMessages, true);
          }
        });
      }
    });
          ...
          public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
          {
                ...
                public void run()
                {
                  if (!paramAnonymousTL_error.isEmpty())
                  {
                    ...
                    while (localIterator.hasNext())
                    {
                      ...
                      long[] arrayOfLong = MessagesStorage.getInstance().updateMessageStateAndId(localTL_updateMessageID.random_id, null, localTL_updateMessageID.id, 0, false, MessagesController.91.this.val$channelId);
                      if (arrayOfLong != null) {
                  ...
                  Utilities.stageQueue.postRunnable(new Runnable()
                  {
                    public void run()
                    {
                      ...
                      label299:
                      boolean bool;
                      if (((MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_channelDifference)) || ((MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_channelDifferenceEmpty)))
                      {
                        if (!MessagesController.91.2.this.val$res.new_messages.isEmpty())
                        {
                          final HashMap localHashMap = new HashMap();
                          ImageLoader.saveMessagesThumbs(MessagesController.91.2.this.val$res.new_messages);
                          final ArrayList localArrayList = new ArrayList();
                          l1 = -MessagesController.91.this.val$channelId;
                          ...
                          {
                            localObject4 = (TLRPC.Message)MessagesController.91.2.this.val$res.new_messages.get(i);
                            if ((MessagesController.91.2.this.val$channelFinal == null) || (!MessagesController.91.2.this.val$channelFinal.left)) {
                            ...
                            for (bool = true;; bool = false)
                            {
                              ...
                              if ((MessagesController.91.2.this.val$channelFinal != null) && (MessagesController.91.2.this.val$channelFinal.megagroup)) {
                                ((TLRPC.Message)localObject4).flags |= 0x80000000;
                              }
                              MessageObject localMessageObject = new MessageObject((TLRPC.Message)localObject4, MessagesController.91.2.this.val$usersDict, MessagesController.this.createdDialogIds.contains(Long.valueOf(l1)));
                              if ((!localMessageObject.isOut()) && (localMessageObject.isUnread())) {
                                localArrayList.add(localMessageObject);
                              }
                              long l2 = -MessagesController.91.this.val$channelId;
                            ...
                            public void run()
                            {
                              if (!localArrayList.isEmpty()) {
                                AndroidUtilities.runOnUIThread(new Runnable()
                                {
                                  public void run()
                                  {
                                    NotificationsController.getInstance().processNewMessages(MessagesController.91.2.2.2.this.val$pushMessages, true);
                                  }
                                });
                              }
                        ...
                        MessagesController.this.processChannelsUpdatesQueue(MessagesController.91.this.val$channelId, 1);
                        MessagesStorage.getInstance().saveChannelPts(MessagesController.91.this.val$channelId, MessagesController.91.2.this.val$res.pts);
                      }
                      for (;;)
                      {
                        MessagesController.this.gettingDifferenceChannels.remove(Integer.valueOf(MessagesController.91.this.val$channelId));
                        MessagesController.this.channelsPts.put(Integer.valueOf(MessagesController.91.this.val$channelId), Integer.valueOf(MessagesController.91.2.this.val$res.pts));
                        if ((MessagesController.91.2.this.val$res.flags & 0x2) != 0) {
                          MessagesController.this.shortPollChannels.put(MessagesController.91.this.val$channelId, (int)(System.currentTimeMillis() / 1000L) + MessagesController.91.2.this.val$res.timeout);
                        }
                        if (!MessagesController.91.2.this.val$res.isFinal) {
                          MessagesController.this.getChannelDifference(MessagesController.91.this.val$channelId);
                        }
                        FileLog.e("tmessages", "received channel difference with pts = " + MessagesController.91.2.this.val$res.pts + " channelId = " + MessagesController.91.this.val$channelId);
                        FileLog.e("tmessages", "new_messages = " + MessagesController.91.2.this.val$res.new_messages.size() + " messages = " + MessagesController.91.2.this.val$res.messages.size() + " users = " + MessagesController.91.2.this.val$res.users.size() + " chats = " + MessagesController.91.2.this.val$res.chats.size() + " other updates = " + MessagesController.91.2.this.val$res.other_updates.size());
                        if (MessagesController.91.this.val$newTaskId != 0L) {
                          MessagesStorage.getInstance().removePendingTask(MessagesController.91.this.val$newTaskId);
                        }
                        return;
                        if ((MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_channelDifferenceTooLong))
                        {
                          l1 = -MessagesController.91.this.val$channelId;
                          localObject2 = (Integer)MessagesController.this.dialogs_read_inbox_max.get(Long.valueOf(l1));
                          localObject1 = localObject2;
                          ...
                          i = 0;
                          if (i < MessagesController.91.2.this.val$res.messages.size())
                          {
                            localObject4 = (TLRPC.Message)MessagesController.91.2.this.val$res.messages.get(i);
                            ((TLRPC.Message)localObject4).dialog_id = (-MessagesController.91.this.val$channelId);
                            if ((!(((TLRPC.Message)localObject4).action instanceof TLRPC.TL_messageActionChannelCreate)) && ((MessagesController.91.2.this.val$channelFinal == null) || (!MessagesController.91.2.this.val$channelFinal.left))) {
                              if (((TLRPC.Message)localObject4).out)
                              {
                                localObject3 = localObject2;
                                label1310:
                          ...
                          MessagesStorage.getInstance().overwriteChannel(MessagesController.91.this.val$channelId, (TLRPC.TL_updates_channelDifferenceTooLong)MessagesController.91.2.this.val$res, MessagesController.91.this.val$newDialogType);
                        }
                      }
                    }
                  });
            ...
            do
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.checkChannelError(paramAnonymousTL_error.text, MessagesController.91.this.val$channelId);
                }
              });
          ...
          MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
          {
            public void run()
            {
              ...
              Utilities.stageQueue.postRunnable(new Runnable()
              {
                ...
                {
                  int i;
                  if ((!MessagesController.92.2.this.val$res.new_messages.isEmpty()) || (!MessagesController.92.2.this.val$res.new_encrypted_messages.isEmpty()))
                  {
                    final HashMap localHashMap = new HashMap();
                    Object localObject1 = MessagesController.92.2.this.val$res.new_encrypted_messages.iterator();
                    Object localObject2;
                    Object localObject3;
                    while (((Iterator)localObject1).hasNext())
                    {
                      localObject2 = (TLRPC.EncryptedMessage)((Iterator)localObject1).next();
                      localObject2 = SecretChatHelper.getInstance().decryptMessage((TLRPC.EncryptedMessage)localObject2);
                      if ((localObject2 != null) && (!((ArrayList)localObject2).isEmpty()))
                      {
                        localObject2 = ((ArrayList)localObject2).iterator();
                        while (((Iterator)localObject2).hasNext())
                        {
                          localObject3 = (TLRPC.Message)((Iterator)localObject2).next();
                          MessagesController.92.2.this.val$res.new_messages.add(localObject3);
                        }
                      }
                    }
                    ...
                    {
                      TLRPC.Message localMessage = (TLRPC.Message)MessagesController.92.2.this.val$res.new_messages.get(i);
                      if ((localMessage.action instanceof TLRPC.TL_messageActionChatDeleteUser))
                      {
                        localObject1 = (TLRPC.User)MessagesController.92.2.this.val$usersDict.get(Integer.valueOf(localMessage.action.user_id));
                      ...
                      for (localMessage.dialog_id = (-localMessage.to_id.chat_id);; localMessage.dialog_id = localMessage.to_id.user_id)
                      {
                        ...
                        localObject3 = new MessageObject(localMessage, MessagesController.92.2.this.val$usersDict, MessagesController.92.2.this.val$chatsDict, MessagesController.this.createdDialogIds.contains(Long.valueOf(localMessage.dialog_id)));
                        ...
                        if (!localArrayList.isEmpty()) {
                          AndroidUtilities.runOnUIThread(new Runnable()
                          {
                            public void run()
                            {
                              ...
                              ArrayList localArrayList = MessagesController.92.2.2.2.this.val$pushMessages;
                              if (!(MessagesController.92.2.this.val$res instanceof TLRPC.TL_updates_differenceSlice)) {}
                              for (boolean bool = true;; bool = false)
                              {
                  ...
                  if ((MessagesController.92.2.this.val$res instanceof TLRPC.TL_updates_difference))
                  {
                    MessagesController.this.gettingDifference = false;
                    MessagesStorage.lastSeqValue = MessagesController.92.2.this.val$res.state.seq;
                    MessagesStorage.lastDateValue = MessagesController.92.2.this.val$res.state.date;
                    MessagesStorage.lastPtsValue = MessagesController.92.2.this.val$res.state.pts;
                    MessagesStorage.lastQtsValue = MessagesController.92.2.this.val$res.state.qts;
                    ConnectionsManager.getInstance().setIsUpdating(false);
                    i = 0;
                    while (i < 3)
                    {
                  ...
                  if ((MessagesController.92.2.this.val$res instanceof TLRPC.TL_updates_differenceSlice))
                  {
                    MessagesStorage.lastDateValue = MessagesController.92.2.this.val$res.intermediate_state.date;
                    MessagesStorage.lastPtsValue = MessagesController.92.2.this.val$res.intermediate_state.pts;
                    MessagesStorage.lastQtsValue = MessagesController.92.2.this.val$res.intermediate_state.qts;
                  }
                  for (;;)
                  {
                    MessagesStorage.getInstance().saveDiffParams(MessagesStorage.lastSeqValue, MessagesStorage.lastPtsValue, MessagesStorage.lastDateValue, MessagesStorage.lastQtsValue);
                    FileLog.e("tmessages", "received difference with date = " + MessagesStorage.lastDateValue + " pts = " + MessagesStorage.lastPtsValue + " seq = " + MessagesStorage.lastSeqValue + " messages = " + MessagesController.92.2.this.val$res.new_messages.size() + " users = " + MessagesController.92.2.this.val$res.users.size() + " chats = " + MessagesController.92.2.this.val$res.chats.size() + " other updates = " + MessagesController.92.2.this.val$res.other_updates.size());
                    return;
                    if ((MessagesController.92.2.this.val$res instanceof TLRPC.TL_updates_differenceEmpty))
                    {
                      MessagesController.this.gettingDifference = false;
                      MessagesStorage.lastSeqValue = MessagesController.92.2.this.val$res.seq;
                      MessagesStorage.lastDateValue = MessagesController.92.2.this.val$res.date;
                      ConnectionsManager.getInstance().setIsUpdating(false);
                      i = 0;
                      while (i < 3)
                      {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            if (paramAnonymousTL_error == null)
            {
              ...
              MessagesStorage.getInstance().updateChannelUsers(MessagesController.39.this.val$chat_id.intValue(), localTL_channels_channelParticipants.participants);
              MessagesController.this.loadedFullParticipants.add(MessagesController.39.this.val$chat_id);
            }
            MessagesController.this.loadingFullParticipants.remove(MessagesController.39.this.val$chat_id);
          }
        });
      }
    });
  ...
  public void markDialogAsRead(final long paramLong, int paramInt1, final int paramInt2, final int paramInt3, boolean paramBoolean1, final boolean paramBoolean2)
  {
    int i = (int)paramLong;
          ...
          MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
          {
            public void run()
            {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  Object localObject = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(Long.valueOf(MessagesController.60.this.val$dialog_id));
                  if (localObject != null)
                  {
                  ...
                  if (!MessagesController.60.this.val$popup)
                  {
                    NotificationsController.getInstance().processReadMessages(null, MessagesController.60.this.val$dialog_id, 0, MessagesController.60.this.val$max_positive_id, false);
                    localObject = new HashMap();
                    ((HashMap)localObject).put(Long.valueOf(MessagesController.60.this.val$dialog_id), Integer.valueOf(0));
                    NotificationsController.getInstance().processDialogsUpdateRead((HashMap)localObject);
                    return;
                  }
                  NotificationsController.getInstance().processReadMessages(null, MessagesController.60.this.val$dialog_id, 0, MessagesController.60.this.val$max_positive_id, true);
                  localObject = new HashMap();
                  ((HashMap)localObject).put(Long.valueOf(MessagesController.60.this.val$dialog_id), Integer.valueOf(-1));
                  NotificationsController.getInstance().processDialogsUpdateRead((HashMap)localObject);
                }
              });
            }
          });
          if ((ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).getBoolean("ghost_mode", false)) || (paramInt2 == Integer.MAX_VALUE)) {
            break;
          }
          ConnectionsManager.getInstance().sendRequest((TLObject)localObject1, new RequestDelegate()
          {
            public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
            {
              if (paramAnonymousTL_error == null)
              {
                MessagesStorage.getInstance().processPendingRead(paramLong, paramInt3, this.val$max_date);
                if ((paramAnonymousTLObject instanceof TLRPC.TL_messages_affectedMessages))
                {
                  paramAnonymousTLObject = (TLRPC.TL_messages_affectedMessages)paramAnonymousTLObject;
                  MessagesController.this.processNewDifferenceParams(-1, paramAnonymousTLObject.pts, -1, paramAnonymousTLObject.pts_count);
                }
      ...
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              NotificationsController.getInstance().processReadMessages(null, MessagesController.63.this.val$dialog_id, MessagesController.63.this.val$max_date, 0, MessagesController.63.this.val$popup);
              Object localObject = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(Long.valueOf(MessagesController.63.this.val$dialog_id));
              if (localObject != null)
              {
                ((TLRPC.TL_dialog)localObject).unread_count = 0;
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.updateInterfaces, new Object[] { Integer.valueOf(256) });
              ...
              localObject = new HashMap();
              ((HashMap)localObject).put(Long.valueOf(MessagesController.63.this.val$dialog_id), Integer.valueOf(0));
              NotificationsController.getInstance().processDialogsUpdateRead((HashMap)localObject);
            }
          });
        }
    ...
    Utilities.stageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            MessagesController.this.putUsers(MessagesController.57.this.val$dialogsRes.users, true);
            MessagesController.this.putChats(MessagesController.57.this.val$dialogsRes.chats, true);
      ...
      public void run()
      {
        ...
        if ((paramInt3 == 1) && (parammessages_Dialogs.dialogs.size() == 0))
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              MessagesController.this.putUsers(MessagesController.54.this.val$dialogsRes.users, true);
              MessagesController.this.loadingDialogs = false;
              if (MessagesController.54.this.val$resetEnd) {
                MessagesController.this.dialogsEndReached = false;
              }
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
              MessagesController.this.loadDialogs(0, MessagesController.54.this.val$count, false);
            }
          });
          return;
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            if (MessagesController.54.this.val$loadType != 1)
            {
              MessagesController.this.applyDialogsNotificationsSettings(MessagesController.54.this.val$dialogsRes.dialogs);
              if (!UserConfig.draftsLoaded) {
                DraftQuery.loadDrafts();
              }
            }
            Object localObject1 = MessagesController.this;
            Object localObject2 = MessagesController.54.this.val$dialogsRes.users;
            if (MessagesController.54.this.val$loadType == 1)
            {
              bool = true;
              ((MessagesController)localObject1).putUsers((ArrayList)localObject2, bool);
              localObject1 = MessagesController.this;
              localObject2 = MessagesController.54.this.val$dialogsRes.chats;
              if (MessagesController.54.this.val$loadType != 1) {
                break label226;
              }
            }
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              if (MessagesController.54.this.val$encChats == null) {
                break label232;
              }
              i = 0;
              while (i < MessagesController.54.this.val$encChats.size())
              {
                localObject1 = (TLRPC.EncryptedChat)MessagesController.54.this.val$encChats.get(i);
            ...
            label232:
            if (!MessagesController.54.this.val$migrate) {
              MessagesController.this.loadingDialogs = false;
            }
            int j = 0;
            if ((MessagesController.54.this.val$migrate) && (!MessagesController.this.dialogs.isEmpty()))
            {
            ...
            for (;;)
            {
              ...
              if ((!MessagesController.54.this.val$migrate) || (i == 0) || (((TLRPC.TL_dialog)localObject4).last_message_date >= i))
              {
                Object localObject5 = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(localObject2);
                if ((MessagesController.54.this.val$loadType != 1) && ((((TLRPC.TL_dialog)localObject4).draft instanceof TLRPC.TL_draftMessage))) {
            ...
            if (MessagesController.54.this.val$migrate)
            {
              ...
              if ((MessagesController.54.this.val$loadType != 2) && (!MessagesController.54.this.val$migrate))
              {
                localObject1 = MessagesController.this;
                if (((MessagesController.54.this.val$dialogsRes.dialogs.size() != 0) && (MessagesController.54.this.val$dialogsRes.dialogs.size() == MessagesController.54.this.val$count)) || (MessagesController.54.this.val$loadType != 0)) {
                  break label1432;
                }
                bool = true;
                label1303:
              ...
              UserConfig.migrateOffsetId = MessagesController.54.this.val$offset;
              UserConfig.saveConfig(false);
              MessagesController.access$4502(MessagesController.this, false);
            ...
            for (;;)
            {
              ...
              if ((j == 0) && (MessagesController.54.this.val$loadType == 1)) {
                MessagesController.this.loadDialogs(0, MessagesController.54.this.val$count, false);
              }
            }
          }
      ...
      public void run()
      {
          ...
          else
          {
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                long l = MessagesController.51.this.val$dialog_id;
                int j = MessagesController.51.this.val$count;
                if ((MessagesController.51.this.val$load_type == 2) && (MessagesController.51.this.val$queryFromServer)) {}
                for (int i = MessagesController.51.this.val$first_unread;; i = MessagesController.51.this.val$max_id)
                {
                  localMessagesController.loadMessages(l, j, i, false, 0, MessagesController.51.this.val$classGuid, MessagesController.51.this.val$load_type, MessagesController.51.this.val$last_message_id, MessagesController.51.this.val$isChannel, MessagesController.51.this.val$loadIndex, MessagesController.51.this.val$first_unread, MessagesController.51.this.val$unread_count, MessagesController.51.this.val$last_date, MessagesController.51.this.val$queryFromServer);
                  return;
                }
              }
            });
        ...
        if (i < j)
        {
          ...
          if (paramInt1)
          {
            ...
            if ((localMessage.media.bytes != null) && ((localMessage.media.bytes.length == 0) || ((localMessage.media.bytes.length == 1) && (localMessage.media.bytes[0] < 53)))) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            MessagesController.this.putUsers(MessagesController.51.this.val$messagesRes.users, MessagesController.51.this.val$isCache);
            MessagesController.this.putChats(MessagesController.51.this.val$messagesRes.chats, MessagesController.51.this.val$isCache);
            int i = Integer.MAX_VALUE;
            int j = i;
            if (MessagesController.51.this.val$queryFromServer)
            {
              j = i;
              if (MessagesController.51.this.val$load_type == 2)
              {
                int k = 0;
                for (;;)
                {
                  j = i;
                  if (k >= MessagesController.51.this.val$messagesRes.messages.size()) {
                    break;
                  }
                  TLRPC.Message localMessage = (TLRPC.Message)MessagesController.51.this.val$messagesRes.messages.get(k);
                  j = i;
                  if (!localMessage.out)
                  {
                    j = i;
                    if (localMessage.id > MessagesController.51.this.val$first_unread)
                    {
                      j = i;
            ...
            if (j == Integer.MAX_VALUE) {
              i = MessagesController.51.this.val$first_unread;
            }
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesDidLoaded, new Object[] { Long.valueOf(MessagesController.51.this.val$dialog_id), Integer.valueOf(MessagesController.51.this.val$count), localObject3, Boolean.valueOf(MessagesController.51.this.val$isCache), Integer.valueOf(i), Integer.valueOf(MessagesController.51.this.val$last_message_id), Integer.valueOf(MessagesController.51.this.val$unread_count), Integer.valueOf(MessagesController.51.this.val$last_date), Integer.valueOf(MessagesController.51.this.val$load_type), Boolean.valueOf(MessagesController.51.this.val$isEnd), Integer.valueOf(MessagesController.51.this.val$classGuid), Integer.valueOf(MessagesController.51.this.val$loadIndex) });
            if (!localObject4.isEmpty()) {
              MessagesController.this.reloadMessages(localObject4, MessagesController.51.this.val$dialog_id);
            }
            if (!localHashMap3.isEmpty()) {
              MessagesController.this.reloadWebPages(MessagesController.51.this.val$dialog_id, localHashMap3);
            }
          }
        });
      }
  ...
  public boolean processUpdateArray(ArrayList<TLRPC.Update> paramArrayList, final ArrayList<TLRPC.User> paramArrayList1, final ArrayList<TLRPC.Chat> paramArrayList2, final boolean paramBoolean)
  {
    ...
    {
      Object localObject5 = (TLRPC.Update)paramArrayList.get(n);
      int i1;
      label640:
      Object localObject4;
      label968:
      ...
      label1238:
      boolean bool2;
      if (((localObject5 instanceof TLRPC.TL_updateNewMessage)) || ((localObject5 instanceof TLRPC.TL_updateNewChannelMessage)))
      {
        if ((localObject5 instanceof TLRPC.TL_updateNewMessage))
        {
          localObject3 = ((TLRPC.TL_updateNewMessage)localObject5).message;
        ...
        for (;;)
        {
          if (k != 0)
          {
            ...
            if (paramArrayList2 == null)
            {
              FileLog.d("tmessages", "not found chat " + k);
              return false;
              paramArrayList1 = ((TLRPC.TL_updateNewChannelMessage)localObject5).message;
              if (BuildVars.DEBUG_VERSION) {
                FileLog.d("tmessages", localObject5 + " channelId = " + paramArrayList1.to_id.channel_id);
              }
              ...
              i = ((TLRPC.Message)localObject3).to_id.user_id;
              k = i1;
              continue;
            }
            paramArrayList1 = paramArrayList2;
            if (paramArrayList2.megagroup)
            {
        ...
        else
        {
          ...
          localObject5 = (Integer)paramArrayList1.get(Long.valueOf(((TLRPC.Message)localObject3).dialog_id));
      ...
      for (;;)
      {
        ...
        if (((TLRPC.Message)localObject3).to_id.user_id == UserConfig.getClientUserId()) {
        ...
        j = i | 0x10;
        break label1403;
        if ((localObject5 instanceof TLRPC.TL_updateReadMessagesContents))
        {
          k = 0;
          for (;;)
          {
            i = j;
            bool2 = bool1;
            if (k >= ((TLRPC.Update)localObject5).messages.size()) {
              break;
            }
            localArrayList2.add(Long.valueOf(((Integer)((TLRPC.Update)localObject5).messages.get(k)).intValue()));
            k += 1;
          }
        }
        long l1;
        if (((localObject5 instanceof TLRPC.TL_updateReadHistoryInbox)) || ((localObject5 instanceof TLRPC.TL_updateReadHistoryOutbox)))
        {
          if ((localObject5 instanceof TLRPC.TL_updateReadHistoryInbox))
          {
            paramArrayList1 = ((TLRPC.TL_updateReadHistoryInbox)localObject5).peer;
            if (paramArrayList1.chat_id != 0) {
              localSparseArray3.put(-paramArrayList1.chat_id, Long.valueOf(((TLRPC.Update)localObject5).max_id));
            }
            for (l1 = -paramArrayList1.chat_id;; l1 = paramArrayList1.user_id)
            {
              ...
              if (localObject3 == null) {
                paramArrayList2 = Integer.valueOf(MessagesStorage.getInstance().getDialogReadMax(localObject5 instanceof TLRPC.TL_updateReadHistoryOutbox, l1));
              }
              paramArrayList1.put(Long.valueOf(l1), Integer.valueOf(Math.max(paramArrayList2.intValue(), ((TLRPC.Update)localObject5).max_id)));
              i = j;
              bool2 = bool1;
              break;
              localSparseArray3.put(paramArrayList1.user_id, Long.valueOf(((TLRPC.Update)localObject5).max_id));
            }
          }
          paramArrayList1 = ((TLRPC.TL_updateReadHistoryOutbox)localObject5).peer;
          if (paramArrayList1.chat_id != 0) {
            localSparseArray4.put(-paramArrayList1.chat_id, Long.valueOf(((TLRPC.Update)localObject5).max_id));
          }
          for (l1 = -paramArrayList1.chat_id;; l1 = paramArrayList1.user_id)
          {
            paramArrayList1 = this.dialogs_read_outbox_max;
            break;
            localSparseArray4.put(paramArrayList1.user_id, Long.valueOf(((TLRPC.Update)localObject5).max_id));
          }
        }
        if ((localObject5 instanceof TLRPC.TL_updateDeleteMessages))
        {
          ...
          paramArrayList1.addAll(((TLRPC.Update)localObject5).messages);
          i = j;
          bool2 = bool1;
        }
        else
        {
          long l2;
          if (((localObject5 instanceof TLRPC.TL_updateUserTyping)) || ((localObject5 instanceof TLRPC.TL_updateChatUserTyping)))
          {
            i = j;
            bool2 = bool1;
            if (((TLRPC.Update)localObject5).user_id != UserConfig.getClientUserId())
            {
              l2 = -((TLRPC.Update)localObject5).chat_id;
              l1 = l2;
              if (l2 == 0L) {
                l1 = ((TLRPC.Update)localObject5).user_id;
              }
              paramArrayList2 = (ArrayList)this.printingUsers.get(Long.valueOf(l1));
              if ((((TLRPC.Update)localObject5).action instanceof TLRPC.TL_sendMessageCancelAction))
              {
                bool2 = bool1;
                if (paramArrayList2 != null)
                {
                  ...
                  {
                    if (((PrintingUser)paramArrayList2.get(i)).userId != ((TLRPC.Update)localObject5).user_id) {
                      break label2249;
                    }
              ...
              for (;;)
              {
                this.onlinePrivacy.put(Integer.valueOf(((TLRPC.Update)localObject5).user_id), Integer.valueOf(ConnectionsManager.getInstance().getCurrentTime()));
                i = j;
                break;
                label2249:
                i += 1;
                ...
                } while (((PrintingUser)localObject3).userId != ((TLRPC.Update)localObject5).user_id);
                i = 1;
                ((PrintingUser)localObject3).lastTime = l3;
                if (((PrintingUser)localObject3).action.getClass() != ((TLRPC.Update)localObject5).action.getClass()) {
                  bool1 = true;
                }
                ((PrintingUser)localObject3).action = ((TLRPC.Update)localObject5).action;
                bool2 = bool1;
                if (i == 0)
                {
                  paramArrayList2 = new PrintingUser();
                  paramArrayList2.userId = ((TLRPC.Update)localObject5).user_id;
                  paramArrayList2.lastTime = l3;
                  paramArrayList2.action = ((TLRPC.Update)localObject5).action;
          ...
          else if ((localObject5 instanceof TLRPC.TL_updateChatParticipants))
          {
            i = j | 0x20;
            localArrayList3.add(((TLRPC.Update)localObject5).participants);
            bool2 = bool1;
          }
          else if ((localObject5 instanceof TLRPC.TL_updateUserStatus))
          {
            i = j | 0x4;
            localArrayList4.add(localObject5);
            bool2 = bool1;
          }
          else if ((localObject5 instanceof TLRPC.TL_updateUserName))
          {
            i = j | 0x1;
            localArrayList4.add(localObject5);
            bool2 = bool1;
          ...
          {
            i = j | 0x2;
            MessagesStorage.getInstance().clearUserPhotos(((TLRPC.Update)localObject5).user_id);
            localArrayList4.add(localObject5);
            bool2 = bool1;
          }
          ...
          else if ((localObject5 instanceof TLRPC.TL_updateContactRegistered))
          {
            i = j;
            bool2 = bool1;
            if (this.enableJoined)
            {
              i = j;
              bool2 = bool1;
              if (((ConcurrentHashMap)localObject1).containsKey(Integer.valueOf(((TLRPC.Update)localObject5).user_id)))
              {
                i = j;
                bool2 = bool1;
                if (!MessagesStorage.getInstance().isDialogHasMessages(((TLRPC.Update)localObject5).user_id))
                {
                  ...
                  ((TLRPC.TL_messageService)localObject3).date = ((TLRPC.Update)localObject5).date;
                  ((TLRPC.TL_messageService)localObject3).from_id = ((TLRPC.Update)localObject5).user_id;
                  ...
                  ((TLRPC.TL_messageService)localObject3).dialog_id = ((TLRPC.Update)localObject5).user_id;
                  localArrayList7.add(localObject3);
          ...
          else if ((localObject5 instanceof TLRPC.TL_updateContactLink))
          {
            if ((((TLRPC.Update)localObject5).my_link instanceof TLRPC.TL_contactLinkContact))
            {
              i = localArrayList5.indexOf(Integer.valueOf(-((TLRPC.Update)localObject5).user_id));
              if (i != -1) {
                localArrayList5.remove(i);
              }
              i = j;
              bool2 = bool1;
              if (!localArrayList5.contains(Integer.valueOf(((TLRPC.Update)localObject5).user_id)))
              {
                localArrayList5.add(Integer.valueOf(((TLRPC.Update)localObject5).user_id));
                i = j;
                bool2 = bool1;
              }
            }
          ...
          else if ((localObject5 instanceof TLRPC.TL_updateNewAuthorization))
          {
            i = j;
            bool2 = bool1;
            if (!MessagesStorage.getInstance().hasAuthMessage(((TLRPC.Update)localObject5).date))
            {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
              ...
              ((TLRPC.TL_messageService)localObject3).action.title = ((TLRPC.Update)localObject5).device;
              ((TLRPC.TL_messageService)localObject3).action.address = ((TLRPC.Update)localObject5).location;
              i = UserConfig.getNewMessageId();
              ((TLRPC.TL_messageService)localObject3).id = i;
              ((TLRPC.TL_messageService)localObject3).local_id = i;
              UserConfig.saveConfig(false);
          ...
          else
          {
            i = j;
            bool2 = bool1;
            if (!(localObject5 instanceof TLRPC.TL_updateNewGeoChatMessage)) {
              if ((localObject5 instanceof TLRPC.TL_updateNewEncryptedMessage))
              {
                localObject3 = SecretChatHelper.getInstance().decryptMessage(((TLRPC.TL_updateNewEncryptedMessage)localObject5).message);
                i = j;
                bool2 = bool1;
                if (localObject3 != null)
                {
                  ...
                  {
                    l1 = ((TLRPC.TL_updateNewEncryptedMessage)localObject5).message.chat_id << 32;
              ...
              else if ((localObject5 instanceof TLRPC.TL_updateEncryptedChatTyping))
              {
                paramArrayList1 = getEncryptedChatDB(((TLRPC.Update)localObject5).chat_id);
                i = j;
                bool2 = bool1;
                if (paramArrayList1 != null)
                {
                  ((TLRPC.Update)localObject5).user_id = paramArrayList1.user_id;
                  l1 = ((TLRPC.Update)localObject5).chat_id << 32;
                  paramArrayList2 = (ArrayList)this.printingUsers.get(Long.valueOf(l1));
                  paramArrayList1 = paramArrayList2;
                  if (paramArrayList2 == null)
                  {
              ...
              else if ((localObject5 instanceof TLRPC.TL_updateEncryptedMessagesRead))
              {
                localHashMap4.put(Integer.valueOf(((TLRPC.Update)localObject5).chat_id), Integer.valueOf(Math.max(((TLRPC.Update)localObject5).max_date, ((TLRPC.Update)localObject5).date)));
                localArrayList1.add((TLRPC.TL_updateEncryptedMessagesRead)localObject5);
                i = j;
                bool2 = bool1;
              }
              else if ((localObject5 instanceof TLRPC.TL_updateChatParticipantAdd))
              {
                MessagesStorage.getInstance().updateChatInfo(((TLRPC.Update)localObject5).chat_id, ((TLRPC.Update)localObject5).user_id, 0, ((TLRPC.Update)localObject5).inviter_id, ((TLRPC.Update)localObject5).version);
                i = j;
                bool2 = bool1;
              }
              else if ((localObject5 instanceof TLRPC.TL_updateChatParticipantDelete))
              {
                MessagesStorage.getInstance().updateChatInfo(((TLRPC.Update)localObject5).chat_id, ((TLRPC.Update)localObject5).user_id, 1, 0, ((TLRPC.Update)localObject5).version);
                i = j;
                bool2 = bool1;
              }
              else if ((localObject5 instanceof TLRPC.TL_updateDcOptions))
              {
                ConnectionsManager.getInstance().updateDcSettings();
                i = j;
                bool2 = bool1;
              }
              else if ((localObject5 instanceof TLRPC.TL_updateEncryption))
              {
                SecretChatHelper.getInstance().processUpdateEncryption((TLRPC.TL_updateEncryption)localObject5, (ConcurrentHashMap)localObject1);
                i = j;
                bool2 = bool1;
              }
              else
              {
                if ((localObject5 instanceof TLRPC.TL_updateUserBlocked))
                {
                  paramArrayList1 = (TLRPC.TL_updateUserBlocked)localObject5;
                    ...
                    MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
                    {
                      public void run()
                      {
                        AndroidUtilities.runOnUIThread(new Runnable()
                        {
                          public void run()
                          {
                            if (MessagesController.104.this.val$finalUpdate.blocked) {
                              if (!MessagesController.this.blockedUsers.contains(Integer.valueOf(MessagesController.104.this.val$finalUpdate.user_id))) {
                                MessagesController.this.blockedUsers.add(Integer.valueOf(MessagesController.104.this.val$finalUpdate.user_id));
                              }
                            }
                            for (;;)
                            {
                              NotificationCenter.getInstance().postNotificationName(NotificationCenter.blockedUsersDidLoaded, new Object[0]);
                              return;
                              MessagesController.this.blockedUsers.remove(Integer.valueOf(MessagesController.104.this.val$finalUpdate.user_id));
                            }
                          }
                        });
                      }
                ...
                if ((localObject5 instanceof TLRPC.TL_updateNotifySettings))
                {
                  localArrayList4.add(localObject5);
                  i = j;
                  bool2 = bool1;
                }
                else if ((localObject5 instanceof TLRPC.TL_updateServiceNotification))
                {
                  paramArrayList1 = (TLRPC.TL_updateServiceNotification)localObject5;
                  ...
                  ((TLRPC.TL_message)localObject3).media = ((TLRPC.Update)localObject5).media;
                ...
                else if ((localObject5 instanceof TLRPC.TL_updatePrivacy))
                {
                  localArrayList4.add(localObject5);
                  i = j;
                  bool2 = bool1;
                }
                else if ((localObject5 instanceof TLRPC.TL_updateWebPage))
                {
                  localHashMap2.put(Long.valueOf(((TLRPC.Update)localObject5).webpage.id), ((TLRPC.Update)localObject5).webpage);
                  i = j;
                  bool2 = bool1;
                }
                else if ((localObject5 instanceof TLRPC.TL_updateChannelTooLong))
                {
                  if (BuildVars.DEBUG_VERSION) {
                    FileLog.d("tmessages", localObject5 + " channelId = " + ((TLRPC.Update)localObject5).channel_id);
                  }
                  paramArrayList2 = (Integer)this.channelsPts.get(Integer.valueOf(((TLRPC.Update)localObject5).channel_id));
                  paramArrayList1 = paramArrayList2;
                  if (paramArrayList2 == null)
                  {
                    localObject3 = Integer.valueOf(MessagesStorage.getInstance().getChannelPtsSync(((TLRPC.Update)localObject5).channel_id));
                    if (((Integer)localObject3).intValue() != 0) {
                      break label4756;
                    }
                    paramArrayList2 = (TLRPC.Chat)((ConcurrentHashMap)localObject2).get(Integer.valueOf(((TLRPC.Update)localObject5).channel_id));
                    if (paramArrayList2 != null)
                    {
                      paramArrayList1 = paramArrayList2;
                      if (!paramArrayList2.min) {}
                    ...
                    {
                      paramArrayList1 = getChat(Integer.valueOf(((TLRPC.Update)localObject5).channel_id));
                    }
                    if (paramArrayList1 != null)
                    {
                      paramArrayList2 = paramArrayList1;
                    ...
                    {
                      paramArrayList2 = MessagesStorage.getInstance().getChatSync(((TLRPC.Update)localObject5).channel_id);
                      putChat(paramArrayList2, true);
                    }
                  ...
                  for (paramArrayList1 = (ArrayList<TLRPC.User>)localObject3;; paramArrayList1 = (ArrayList<TLRPC.User>)localObject3)
                  {
                    ...
                    i = j;
                    bool2 = bool1;
                    if (((TLRPC.Update)localObject5).pts <= paramArrayList1.intValue()) {
                      break;
                    }
                    getChannelDifference(((TLRPC.Update)localObject5).channel_id);
                    i = j;
                    bool2 = bool1;
                    break;
                    label4756:
                    this.channelsPts.put(Integer.valueOf(((TLRPC.Update)localObject5).channel_id), localObject3);
                  }
                  label4780:
                  getChannelDifference(((TLRPC.Update)localObject5).channel_id);
                  i = j;
                ...
                {
                  if (((localObject5 instanceof TLRPC.TL_updateReadChannelInbox)) || ((localObject5 instanceof TLRPC.TL_updateReadChannelOutbox)))
                  {
                    l1 = ((TLRPC.Update)localObject5).max_id | ((TLRPC.Update)localObject5).channel_id << 32;
                    l2 = -((TLRPC.Update)localObject5).channel_id;
                    if ((localObject5 instanceof TLRPC.TL_updateReadChannelInbox))
                    {
                      paramArrayList1 = this.dialogs_read_inbox_max;
                      localSparseArray3.put(-((TLRPC.Update)localObject5).channel_id, Long.valueOf(l1));
                    }
                    for (;;)
                    {
                      ...
                      paramArrayList2 = (ArrayList<TLRPC.Chat>)localObject3;
                      if (localObject3 == null) {
                        paramArrayList2 = Integer.valueOf(MessagesStorage.getInstance().getDialogReadMax(localObject5 instanceof TLRPC.TL_updateReadChannelOutbox, l2));
                      }
                      paramArrayList1.put(Long.valueOf(l2), Integer.valueOf(Math.max(paramArrayList2.intValue(), ((TLRPC.Update)localObject5).max_id)));
                      i = j;
                      bool2 = bool1;
                      break;
                      paramArrayList1 = this.dialogs_read_outbox_max;
                      localSparseArray4.put(-((TLRPC.Update)localObject5).channel_id, Long.valueOf(l1));
                    }
                  }
                  if ((localObject5 instanceof TLRPC.TL_updateDeleteChannelMessages))
                  {
                    if (BuildVars.DEBUG_VERSION) {
                      FileLog.d("tmessages", localObject5 + " channelId = " + ((TLRPC.Update)localObject5).channel_id);
                    }
                    paramArrayList2 = (ArrayList)localSparseArray1.get(((TLRPC.Update)localObject5).channel_id);
                    paramArrayList1 = paramArrayList2;
                    if (paramArrayList2 == null)
                    {
                      paramArrayList1 = new ArrayList();
                      localSparseArray1.put(((TLRPC.Update)localObject5).channel_id, paramArrayList1);
                    }
                    paramArrayList1.addAll(((TLRPC.Update)localObject5).messages);
                    i = j;
                    bool2 = bool1;
                  }
                  else if ((localObject5 instanceof TLRPC.TL_updateChannel))
                  {
                    if (BuildVars.DEBUG_VERSION) {
                      FileLog.d("tmessages", localObject5 + " channelId = " + ((TLRPC.Update)localObject5).channel_id);
                    }
                  ...
                  else if ((localObject5 instanceof TLRPC.TL_updateChannelMessageViews))
                  {
                    if (BuildVars.DEBUG_VERSION) {
                      FileLog.d("tmessages", localObject5 + " channelId = " + ((TLRPC.Update)localObject5).channel_id);
                    }
                    localObject3 = (TLRPC.TL_updateChannelMessageViews)localObject5;
                    paramArrayList2 = (SparseIntArray)localSparseArray2.get(((TLRPC.Update)localObject5).channel_id);
                    paramArrayList1 = paramArrayList2;
                    if (paramArrayList2 == null)
                    {
                      paramArrayList1 = new SparseIntArray();
                      localSparseArray2.put(((TLRPC.Update)localObject5).channel_id, paramArrayList1);
                    }
                    paramArrayList1.put(((TLRPC.TL_updateChannelMessageViews)localObject3).id, ((TLRPC.Update)localObject5).views);
                    i = j;
                    bool2 = bool1;
                  }
                  else
                  {
                    if ((localObject5 instanceof TLRPC.TL_updateChatParticipantAdmin))
                    {
                      paramArrayList1 = MessagesStorage.getInstance();
                      k = ((TLRPC.Update)localObject5).chat_id;
                      i1 = ((TLRPC.Update)localObject5).user_id;
                      if (((TLRPC.Update)localObject5).is_admin) {}
                      for (i = 1;; i = 0)
                      {
                        paramArrayList1.updateChatInfo(k, i1, 2, i, ((TLRPC.Update)localObject5).version);
                        i = j;
                        bool2 = bool1;
                        break;
                      }
                    ...
                    else if ((localObject5 instanceof TLRPC.TL_updateStickerSetsOrder))
                    {
                      localArrayList4.add(localObject5);
                      i = j;
                      bool2 = bool1;
                    ...
                    else if ((localObject5 instanceof TLRPC.TL_updateDraftMessage))
                    {
                      localArrayList4.add(localObject5);
                      i = j;
                      bool2 = bool1;
                    ...
                    {
                      if (((localObject5 instanceof TLRPC.TL_updateEditChannelMessage)) || ((localObject5 instanceof TLRPC.TL_updateEditMessage)))
                      {
                        if ((localObject5 instanceof TLRPC.TL_updateEditChannelMessage))
                        {
                          localObject4 = ((TLRPC.TL_updateEditChannelMessage)localObject5).message;
                          if (BuildVars.DEBUG_VERSION) {
                            FileLog.d("tmessages", localObject5 + " channelId = " + ((TLRPC.Message)localObject4).to_id.channel_id);
                          }
                          ...
                          if (!paramBoolean)
                          {
                            k = paramArrayList2.entities.size();
                            i = 0;
                          }
                        }
                        else
                        {
                          for (;;)
                          {
                            ...
                            {
                              i1 = ((TLRPC.TL_messageEntityMentionName)paramArrayList1).user_id;
                              localObject3 = (TLRPC.User)((ConcurrentHashMap)localObject1).get(Integer.valueOf(i1));
                              if (localObject3 != null)
                              {
                                paramArrayList1 = (ArrayList<TLRPC.User>)localObject3;
                              ...
                              {
                                paramArrayList1 = getUser(Integer.valueOf(i1));
                              }
                              if (paramArrayList1 != null)
                              {
                                localObject3 = paramArrayList1;
                              ...
                              {
                                localObject3 = MessagesStorage.getInstance().getUserSync(i1);
                                paramArrayList1 = (ArrayList<TLRPC.User>)localObject3;
                                if (localObject3 != null)
                                {
                                  paramArrayList1 = (ArrayList<TLRPC.User>)localObject3;
                              ...
                              {
                                return false;
                                paramArrayList2 = ((TLRPC.TL_updateEditMessage)localObject5).message;
                                break;
                              }
                            }
                            i += 1;
                      ...
                      i = j;
                      bool2 = bool1;
                      if ((localObject5 instanceof TLRPC.TL_updateChannelPinnedMessage))
                      {
                        if (BuildVars.DEBUG_VERSION) {
                          FileLog.d("tmessages", localObject5 + " channelId = " + ((TLRPC.Update)localObject5).channel_id);
                        }
                        paramArrayList1 = (TLRPC.TL_updateChannelPinnedMessage)localObject5;
                        MessagesStorage.getInstance().updateChannelPinnedMessage(((TLRPC.Update)localObject5).channel_id, paramArrayList1.id);
                        i = j;
                        bool2 = bool1;
                      }
                    }
      ...
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              NotificationsController.getInstance().processNewMessages(MessagesController.105.this.val$pushMessages, true);
            }
          });
        }
      });
      ...
      public void run()
      {
        ...
        if (!localArrayList4.isEmpty())
        {
          ...
          if (m < localArrayList4.size())
          {
            ...
            new UpdateBiz().insertUpdate((TLRPC.User)localObject6, (TLRPC.Update)localObject5);
            SharedPreferences localSharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0);
            boolean bool1 = localSharedPreferences.getBoolean("specific_contact", false);
            boolean bool2 = localSharedPreferences.contains("specific_c" + ((TLRPC.Update)localObject5).user_id);
            ...
            do
            {
              for (;;)
              {
                ...
                if ((((TLRPC.Update)localObject5).key instanceof TLRPC.TL_privacyKeyChatInvite))
                {
                  ...
                  if ((localObject5 instanceof TLRPC.TL_updateUserStatus))
                  {
                    ...
                    n = i;
                    if (((TLRPC.Update)localObject5).status.expires == -1) {
                      n = 1;
                    }
                    localObject2 = localObject1;
                    i1 = j;
                    ...
                    if (bool1)
                    {
                      ...
                      if (bool2)
                      {
                        ...
                        {
                          i = i2;
                          if (((TLRPC.User)localObject6).status != null)
                          {
                            i = i2;
                            if (((TLRPC.User)localObject6).status.expires <= 0)
                            {
                              i = i2;
                              if (MessagesController.getInstance().onlinePrivacy.containsKey(Integer.valueOf(((TLRPC.User)localObject6).id))) {
                                i = 1;
                              }
                            }
                          }
                        }
                        if (((TLRPC.User)localObject6).status.expires > ConnectionsManager.getInstance().getCurrentTime()) {
                          i = 1;
                        }
                        if ((n == 0) && (i != 0))
                        {
                          MessagesController.MihanNotificatin(ContactsController.formatName(((TLRPC.User)localObject6).first_name, ((TLRPC.User)localObject6).last_name) + " " + LocaleController.getString("GetOnline", 2131166638), ((TLRPC.User)localObject6).id);
                          localObject2 = localObject1;
                          i1 = j;
                          i = k;
                        }
                        else
                        {
                          ...
                          if (n == 0)
                          {
                            MessagesController.MihanNotificatin(ContactsController.formatName(((TLRPC.User)localObject6).first_name, ((TLRPC.User)localObject6).last_name) + " " + LocaleController.getString("GetOffline", 2131166637), ((TLRPC.User)localObject6).id);
                            localObject2 = localObject1;
                            i1 = j;
                            i = k;
                          }
                  ...
                  else if ((localObject5 instanceof TLRPC.TL_updateUserPhoto))
                  {
                    ...
                    if (bool1)
                    {
                      ...
                      if (bool2)
                      {
                        MessagesController.MihanNotificatin(ContactsController.formatName(((TLRPC.User)localObject6).first_name, ((TLRPC.User)localObject6).last_name) + " " + LocaleController.getString("changed_photo", 2131166829), ((TLRPC.User)localObject6).id);
                        localObject2 = localObject1;
                        i1 = j;
                        i = k;
                      }
                  ...
                  else if ((localObject5 instanceof TLRPC.TL_updateUserPhone))
                  {
                    ...
                    if (bool1)
                    {
                      ...
                      if (bool2)
                      {
                        MessagesController.MihanNotificatin(ContactsController.formatName(((TLRPC.User)localObject6).first_name, ((TLRPC.User)localObject6).last_name) + " " + LocaleController.getString("changed_phone", 2131166828), ((TLRPC.User)localObject6).id);
                        localObject2 = localObject1;
                        i1 = j;
                        i = k;
                      }
                  ...
                  else if ((localObject5 instanceof TLRPC.TL_updateNotifySettings))
                  {
                    ...
                    if ((((TLRPC.Update)localObject5).notify_settings instanceof TLRPC.TL_peerNotifySettings))
                    {
                      ...
                      if ((((TLRPC.TL_updateNotifySettings)localObject6).peer instanceof TLRPC.TL_notifyPeer))
                      {
                        ...
                        for (;;)
                        {
                          MessagesStorage.getInstance().setDialogFlags(l1, i << 32 | 1L);
                  ...
                  else
                  {
                    ...
                    {
                      StickersQuery.reorderStickers(((TLRPC.Update)localObject5).order);
                      localObject2 = localObject1;
                      i1 = j;
                      i = k;
                    }
              ...
              i1 = j;
              i = k;
            } while (!(localObject5 instanceof TLRPC.TL_updateDraftMessage));
            int i1 = 1;
        ...
        for (;;)
        {
          ...
          {
            localObject5 = (MessageObject)((ArrayList)localObject3).get(j);
      ...
      public void run()
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            int k;
            Object localObject1;
            if ((MessagesController.107.this.val$markAsReadMessagesInbox.size() != 0) || (MessagesController.107.this.val$markAsReadMessagesOutbox.size() != 0))
            {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesRead, new Object[] { MessagesController.107.this.val$markAsReadMessagesInbox, MessagesController.107.this.val$markAsReadMessagesOutbox });
              NotificationsController.getInstance().processReadMessages(MessagesController.107.this.val$markAsReadMessagesInbox, 0L, 0, 0, false);
              k = 0;
              i = j;
              j = k;
              int m;
              while (j < MessagesController.107.this.val$markAsReadMessagesInbox.size())
              {
                k = MessagesController.107.this.val$markAsReadMessagesInbox.keyAt(j);
                m = (int)((Long)MessagesController.107.this.val$markAsReadMessagesInbox.get(k)).longValue();
              ...
              {
                i = j;
                if (k >= MessagesController.107.this.val$markAsReadMessagesOutbox.size()) {
                  break;
                }
                i = MessagesController.107.this.val$markAsReadMessagesOutbox.keyAt(k);
                m = (int)((Long)MessagesController.107.this.val$markAsReadMessagesOutbox.get(i)).longValue();
            ...
            j = i;
            Object localObject2;
            if (!MessagesController.107.this.val$markAsReadEncrypted.isEmpty())
            {
              localObject1 = MessagesController.107.this.val$markAsReadEncrypted.entrySet().iterator();
              for (;;)
              {
                j = i;
                if (!((Iterator)localObject1).hasNext()) {
            ...
            if (!MessagesController.107.this.val$markAsReadMessages.isEmpty()) {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesReadContent, new Object[] { MessagesController.107.this.val$markAsReadMessages });
            }
            if (MessagesController.107.this.val$deletedMessages.size() != 0)
            {
              i = 0;
              if (i < MessagesController.107.this.val$deletedMessages.size())
              {
                k = MessagesController.107.this.val$deletedMessages.keyAt(i);
                localObject1 = (ArrayList)MessagesController.107.this.val$deletedMessages.get(k);
                if (localObject1 == null) {}
                label860:
                for (;;)
                {
              ...
              NotificationsController.getInstance().removeDeletedMessagesFromNotifications(MessagesController.107.this.val$deletedMessages);
            }
            if (j != 0) {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.updateInterfaces, new Object[] { Integer.valueOf(j) });
            }
      ...
      if (((paramUpdates instanceof TLRPC.TL_updateShortChatMessage)) || ((paramUpdates instanceof TLRPC.TL_updateShortMessage)))
      {
        ...
        if (MessagesStorage.lastPtsValue + paramUpdates.pts_count == paramUpdates.pts)
        {
          ...
          if ((paramUpdates instanceof TLRPC.TL_updateShortMessage)) {
            if (paramUpdates.out)
            {
              ((TLRPC.TL_message)localObject4).from_id = UserConfig.getClientUserId();
              ...
              MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
              {
                public void run()
                {
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      NotificationsController.getInstance().processNewMessages(MessagesController.98.this.val$objArr, true);
                    }
                  });
                }
              });
      ...
      ConnectionsManager.getInstance().sendRequest(paramHashMap, new RequestDelegate()
      {
        public void run(final TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ArrayList localArrayList = (ArrayList)MessagesController.this.reloadingWebpages.remove(MessagesController.50.this.val$url);
              ...
              MessagesStorage.getInstance().putMessages(localTL_messages_messages, MessagesController.50.this.val$dialog_id, -2, 0, false);
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.replaceMessagesObjects, new Object[] { Long.valueOf(MessagesController.50.this.val$dialog_id), localArrayList });
            }
          });
        }
      });
  ...
  public MediaController.SearchImage saveGif(TLRPC.Document paramDocument)
  {
    MediaController.SearchImage localSearchImage = new MediaController.SearchImage();
    localSearchImage.type = 2;
    localSearchImage.document = paramDocument;
    ...
    localSearchImage.id = ("" + localSearchImage.document.id);
    paramDocument = new ArrayList();
    paramDocument.add(localSearchImage);
    MessagesStorage.getInstance().putWebRecent(paramDocument);
    paramDocument = new TLRPC.TL_messages_saveGif();
    paramDocument.id = new TLRPC.TL_inputDocument();
    paramDocument.id.id = localSearchImage.document.id;
    paramDocument.id.access_hash = localSearchImage.document.access_hash;
    paramDocument.unsave = false;
    ConnectionsManager.getInstance().sendRequest(paramDocument, new RequestDelegate()
    {
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error) {}
    });
    return localSearchImage;
  }
            ...
            paramInt1 = ConnectionsManager.getInstance().sendRequest((TLObject)localObject2, new RequestDelegate()
            {
              public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
              {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    HashMap localHashMap = (HashMap)MessagesController.this.sendingTypings.get(Integer.valueOf(MessagesController.47.this.val$action));
                    if (localHashMap != null) {
                      localHashMap.remove(Long.valueOf(MessagesController.47.this.val$dialog_id));
                    }
                  }
                });
              }
      ...
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        if ((paramAnonymousTLObject instanceof TLRPC.TL_boolTrue)) {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              MessagesController.71.this.val$info.about = MessagesController.71.this.val$about;
              MessagesStorage.getInstance().updateChatInfo(MessagesController.71.this.val$info, false);
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoDidLoaded, new Object[] { MessagesController.71.this.val$info, Integer.valueOf(0), Boolean.valueOf(false), null });
            }
          });
        }
      }
      ...
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        if ((paramAnonymousTLObject instanceof TLRPC.TL_boolTrue)) {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              TLRPC.Chat localChat = MessagesController.this.getChat(Integer.valueOf(MessagesController.72.this.val$chat_id));
              if (MessagesController.72.this.val$userName.length() != 0) {}
              for (localChat.flags |= 0x40;; localChat.flags &= 0xFFFFFFBF)
              {
                localChat.username = MessagesController.72.this.val$userName;
                ArrayList localArrayList = new ArrayList();
      ...
      do
      {
        do
        {
          ...
          for (i = 1;; i = 0)
          {
            ...
            {
              MessageObject localMessageObject = (MessageObject)paramArrayList.get(m);
              int n;
              ...
              if ((localMessageObject.isOut()) && (localMessageObject.isNewGif()) && (!localMessageObject.isSending()) && (!localMessageObject.isForwarded())) {
                addNewGifToRecent(localMessageObject.messageOwner.media.document, localMessageObject.messageOwner.date);
              }
              int i1 = k;
    ...
    if (UserConfig.isClientActivated())
    {
      if ((ConnectionsManager.getInstance().getPauseTime() == 0L) && (ApplicationLoader.isScreenOn) && (!ApplicationLoader.mainInterfacePaused)) {
        if ((this.statusSettingState != 1) && ((this.lastStatusUpdateTime == 0L) || (Math.abs(System.currentTimeMillis() - this.lastStatusUpdateTime) >= 55000L) || (this.offlineSent)))
        {
          ...
          bool = ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).getBoolean("ghost_mode", false);
          ((TLRPC.TL_account_updateStatus)localObject1).offline = bool;
        }
      }
      for (this.statusRequest = ConnectionsManager.getInstance().sendRequest((TLObject)localObject1, new RequestDelegate()
          {
            public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
            {
              if (paramAnonymousTL_error == null)
              {
                ...
                MessagesController.access$3802(MessagesController.this, bool);
              ...
              for (;;)
              {
                ...
                if (MessagesController.this.lastStatusUpdateTime != 0L) {
                  MessagesController.access$3714(MessagesController.this, 5000L);
                }
              }
            }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\MessagesController.class
