...
public class ContactsController
{
  ...
  private boolean checkContactsInternal()
  {
    ...
    //   15: istore_2
    //   16: aload_0
    //   17: invokespecial 613	org/telegram/messenger/ContactsController:hasContactsPermission	()Z
    //   20: ifne +5 -> 25
    //   23: iconst_0
    //   24: ireturn
    //   25: iload_1
    //   26: istore_2
    //   27: getstatic 264	org/telegram/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   30: invokevirtual 617	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   33: astore 10
    //   35: aconst_null
    //   36: astore 9
    //   38: aconst_null
    ...
    //   46: istore_3
    //   47: aload 10
    //   49: getstatic 623	android/provider/ContactsContract$RawContacts:CONTENT_URI	Landroid/net/Uri;
    //   52: iconst_1
    //   53: anewarray 211	java/lang/String
    //   56: dup
    //   57: iconst_0
    //   58: ldc_w 625
    //   61: aastore
    ...
    //   63: aconst_null
    //   64: aconst_null
    //   65: invokevirtual 631	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   68: astore 10
    //   70: iload 7
    //   72: istore_1
    //   73: aload 10
    ...
    //   89: iload 6
    //   91: istore_3
    //   92: new 456	java/lang/StringBuilder
    //   95: dup
    //   96: invokespecial 457	java/lang/StringBuilder:<init>	()V
    //   99: astore 11
    //   101: aload 10
    //   103: astore 8
    //   105: iload 4
    ...
    //   143: aload 10
    //   145: ldc_w 625
    //   148: invokeinterface 640 2 0
    //   153: invokeinterface 644 2 0
    //   158: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   161: pop
    //   162: goto -61 -> 101
    //   165: astore 10
    //   167: aload 8
    ...
    //   173: ldc_w 454
    //   176: aload 10
    //   178: invokestatic 647	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   181: iload_1
    //   182: istore_2
    //   183: aload 8
    //   185: ifnull +14 -> 199
    ...
    //   214: istore_3
    //   215: aload 11
    //   217: invokevirtual 472	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   220: astore 11
    //   222: aload 10
    //   224: astore 8
    //   226: iload 4
    ...
    //   238: istore_3
    //   239: aload_0
    //   240: getfield 187	org/telegram/messenger/ContactsController:lastContactsVersions	Ljava/lang/String;
    //   243: invokevirtual 501	java/lang/String:length	()I
    //   246: ifeq +34 -> 280
    //   249: aload 10
    //   251: astore 8
    //   253: iload 4
    ...
    //   265: istore_3
    //   266: aload_0
    //   267: getfield 187	org/telegram/messenger/ContactsController:lastContactsVersions	Ljava/lang/String;
    //   270: aload 11
    //   272: invokevirtual 653	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   275: ifne +5 -> 280
    //   278: iconst_1
    //   279: istore_2
    //   280: aload 10
    ...
    //   292: aload_0
    //   293: aload 11
    //   295: putfield 187	org/telegram/messenger/ContactsController:lastContactsVersions	Ljava/lang/String;
    //   298: iload_2
    //   299: istore_1
    //   300: iload_1
    //   301: istore_2
    ...
    //   323: ldc_w 454
    //   326: aload 8
    //   328: invokestatic 647	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   331: goto -132 -> 199
    //   334: astore 8
    //   336: aload 9
    //   338: ifnull +12 -> 350
  ...
  private HashMap<Integer, Contact> readContactsFromPhoneBook()
  {
    ...
    for (;;)
    {
      ...
      ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneHome", 2131166166));
      continue;
      label365:
      if (i == 2) {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneMobile", 2131166168));
      } else if (i == 3) {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneWork", 2131166173));
      } else if (i == 12) {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneMain", 2131166167));
      } else {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneOther", 2131166172));
      }
    }
            ...
            if ((localObject3 != null) && (((String)localObject3).length() != 0))
            {
              ...
              if (!localHashMap2.containsKey(localObject3))
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject5))
                {
                  ...
                  ((Contact)localObject6).phoneTypes.add(LocaleController.getString("PhoneMobile", 2131166168));
  ...
  public String getInviteText()
  {
    ...
    return LocaleController.getString("InviteText", 2131165829);
  }
      ...
      public void run()
      {
        ...
        if (!paramHashMap.isEmpty())
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            Object localObject4 = (ContactsController.Contact)paramHashMap.get(localObject3);
            ...
            if (localObject4 == null)
            {
              ...
              {
                localObject2 = (ContactsController.Contact)localHashMap3.get(localContact.shortPhones.get(i));
                if (localObject2 == null) {
                  break label473;
                }
              ...
              if (i < localContact.phones.size())
              {
                ...
                if (j == -1) {
                  if (paramBoolean1)
                  {
                    ...
                    localObject3 = MessagesController.getInstance().getUser(Integer.valueOf(((TLRPC.TL_contact)localObject3).user_id));
                    if ((localObject3 != null) && (TextUtils.isEmpty(((TLRPC.User)localObject3).first_name)) && (TextUtils.isEmpty(((TLRPC.User)localObject3).last_name)) && ((!TextUtils.isEmpty(localContact.first_name)) || (!TextUtils.isEmpty(localContact.last_name)))) {
                      break label768;
                    }
                  }
                }
        ...
        do
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            localObject2 = (ContactsController.Contact)((Map.Entry)localObject3).getValue();
            j = ((Integer)((Map.Entry)localObject3).getKey()).intValue();
            i = 0;
            if (i < ((ContactsController.Contact)localObject2).phones.size())
            {
              if (paramBoolean4) {
                break label1401;
              }
              ...
              localObject3 = MessagesController.getInstance().getUser(Integer.valueOf(((TLRPC.TL_contact)localObject3).user_id));
              if ((localObject3 != null) && (TextUtils.isEmpty(((TLRPC.User)localObject3).first_name)) && (TextUtils.isEmpty(((TLRPC.User)localObject3).last_name)) && ((!TextUtils.isEmpty(((ContactsController.Contact)localObject2).first_name)) || (!TextUtils.isEmpty(((ContactsController.Contact)localObject2).last_name)))) {
                break label1401;
              }
            }
          }
          for (;;)
          {
            ...
            break;
            localObject3 = new TLRPC.TL_inputPhoneContact();
            ((TLRPC.TL_inputPhoneContact)localObject3).client_id = j;
            ((TLRPC.TL_inputPhoneContact)localObject3).client_id |= i << 32;
            ((TLRPC.TL_inputPhoneContact)localObject3).first_name = ((ContactsController.Contact)localObject2).first_name;
            ((TLRPC.TL_inputPhoneContact)localObject3).last_name = ((ContactsController.Contact)localObject2).last_name;
            ((TLRPC.TL_inputPhoneContact)localObject3).phone = ((String)((ContactsController.Contact)localObject2).phones.get(i));
            localArrayList.add(localObject3);
          }
          Utilities.stageQueue.postRunnable(new Runnable()
          {
      ...
      public void run()
      {
        ...
        Utilities.stageQueue.postRunnable(new Runnable()
        {
          public void run()
          {
            ...
            while (i < ContactsController.8.this.val$contactsArr.size())
            {
              ...
              else
              {
                ...
                for (localObject1 = "#";; localObject1 = ((String)localObject1).toUpperCase())
                {
                  ...
                  if ((localUser.id == UserConfig.getClientUserId()) || ((localUser.status != null) && (localUser.status.expires > ConnectionsManager.getInstance().getCurrentTime())) || (MessagesController.getInstance().onlinePrivacy.containsKey(Integer.valueOf(localUser.id))))
                  {
                    ...
                    {
                      localArrayList1 = (ArrayList)localHashMap4.get(localObject1);
                      localObject3 = localArrayList1;
                      if (localArrayList1 == null)
                      {
                        localObject3 = new ArrayList();
                        localHashMap4.put(localObject1, localObject3);
            ...
            Collections.sort(localArrayList4, new Comparator()
            {
            ...
            Collections.sort(localArrayList5, new Comparator()
            {
              public int compare(String paramAnonymous3String1, String paramAnonymous3String2)
              {
                int i = paramAnonymous3String1.charAt(0);
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                ContactsController.this.onlineUsersSectionsDict = localHashMap3;
                ContactsController.this.onlineUsersMutualSectionsDict = localHashMap4;
                ContactsController.this.onlineSortedUsersSectionsArray = localArrayList4;
                ContactsController.this.onlineSortedUsersMutualSectionsArray = localArrayList5;
                if (ContactsController.8.this.val$from != 2) {}
                synchronized (ContactsController.loadContactsSync)
                {
                  ContactsController.access$402(ContactsController.this, false);
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  Utilities.globalQueue.postRunnable(new Runnable()
                  {
                    public void run()
                    {
                      ContactsController.this.contactsByPhone = ContactsController.8.1.8.this.val$contactsByPhonesDictFinal;
                    }
                  });
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\ContactsController.class
