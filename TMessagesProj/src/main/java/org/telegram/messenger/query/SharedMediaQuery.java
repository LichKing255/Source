...
public class SharedMediaQuery
{
  ...
  public static void getMediaCount(long paramLong, int paramInt1, final int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == 5) {
      localTL_messages_search.filter = new TLRPC.TL_inputMessagesFilterPhotos();
    }
    for (;;)
    {
      ...
      return;
      if (paramInt1 == 6) {
        localTL_messages_search.filter = new TLRPC.TL_inputMessagesFilterVideo();
      } else if (paramInt1 == 0) {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\query\SharedMediaQuery.class
