...
public class ImageLoader
{
  ...
  public ImageLoader()
  {
    ...
    FileLoader.getInstance().setDelegate(new FileLoader.FileLoaderDelegate()
    {
      ...
      public void fileLoadProgressChanged(final String paramAnonymousString, final float paramAnonymousFloat)
      {
        ...
        {
          ImageLoader.access$2502(ImageLoader.this, l);
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
  ...
  private boolean canMoveFiles(File paramFile1, File paramFile2, int paramInt)
  {
    ...
    //   16: aload 8
    //   18: astore 7
    //   20: new 314	java/io/File
    //   23: dup
    //   24: aload_1
    //   25: ldc_w 452
    //   28: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   31: astore 5
    //   33: aload 8
    //   35: astore 7
    //   37: aload 5
    //   39: astore_1
    //   40: new 314	java/io/File
    //   43: dup
    //   44: aload_2
    //   45: ldc_w 454
    //   48: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   51: astore_1
    //   52: aload 5
    //   54: astore 6
    //   56: aload_1
    ...
    //   71: astore 7
    //   73: aload 6
    //   75: invokevirtual 329	java/io/File:createNewFile	()Z
    //   78: pop
    //   79: aload 8
    //   81: astore 7
    //   83: new 456	java/io/RandomAccessFile
    //   86: dup
    //   87: aload 6
    //   89: ldc_w 458
    //   92: invokespecial 459	java/io/RandomAccessFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   95: astore_1
    //   96: aload_1
    //   97: aload_2
    //   98: invokevirtual 463	java/io/RandomAccessFile:write	([B)V
    //   101: aload_1
    //   102: invokevirtual 466	java/io/RandomAccessFile:close	()V
    //   105: aconst_null
    //   106: astore_1
    //   107: aload_1
    //   108: astore 7
    //   110: aload 6
    //   112: aload 5
    //   114: invokevirtual 470	java/io/File:renameTo	(Ljava/io/File;)Z
    //   117: istore 4
    //   119: aload_1
    //   120: astore 7
    //   122: aload 6
    //   124: invokevirtual 473	java/io/File:delete	()Z
    //   127: pop
    //   128: aload_1
    //   129: astore 7
    //   131: aload 5
    //   133: invokevirtual 473	java/io/File:delete	()Z
    //   136: pop
    //   137: iload 4
    //   139: ifeq +180 -> 319
    //   142: iconst_0
    //   143: ifeq +11 -> 154
    //   146: new 475	java/lang/NullPointerException
    //   149: dup
    //   150: invokespecial 476	java/lang/NullPointerException:<init>	()V
    //   153: athrow
    //   154: iconst_1
    //   155: ireturn
    //   156: iload_3
    ...
    //   161: aload 8
    //   163: astore 7
    //   165: new 314	java/io/File
    //   168: dup
    //   169: aload_1
    //   170: ldc_w 478
    //   173: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   176: astore 5
    //   178: aload 8
    //   180: astore 7
    //   182: aload 5
    //   184: astore_1
    //   185: new 314	java/io/File
    //   188: dup
    //   189: aload_2
    //   190: ldc_w 480
    //   193: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   196: astore_1
    //   197: aload 5
    //   199: astore 6
    //   201: aload_1
    ...
    //   212: aload 8
    //   214: astore 7
    //   216: new 314	java/io/File
    //   219: dup
    //   220: aload_1
    //   221: ldc_w 482
    //   224: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   227: astore 5
    //   229: aload 8
    //   231: astore 7
    //   233: aload 5
    //   235: astore_1
    //   236: new 314	java/io/File
    //   239: dup
    //   240: aload_2
    //   241: ldc_w 484
    //   244: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   247: astore_1
    //   248: aload 5
    //   250: astore 6
    //   252: aload_1
    ...
    //   263: aload 8
    //   265: astore 7
    //   267: new 314	java/io/File
    //   270: dup
    //   271: aload_1
    //   272: ldc_w 486
    //   275: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   278: astore 5
    //   280: aload 8
    //   282: astore 7
    //   284: aload 5
    //   286: astore_1
    //   287: new 314	java/io/File
    //   290: dup
    //   291: aload_2
    //   292: ldc_w 488
    //   295: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   298: astore_1
    //   299: aload 5
    //   301: astore 6
    //   303: aload_1
    ...
    //   310: ldc_w 348
    //   313: aload_1
    //   314: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   317: iconst_1
    //   318: ireturn
    //   319: iconst_0
    //   320: ifeq +11 -> 331
    //   323: new 475	java/lang/NullPointerException
    //   326: dup
    //   327: invokespecial 476	java/lang/NullPointerException:<init>	()V
    //   330: athrow
    //   331: iconst_0
    //   332: ireturn
    //   333: astore_1
    //   334: ldc_w 348
    //   337: aload_1
    //   338: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   341: goto -10 -> 331
    //   344: aconst_null
    //   345: astore_1
    //   346: astore_2
    ...
    //   350: ldc_w 348
    //   353: aload_2
    //   354: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   357: aload_1
    //   358: ifnull -27 -> 331
    //   361: aload_1
    //   362: invokevirtual 466	java/io/RandomAccessFile:close	()V
    //   365: goto -34 -> 331
    //   368: astore_1
    //   369: ldc_w 348
    //   372: aload_1
    //   373: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   376: goto -45 -> 331
    //   379: astore_1
    //   380: aload 7
    //   382: ifnull +8 -> 390
    //   385: aload 7
    //   387: invokevirtual 466	java/io/RandomAccessFile:close	()V
    //   390: aload_1
    //   391: athrow
    //   392: astore_2
    //   393: ldc_w 348
    //   396: aload_2
    //   397: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   400: goto -10 -> 390
    //   403: astore_2
    //   404: aload_1
    //   405: astore 7
        ...
        public void run()
        {
          ...
          if (paramInt2 != 2)
          {
            ...
            if (i == 0)
            {
              ...
              if (localObject2 != null)
              {
                ((ImageLoader.CacheImage)localObject2).addImageReceiver(paramImageReceiver);
                j = 1;
              }
            }
            i = j;
            if (j == 0)
            {
              ...
              {
                ((ImageLoader.CacheImage)localObject1).addImageReceiver(paramImageReceiver);
                i = 1;
              }
            }
          }
          ...
          if (i == 0)
          {
            ...
            if (paramInt2 != 2)
            {
              ...
              ((ImageLoader.CacheImage)localObject3).addImageReceiver(paramImageReceiver);
          ...
          do
          {
            ...
            if ((bool1) && (localObject2 == null))
            {
              ...
              if (localThumbGenerateInfo == null)
              {
                ...
                ImageLoader.ThumbGenerateInfo.access$3302((ImageLoader.ThumbGenerateInfo)localObject1, (TLRPC.TL_fileLocation)paramTLObject);
                ImageLoader.ThumbGenerateInfo.access$3402((ImageLoader.ThumbGenerateInfo)localObject1, paramString5);
                ImageLoader.this.waitingForQualityThumb.put(str, localObject1);
              }
              ImageLoader.ThumbGenerateInfo.access$2808((ImageLoader.ThumbGenerateInfo)localObject1);
  ...
  private void fileDidLoaded(final String paramString, final File paramFile, final int paramInt)
  {
    this.imageLoadQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        if (localObject != null)
        {
          ImageLoader.this.generateThumb(paramInt, paramFile, ImageLoader.ThumbGenerateInfo.access$3300((ImageLoader.ThumbGenerateInfo)localObject), ImageLoader.ThumbGenerateInfo.access$3400((ImageLoader.ThumbGenerateInfo)localObject));
        ...
        ImageLoader.CacheOutTask localCacheOutTask;
        do
        {
          return;
          ImageLoader.this.imageLoadingByUrl.remove(paramString);
          localCacheOutTask = null;
          int i = 0;
          while (i < localCacheImage2.imageReceiverArray.size())
          {
            ...
            ImageLoader.CacheImage localCacheImage1 = (ImageLoader.CacheImage)ImageLoader.this.imageLoadingByKeys.get(localCacheImage2.key);
            ...
            if (localCacheImage1 == null)
            {
              ...
              ((ImageLoader.CacheImage)localObject).key = localCacheImage2.key;
              ...
              localCacheOutTask = new ImageLoader.CacheOutTask(ImageLoader.this, (ImageLoader.CacheImage)localObject);
              ((ImageLoader.CacheImage)localObject).cacheTask = localCacheOutTask;
              ((ImageLoader.CacheImage)localObject).filter = localCacheImage2.filter;
              ((ImageLoader.CacheImage)localObject).animatedFile = localCacheImage2.animatedFile;
              ImageLoader.this.imageLoadingByKeys.put(((ImageLoader.CacheImage)localObject).key, localObject);
            }
            ((ImageLoader.CacheImage)localObject).addImageReceiver(localImageReceiver);
            i += 1;
          }
        } while (localCacheOutTask == null);
        if (localCacheImage2.thumb)
        {
          ImageLoader.this.cacheThumbOutQueue.postRunnable(localCacheOutTask);
          return;
        }
        ImageLoader.this.cacheOutQueue.postRunnable(localCacheOutTask);
      }
    });
  }
  ...
  private void httpFileLoadError(final String paramString)
  {
    this.imageLoadQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        localCacheImage.httpTask = new ImageLoader.HttpImageTask(ImageLoader.this, ImageLoader.HttpImageTask.access$100(localHttpImageTask), ImageLoader.HttpImageTask.access$3800(localHttpImageTask));
  ...
  {
    // Byte code:
    //   0: new 575	android/graphics/BitmapFactory$Options
    //   3: dup
    //   4: invokespecial 576	android/graphics/BitmapFactory$Options:<init>	()V
    //   7: astore 13
    //   9: aload 13
    //   11: iconst_1
    //   12: putfield 580	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   15: aconst_null
    //   16: astore 10
    //   18: aload_0
    //   19: astore 8
    ...
    //   33: astore 8
    //   35: aload_1
    //   36: invokevirtual 586	android/net/Uri:getScheme	()Ljava/lang/String;
    //   39: ifnull +22 -> 61
    //   42: aload_1
    //   43: invokevirtual 586	android/net/Uri:getScheme	()Ljava/lang/String;
    //   46: ldc_w 299
    //   49: invokevirtual 590	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   52: ifeq +270 -> 322
    //   55: aload_1
    //   56: invokevirtual 593	android/net/Uri:getPath	()Ljava/lang/String;
    //   59: astore 8
    //   61: aload 8
    //   63: ifnull +284 -> 347
    //   66: aload 8
    //   68: aload 13
    //   70: invokestatic 599	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   73: pop
    //   74: aload 13
    //   76: getfield 602	android/graphics/BitmapFactory$Options:outWidth	I
    //   79: i2f
    //   80: fstore 5
    //   82: aload 13
    //   84: getfield 605	android/graphics/BitmapFactory$Options:outHeight	I
    //   87: i2f
    //   88: fstore 6
    //   90: iload 4
    //   92: ifeq +307 -> 399
    ...
    //   101: fload_3
    //   102: fdiv
    //   103: invokestatic 609	java/lang/Math:max	(FF)F
    //   106: fstore_2
    //   107: fload_2
    //   108: fstore_3
    //   109: fload_2
    ...
    //   117: aload 13
    //   119: iconst_0
    //   120: putfield 580	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   123: aload 13
    //   125: fload_3
    //   126: f2i
    //   127: putfield 612	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   130: getstatic 617	android/os/Build$VERSION:SDK_INT	I
    //   133: bipush 21
    ...
    //   141: aload 13
    //   143: iload 4
    //   145: putfield 620	android/graphics/BitmapFactory$Options:inPurgeable	Z
    //   148: aconst_null
    //   149: astore_0
    //   150: aload 8
    //   152: ifnull +268 -> 420
    ...
    //   164: aload_0
    //   165: ifnull +70 -> 235
    //   168: new 622	android/media/ExifInterface
    //   171: dup
    //   172: aload_0
    //   173: invokespecial 623	android/media/ExifInterface:<init>	(Ljava/lang/String;)V
    //   176: ldc_w 625
    //   179: iconst_1
    //   180: invokevirtual 629	android/media/ExifInterface:getAttributeInt	(Ljava/lang/String;I)I
    //   183: istore 7
    //   185: new 631	android/graphics/Matrix
    //   188: dup
    //   189: invokespecial 632	android/graphics/Matrix:<init>	()V
    //   192: astore_0
    //   193: iload 7
    ...
    //   251: aload 8
    //   253: aload 13
    //   255: invokestatic 599	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   258: astore_1
    //   259: aload_1
    //   260: astore_0
    //   261: aload_1
    ...
    //   266: astore_0
    //   267: aload 13
    //   269: getfield 620	android/graphics/BitmapFactory$Options:inPurgeable	Z
    //   272: ifeq +10 -> 282
    //   275: aload_1
    //   276: astore_0
    //   277: aload_1
    //   278: invokestatic 638	org/telegram/messenger/Utilities:pinBitmap	(Landroid/graphics/Bitmap;)I
    //   281: pop
    //   282: aload_1
    //   283: astore_0
    //   284: aload_1
    ...
    //   286: iconst_0
    //   287: aload_1
    //   288: invokevirtual 643	android/graphics/Bitmap:getWidth	()I
    //   291: aload_1
    //   292: invokevirtual 646	android/graphics/Bitmap:getHeight	()I
    //   295: aload 9
    //   297: iconst_1
    //   298: invokestatic 652	org/telegram/messenger/Bitmaps:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   301: astore 10
    //   303: aload_1
    //   304: astore_0
    //   305: aload 10
    ...
    //   312: astore_0
    //   313: aload_1
    //   314: invokevirtual 655	android/graphics/Bitmap:recycle	()V
    //   317: aload 10
    //   319: astore_0
    //   320: aload_0
    //   321: areturn
    //   322: aload_1
    //   323: invokestatic 658	org/telegram/messenger/AndroidUtilities:getPath	(Landroid/net/Uri;)Ljava/lang/String;
    //   326: astore 8
    //   328: goto -267 -> 61
    //   331: astore 8
    //   333: ldc_w 348
    ...
    //   347: aload_1
    //   348: ifnull -274 -> 74
    //   351: getstatic 234	org/telegram/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   354: invokevirtual 662	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   357: aload_1
    //   358: invokevirtual 668	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   361: astore_0
    //   362: aload_0
    //   363: aconst_null
    //   364: aload 13
    //   366: invokestatic 672	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   369: pop
    //   370: aload_0
    //   371: invokevirtual 675	java/io/InputStream:close	()V
    //   374: getstatic 234	org/telegram/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   377: invokevirtual 662	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   380: aload_1
    //   381: invokevirtual 668	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   384: astore 10
    //   386: goto -312 -> 74
    //   389: astore_0
    //   390: ldc_w 348
    //   393: aload_0
    //   394: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   397: aconst_null
    //   398: areturn
    //   399: fload 5
    //   401: fload_2
    ...
    //   405: fload_3
    //   406: fdiv
    //   407: invokestatic 677	java/lang/Math:min	(FF)F
    //   410: fstore_2
    //   411: goto -304 -> 107
    //   414: iconst_0
    //   415: istore 4
    ...
    //   421: ifnull -263 -> 158
    //   424: aload_1
    //   425: invokestatic 658	org/telegram/messenger/AndroidUtilities:getPath	(Landroid/net/Uri;)Ljava/lang/String;
    //   428: astore_0
    //   429: goto -271 -> 158
    //   432: aload_0
    //   433: ldc_w 678
    //   436: invokevirtual 682	android/graphics/Matrix:postRotate	(F)Z
    //   439: pop
    //   440: goto -208 -> 232
    //   443: astore 11
    //   445: aload_0
    ...
    //   448: ldc_w 348
    //   451: aload 11
    //   453: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   456: goto -221 -> 235
    //   459: aload_0
    //   460: ldc_w 683
    //   463: invokevirtual 682	android/graphics/Matrix:postRotate	(F)Z
    //   466: pop
    //   467: goto -235 -> 232
    //   470: aload_0
    //   471: ldc_w 684
    //   474: invokevirtual 682	android/graphics/Matrix:postRotate	(F)Z
    //   477: pop
    //   478: goto -246 -> 232
    //   481: astore_1
    //   482: ldc_w 348
    //   485: aload_1
    //   486: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   489: invokestatic 686	org/telegram/messenger/ImageLoader:getInstance	()Lorg/telegram/messenger/ImageLoader;
    //   492: invokevirtual 689	org/telegram/messenger/ImageLoader:clearMemory	()V
    //   495: aload_0
    //   496: astore_1
    //   497: aload_0
    ...
    //   501: aload 8
    //   503: aload 13
    //   505: invokestatic 599	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   508: astore 8
    //   510: aload 8
    //   512: astore_1
    //   513: aload 8
    ...
    //   523: astore_0
    //   524: aload 13
    //   526: getfield 620	android/graphics/BitmapFactory$Options:inPurgeable	Z
    //   529: ifeq +15 -> 544
    //   532: aload 8
    //   534: astore_0
    //   535: aload 8
    //   537: invokestatic 638	org/telegram/messenger/Utilities:pinBitmap	(Landroid/graphics/Bitmap;)I
    //   540: pop
    //   541: aload 8
    //   543: astore_1
    //   544: aload_1
    ...
    //   554: iconst_0
    //   555: aload_1
    //   556: invokevirtual 643	android/graphics/Bitmap:getWidth	()I
    //   559: aload_1
    //   560: invokevirtual 646	android/graphics/Bitmap:getHeight	()I
    //   563: aload 9
    //   565: iconst_1
    //   566: invokestatic 652	org/telegram/messenger/Bitmaps:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   569: astore 8
    //   571: aload_1
    //   572: astore_0
    //   573: aload 8
    ...
    //   580: astore_0
    //   581: aload_1
    //   582: invokevirtual 655	android/graphics/Bitmap:recycle	()V
    //   585: aload 8
    //   587: areturn
    //   588: astore_1
    //   589: ldc_w 348
    //   592: aload_1
    //   593: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   596: aload_0
    //   597: areturn
    //   598: aload_1
    //   599: ifnull -279 -> 320
    ...
    //   607: aconst_null
    //   608: aload 13
    //   610: invokestatic 672	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   613: astore_1
    //   614: aload_1
    //   615: astore_0
    //   616: aload_1
    ...
    //   621: astore_0
    //   622: aload 13
    //   624: getfield 620	android/graphics/BitmapFactory$Options:inPurgeable	Z
    //   627: ifeq +10 -> 637
    //   630: aload_1
    //   631: astore_0
    //   632: aload_1
    //   633: invokestatic 638	org/telegram/messenger/Utilities:pinBitmap	(Landroid/graphics/Bitmap;)I
    //   636: pop
    //   637: aload_1
    //   638: astore_0
    //   639: aload_1
    ...
    //   641: iconst_0
    //   642: aload_1
    //   643: invokevirtual 643	android/graphics/Bitmap:getWidth	()I
    //   646: aload_1
    //   647: invokevirtual 646	android/graphics/Bitmap:getHeight	()I
    //   650: aload 9
    //   652: iconst_1
    //   653: invokestatic 652	org/telegram/messenger/Bitmaps:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   656: astore 8
    //   658: aload_1
    //   659: astore_0
    //   660: aload 8
    ...
    //   667: astore_0
    //   668: aload_1
    //   669: invokevirtual 655	android/graphics/Bitmap:recycle	()V
    //   672: aload 8
    //   674: astore_0
    //   675: aload 10
    //   677: invokevirtual 675	java/io/InputStream:close	()V
    //   680: aload_0
    //   681: areturn
    //   682: astore_1
    //   683: ldc_w 348
    //   686: aload_1
    //   687: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   690: aload_0
    //   691: areturn
    //   692: astore_1
    //   693: ldc_w 348
    //   696: aload_1
    //   697: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   700: aload 10
    //   702: invokevirtual 675	java/io/InputStream:close	()V
    //   705: aload_0
    //   706: areturn
    //   707: astore_1
    //   708: ldc_w 348
    //   711: aload_1
    //   712: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   715: aload_0
    //   716: areturn
    //   717: astore_0
    //   718: aload 10
    //   720: invokevirtual 675	java/io/InputStream:close	()V
    //   723: aload_0
    //   724: athrow
    //   725: astore_1
    //   726: ldc_w 348
    //   729: aload_1
    //   730: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   733: goto -10 -> 723
    //   736: astore_0
    //   737: aload 11
    //   739: astore 9
  ...
  private void removeFromWaitingForThumb(Integer paramInteger)
  {
    ...
    if (str != null)
    {
      ...
      if (localThumbGenerateInfo != null)
      {
        ThumbGenerateInfo.access$2810(localThumbGenerateInfo);
    ...
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        if (paramHttpFileTask != null) {
          ImageLoader.access$3910(ImageLoader.this);
        }
        Object localObject;
        if (paramHttpFileTask != null)
        {
          ...
          if (!ImageLoader.HttpFileTask.access$4000(paramHttpFileTask)) {
            break label178;
          }
          ...
          ImageLoader.this.retryHttpsTasks.put(ImageLoader.HttpFileTask.access$4100(paramHttpFileTask), localObject);
        ...
        while ((ImageLoader.this.currentHttpFileLoadTasksCount < 2) && (!ImageLoader.this.httpFileLoadTasks.isEmpty()))
        {
          ...
          ImageLoader.access$3908(ImageLoader.this);
          continue;
          label178:
          NotificationCenter.getInstance().postNotificationName(NotificationCenter.httpFileDidFailedLoad, new Object[] { ImageLoader.HttpFileTask.access$4100(paramHttpFileTask) });
          continue;
          label204:
          if (paramInt == 2)
          {
            ImageLoader.this.httpFileLoadTasksByKeys.remove(ImageLoader.HttpFileTask.access$4100(paramHttpFileTask));
            localObject = new File(FileLoader.getInstance().getDirectory(4), Utilities.MD5(ImageLoader.HttpFileTask.access$4100(paramHttpFileTask)) + "." + ImageLoader.HttpFileTask.access$4300(paramHttpFileTask));
            ...
            {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.httpFileDidLoaded, new Object[] { ImageLoader.HttpFileTask.access$4100(paramHttpFileTask), localObject });
              break;
            }
          }
        }
  ...
  {
    // Byte code:
    //   0: new 162	java/util/HashMap
    //   3: dup
    //   4: invokespecial 163	java/util/HashMap:<init>	()V
    //   7: astore_2
    //   8: invokestatic 312	org/telegram/messenger/AndroidUtilities:getCacheDir	()Ljava/io/File;
    //   11: astore_3
    //   12: aload_3
    //   13: invokevirtual 318	java/io/File:isDirectory	()Z
    //   16: ifne +8 -> 24
    //   19: aload_3
    //   20: invokevirtual 321	java/io/File:mkdirs	()Z
    //   23: pop
    //   24: new 314	java/io/File
    //   27: dup
    //   28: aload_3
    //   29: ldc_w 323
    //   32: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   35: invokevirtual 329	java/io/File:createNewFile	()Z
    //   38: pop
    //   39: aload_2
    //   40: iconst_4
    //   41: invokestatic 335	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   44: aload_3
    //   45: invokevirtual 339	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   48: pop
    //   49: ldc_w 348
    //   52: new 725	java/lang/StringBuilder
    //   55: dup
    //   56: invokespecial 726	java/lang/StringBuilder:<init>	()V
    //   59: ldc_w 993
    //   62: invokevirtual 730	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   65: aload_3
    //   66: invokevirtual 996	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   69: invokevirtual 735	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   72: invokestatic 998	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   75: ldc_w 1000
    ...
    //   96: aload 4
    //   98: ldc_w 1016
    //   101: invokeinterface 1019 2 0
    //   106: checkcast 314	java/io/File
    //   109: ldc_w 1021
    //   112: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   115: astore 5
    //   117: new 314	java/io/File
    //   120: dup
    //   121: aload 5
    //   123: ldc_w 323
    //   126: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   129: invokevirtual 329	java/io/File:createNewFile	()Z
    //   132: pop
    //   133: getstatic 234	org/telegram/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   136: ldc_w 1023
    //   139: iconst_0
    //   140: invokevirtual 1027	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   143: ldc_w 1029
    //   146: iconst_0
    //   147: invokeinterface 1035 3 0
    //   152: ifeq +488 -> 640
    //   155: aload 4
    //   157: ldc_w 1016
    //   160: invokeinterface 1019 2 0
    //   165: ifnull +455 -> 620
    //   168: aload_0
    //   169: new 314	java/io/File
    //   172: dup
    //   173: aload 4
    //   175: ldc_w 1016
    //   178: invokeinterface 1019 2 0
    //   183: checkcast 314	java/io/File
    //   186: ldc_w 1037
    //   189: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   192: putfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   195: aload_0
    //   196: getfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   199: invokevirtual 321	java/io/File:mkdirs	()Z
    //   202: pop
    //   203: aload_0
    //   204: getfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   207: invokevirtual 318	java/io/File:isDirectory	()Z
    //   210: istore_1
    //   211: iload_1
    //   212: ifeq +351 -> 563
    //   215: new 314	java/io/File
    //   218: dup
    //   219: aload_0
    //   220: getfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   223: ldc_w 1039
    //   226: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   229: astore 4
    //   231: aload 4
    //   233: invokevirtual 1042	java/io/File:mkdir	()Z
    //   236: pop
    //   237: aload 4
    //   239: invokevirtual 318	java/io/File:isDirectory	()Z
    //   242: ifeq +52 -> 294
    //   245: aload_0
    //   246: aload_3
    //   247: aload 4
    //   249: iconst_0
    //   250: invokespecial 1044	org/telegram/messenger/ImageLoader:canMoveFiles	(Ljava/io/File;Ljava/io/File;I)Z
    //   253: ifeq +41 -> 294
    //   256: aload_2
    //   257: iconst_0
    //   258: invokestatic 335	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   261: aload 4
    //   263: invokevirtual 339	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   266: pop
    //   267: ldc_w 348
    //   270: new 725	java/lang/StringBuilder
    //   273: dup
    //   274: invokespecial 726	java/lang/StringBuilder:<init>	()V
    //   277: ldc_w 1046
    //   280: invokevirtual 730	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   283: aload 4
    //   285: invokevirtual 996	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   288: invokevirtual 735	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   291: invokestatic 998	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   294: new 314	java/io/File
    //   297: dup
    //   298: aload_0
    //   299: getfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   302: ldc_w 1048
    //   305: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   308: astore 4
    //   310: aload 4
    //   312: invokevirtual 1042	java/io/File:mkdir	()Z
    //   315: pop
    //   316: aload 4
    //   318: invokevirtual 318	java/io/File:isDirectory	()Z
    //   321: ifeq +52 -> 373
    //   324: aload_0
    //   325: aload_3
    //   326: aload 4
    //   328: iconst_2
    //   329: invokespecial 1044	org/telegram/messenger/ImageLoader:canMoveFiles	(Ljava/io/File;Ljava/io/File;I)Z
    //   332: ifeq +41 -> 373
    //   335: aload_2
    //   336: iconst_2
    //   337: invokestatic 335	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   340: aload 4
    //   342: invokevirtual 339	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   345: pop
    //   346: ldc_w 348
    //   349: new 725	java/lang/StringBuilder
    //   352: dup
    //   353: invokespecial 726	java/lang/StringBuilder:<init>	()V
    //   356: ldc_w 1050
    //   359: invokevirtual 730	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   362: aload 4
    //   364: invokevirtual 996	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   367: invokevirtual 735	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   370: invokestatic 998	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   373: new 314	java/io/File
    //   376: dup
    //   377: aload_0
    //   378: getfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   381: ldc_w 1052
    //   384: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   387: astore 4
    //   389: aload 4
    //   391: invokevirtual 1042	java/io/File:mkdir	()Z
    //   394: pop
    //   395: aload 4
    //   397: invokevirtual 318	java/io/File:isDirectory	()Z
    //   400: ifeq +68 -> 468
    //   403: aload_0
    //   404: aload_3
    //   405: aload 4
    //   407: iconst_1
    //   408: invokespecial 1044	org/telegram/messenger/ImageLoader:canMoveFiles	(Ljava/io/File;Ljava/io/File;I)Z
    //   411: ifeq +57 -> 468
    //   414: new 314	java/io/File
    //   417: dup
    //   418: aload 4
    //   420: ldc_w 323
    //   423: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   426: invokevirtual 329	java/io/File:createNewFile	()Z
    //   429: pop
    //   430: aload_2
    //   431: iconst_1
    //   432: invokestatic 335	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   435: aload 4
    //   437: invokevirtual 339	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   440: pop
    //   441: ldc_w 348
    //   444: new 725	java/lang/StringBuilder
    //   447: dup
    //   448: invokespecial 726	java/lang/StringBuilder:<init>	()V
    //   451: ldc_w 1054
    //   454: invokevirtual 730	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   457: aload 4
    //   459: invokevirtual 996	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   462: invokevirtual 735	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   465: invokestatic 998	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   468: new 314	java/io/File
    //   471: dup
    //   472: aload_0
    //   473: getfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   476: ldc_w 1056
    //   479: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   482: astore 4
    //   484: aload 4
    //   486: invokevirtual 1042	java/io/File:mkdir	()Z
    //   489: pop
    //   490: aload 4
    //   492: invokevirtual 318	java/io/File:isDirectory	()Z
    //   495: ifeq +68 -> 563
    //   498: aload_0
    //   499: aload_3
    //   500: aload 4
    //   502: iconst_3
    //   503: invokespecial 1044	org/telegram/messenger/ImageLoader:canMoveFiles	(Ljava/io/File;Ljava/io/File;I)Z
    //   506: ifeq +57 -> 563
    //   509: new 314	java/io/File
    //   512: dup
    //   513: aload 4
    //   515: ldc_w 323
    //   518: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   521: invokevirtual 329	java/io/File:createNewFile	()Z
    //   524: pop
    //   525: aload_2
    //   526: iconst_3
    //   527: invokestatic 335	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   530: aload 4
    //   532: invokevirtual 339	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   535: pop
    //   536: ldc_w 348
    //   539: new 725	java/lang/StringBuilder
    //   542: dup
    //   543: invokespecial 726	java/lang/StringBuilder:<init>	()V
    //   546: ldc_w 1058
    //   549: invokevirtual 730	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   552: aload 4
    //   554: invokevirtual 996	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   557: invokevirtual 735	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   560: invokestatic 998	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   563: invokestatic 1063	org/telegram/messenger/MediaController:getInstance	()Lorg/telegram/messenger/MediaController;
    //   566: invokevirtual 1066	org/telegram/messenger/MediaController:checkSaveToGalleryFiles	()V
    //   569: aload_2
    //   570: areturn
    //   571: astore 4
    //   573: ldc_w 348
    //   576: aload 4
    //   578: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   581: goto -557 -> 24
    //   584: astore 4
    //   586: ldc_w 348
    //   589: aload 4
    //   591: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   594: goto -555 -> 39
    //   597: astore 5
    //   599: ldc_w 348
    //   602: aload 5
    //   604: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   607: goto -474 -> 133
    //   610: astore_3
    //   611: ldc_w 348
    //   614: aload_3
    //   615: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   618: aload_2
    //   619: areturn
    //   620: aload_0
    //   621: new 314	java/io/File
    //   624: dup
    //   625: invokestatic 1069	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   628: ldc_w 1037
    //   631: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   634: putfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   637: goto -442 -> 195
    //   640: aload_0
    //   641: new 314	java/io/File
    //   644: dup
    //   645: invokestatic 1069	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   648: ldc_w 1037
    //   651: invokespecial 326	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   654: putfield 224	org/telegram/messenger/ImageLoader:telegramPath	Ljava/io/File;
    //   657: goto -462 -> 195
    //   660: astore 4
    //   662: ldc_w 348
    //   665: aload 4
    //   667: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   670: goto -376 -> 294
    //   673: astore 4
    //   675: ldc_w 348
    //   678: aload 4
    //   680: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   683: goto -310 -> 373
    //   686: astore 4
    //   688: ldc_w 348
    //   691: aload 4
    //   693: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   696: goto -228 -> 468
    //   699: astore_3
    //   700: ldc_w 348
    //   703: aload_3
    //   704: invokestatic 354	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   707: goto -144 -> 563
    //   710: ldc_w 348
    //   713: ldc_w 1071
    //   716: invokestatic 998	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   719: goto -156 -> 563
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	722	0	this	ImageLoader
    //   210	2	1	bool	boolean
    //   7	612	2	localHashMap	HashMap
    //   11	489	3	localFile1	File
    //   610	5	3	localException1	Exception
    //   699	5	3	localException2	Exception
    //   90	463	4	localObject	Object
    //   571	6	4	localException3	Exception
    //   584	6	4	localException4	Exception
    //   660	6	4	localException5	Exception
    //   673	6	4	localException6	Exception
    //   686	6	4	localException7	Exception
    //   115	7	5	localFile2	File
    //   597	6	5	localException8	Exception
    // Exception table:
    //   from	to	target	type
    //   19	24	571	java/lang/Exception
    //   24	39	584	java/lang/Exception
    //   117	133	597	java/lang/Exception
    //   75	117	610	java/lang/Exception
    //   133	195	610	java/lang/Exception
    //   195	211	610	java/lang/Exception
    //   563	569	610	java/lang/Exception
    //   599	607	610	java/lang/Exception
    //   620	637	610	java/lang/Exception
    //   640	657	610	java/lang/Exception
    //   662	670	610	java/lang/Exception
    //   675	683	610	java/lang/Exception
    //   688	696	610	java/lang/Exception
    //   700	707	610	java/lang/Exception
    //   710	719	610	java/lang/Exception
    //   215	294	660	java/lang/Exception
    //   294	373	673	java/lang/Exception
    //   373	468	686	java/lang/Exception
    //   468	563	699	java/lang/Exception
  }
  ...
  public void loadImageForImageReceiver(ImageReceiver paramImageReceiver)
  {
    ...
    for (i = 2;; i = 1)
    {
      ...
      localObject6 = (TLRPC.Document)localObject8;
      if ((((TLRPC.Document)localObject6).id == 0L) || (((TLRPC.Document)localObject6).dc_id == 0)) {
        break;
      }
      localObject4 = ((TLRPC.Document)localObject6).dc_id + "_" + ((TLRPC.Document)localObject6).id;
      localObject1 = FileLoader.getDocumentFileName((TLRPC.Document)localObject6);
      if (localObject1 != null)
      {
  ...
  private class CacheImage
  {
    ...
    public void addImageReceiver(ImageReceiver paramImageReceiver)
    {
      int j = 0;
      Iterator localIterator = this.imageReceiverArray.iterator();
      do
      {
        i = j;
        if (!localIterator.hasNext()) {
      ...
      } while ((ImageReceiver)localIterator.next() != paramImageReceiver);
      int i = 1;
      if (i == 0)
      {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      //   230: iload 12
      //   232: istore 6
      //   234: invokestatic 119	org/telegram/messenger/ImageLoader:access$1100	()[B
      //   237: astore 14
      //   239: iload 12
      //   241: istore 6
      //   243: aload 15
      ...
      //   393: invokestatic 160	org/telegram/messenger/ImageLoader:access$1302	(Lorg/telegram/messenger/ImageLoader;J)J
      //   396: pop2
      //   397: aload_0
      ...
      //   468: iload 12
      //   470: istore 6
      //   472: invokestatic 176	org/telegram/messenger/ImageLoader:access$1200	()[B
      //   475: astore 14
      //   477: goto -238 -> 239
      //   480: astore 14
      //   482: ldc -94
      ...
      //   895: l2i
      //   896: istore 6
      //   898: invokestatic 250	org/telegram/messenger/ImageLoader:access$1400	()[B
      //   901: ifnull +1998 -> 2899
      //   904: invokestatic 250	org/telegram/messenger/ImageLoader:access$1400	()[B
      //   907: arraylength
      //   908: iload 6
      //   910: if_icmplt +1989 -> 2899
      //   913: invokestatic 250	org/telegram/messenger/ImageLoader:access$1400	()[B
      //   916: astore 14
      //   918: aload 14
      //   920: astore 15
      //   922: aload 14
      ...
      //   931: astore 15
      //   933: aload 15
      //   935: invokestatic 254	org/telegram/messenger/ImageLoader:access$1402	([B)[B
      //   938: pop
      //   939: aload 16
      //   941: aload 15
      //   943: iconst_0
      ...
      //   1446: invokestatic 322	org/telegram/messenger/ImageLoader:access$1300	(Lorg/telegram/messenger/ImageLoader;)J
      //   1449: lconst_0
      //   1450: lcmp
      //   1451: ifeq +35 -> 1486
      //   1454: aload_0
      //   1455: getfield 27	org/telegram/messenger/ImageLoader$CacheOutTask:this$0	Lorg/telegram/messenger/ImageLoader;
      //   1458: invokestatic 322	org/telegram/messenger/ImageLoader:access$1300	(Lorg/telegram/messenger/ImageLoader;)J
      ...
      //   1493: invokestatic 160	org/telegram/messenger/ImageLoader:access$1302	(Lorg/telegram/messenger/ImageLoader;J)J
      //   1496: pop2
      //   1497: aload_0
      ...
      //   2417: aload 16
      //   2419: astore 14
      //   2421: invokestatic 388	org/telegram/messenger/ImageLoader:access$1500	()[B
      //   2424: ifnull +552 -> 2976
      //   2427: aload 16
      //   2429: astore 14
      //   2431: invokestatic 388	org/telegram/messenger/ImageLoader:access$1500	()[B
      //   2434: arraylength
      //   2435: iload 7
      //   2437: if_icmplt +539 -> 2976
      //   2440: aload 16
      //   2442: astore 14
      //   2444: invokestatic 388	org/telegram/messenger/ImageLoader:access$1500	()[B
      //   2447: astore 15
      //   2449: aload 15
      //   2451: astore 14
      //   2453: aload 14
      ...
      //   2474: astore 14
      //   2476: aload 15
      //   2478: invokestatic 391	org/telegram/messenger/ImageLoader:access$1502	([B)[B
      //   2481: pop
      //   2482: aload 16
      //   2484: astore 14
      //   2486: aload 17
          ...
          catch (Throwable paramVarArgs)
          {
            try
            {
              for (;;)
              {
                ...
                try
                {
                  i = ((InputStream)localObject2).read(paramVarArgs);
                  if (i <= 0) {
                    break label539;
                  }
                  this.fileOutputStream.write(paramVarArgs, 0, i);
                }
                catch (Exception paramVarArgs)
                {
                  FileLog.e("tmessages", paramVarArgs);
                  ...
                  for (;;)
                  {
                    ...
                    for (;;)
                    {
                      ...
                      if ((paramVarArgs instanceof UnknownHostException)) {
                        this.canRetry = false;
                      } else if (((paramVarArgs instanceof SocketException)) && (paramVarArgs.getMessage() != null) && (paramVarArgs.getMessage().contains("ECONNRESET"))) {
                        this.canRetry = false;
                      }
                    }
                    localException1 = localException1;
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\ImageLoader.class
