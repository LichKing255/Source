...
public class NativeLoader
{
  ...
  public static void initNativeLibs(Context paramContext)
  {
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        if (!new File((File)localObject1, "libtmessages.22.so").exists()) {
          break;
        }
        FileLog.d("tmessages", "load normal lib");
        try
        {
          System.loadLibrary("tmessages.22");
      ...
      else
      {
        ...
        localObject4 = new File((File)localObject2, "libtmessages.22loc.so");
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\NativeLoader.class
