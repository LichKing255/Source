...
public class LocaleController
{
  ...
  public LocaleController()
  {
    ...
    localObject1 = new LocaleInfo();
    ((LocaleInfo)localObject1).name = "پارسی";
    ...
    is24HourFormat = ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).getBoolean("enable24HourFormat", false);
    localObject1 = null;
    boolean bool2 = false;
    try
    {
  ...
  public static String formatDate(long paramLong)
  {
    try
    {
      ...
      if ((k + 1 == i) && (j == m)) {
        return getString("Yesterday", 2131166490);
      }
      if (j == m) {
  ...
  public static String formatDateAudio(long paramLong)
  {
    try
    {
      ...
      int m = ((Calendar)localObject).get(1);
      if ((k == i) && (j == m)) {
        return String.format("%s %s", new Object[] { getString("TodayAt", 2131166407), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if ((k + 1 == i) && (j == m)) {
        return String.format("%s %s", new Object[] { getString("YesterdayAt", 2131166491), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if (j == m) {
        return formatString("formatDateAtTime", 2131166518, new Object[] { getInstance().formatterMonth.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      localObject = formatString("formatDateAtTime", 2131166518, new Object[] { getInstance().formatterYear.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      return (String)localObject;
    }
    catch (Exception localException)
    {
  ...
  public static String formatDateChat(long paramLong)
  {
    try
    {
      ...
      {
        if (i == j) {
          return new SolarCalendar((Calendar)localObject).getShortDesDate();
        }
        return new SolarCalendar((Calendar)localObject).getNumDate();
      }
      if (i == j) {
        return getInstance().chatDate.format(paramLong * 1000L);
      }
      localObject = getInstance().chatFullDate.format(paramLong * 1000L);
      return (String)localObject;
    }
    catch (Exception localException)
    {
  ...
  public static String formatDateOnline(long paramLong)
  {
    try
    {
      ...
      int k = ((Calendar)localObject).get(6);
      int m = ((Calendar)localObject).get(1);
      boolean bool = ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).getBoolean("persian_date", false);
      if ((k == i) && (j == m))
      {
        if (bool)
        {
          localObject = new SolarCalendar((Calendar)localObject);
          return getString("LastSeen", 2131165859) + " " + getString("TodayAt", 2131166407) + " " + ((SolarCalendar)localObject).getTime();
        }
        return String.format("%s %s %s", new Object[] { getString("LastSeen", 2131165859), getString("TodayAt", 2131166407), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if ((k + 1 == i) && (j == m))
      {
        if (bool)
        {
          localObject = new SolarCalendar((Calendar)localObject);
          return getString("LastSeen", 2131165859) + " " + getString("YesterdayAt", 2131166491) + " " + ((SolarCalendar)localObject).getTime();
        }
        return String.format("%s %s %s", new Object[] { getString("LastSeen", 2131165859), getString("YesterdayAt", 2131166491), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if (j == m)
      {
        if (bool)
        {
          localObject = new SolarCalendar((Calendar)localObject);
          return getString("LastSeen", 2131165859) + " " + ((SolarCalendar)localObject).getShortDesDateTime();
        }
        localObject = formatString("formatDateAtTime", 2131166518, new Object[] { getInstance().formatterMonth.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
        return String.format("%s %s", new Object[] { getString("LastSeenDate", 2131165864), localObject });
      }
      if (bool)
      {
        localObject = new SolarCalendar((Calendar)localObject);
        return getString("LastSeen", 2131165859) + " " + ((SolarCalendar)localObject).getNumDateTime();
      }
      localObject = formatString("formatDateAtTime", 2131166518, new Object[] { getInstance().formatterYear.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      localObject = String.format("%s %s", new Object[] { getString("LastSeenDate", 2131165864), localObject });
      return (String)localObject;
    }
    catch (Exception localException)
    {
  ...
  {
    if (ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).getBoolean("exact_count", false)) {
  ...
  public static String formatUserStatus(TLRPC.User paramUser)
  {
    ...
    {
      return getString("Online", 2131166113);
      label90:
    ...
    if ((paramUser == null) || (paramUser.status == null) || (paramUser.status.expires == 0) || (UserObject.isDeleted(paramUser)) || ((paramUser instanceof TLRPC.TL_userEmpty))) {
      return getString("ALongTimeAgo", 2131165245);
    }
    ...
    if (paramUser.status.expires == -1) {
      return getString("Invisible", 2131165826);
    }
    if (paramUser.status.expires == -100) {
      return getString("Lately", 2131165884);
    }
    if (paramUser.status.expires == -101) {
      return getString("WithinAWeek", 2131166480);
    }
    if (paramUser.status.expires == -102) {
      return getString("WithinAMonth", 2131166479);
    }
  ...
  {
    return getString("LanguageName", 2131165856);
  }
  ...
  private HashMap<String, String> getLocaleFileStrings(File paramFile)
  {
    ...
    //   18: aload 5
    //   20: astore_3
    //   21: invokestatic 892	android/util/Xml:newPullParser	()Lorg/xmlpull/v1/XmlPullParser;
    //   24: astore 10
    //   26: aload 5
    //   28: astore_3
    //   29: new 894	java/io/FileInputStream
    //   32: dup
    //   33: aload_1
    //   34: invokespecial 897	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   37: astore 8
    //   39: aload 10
    //   41: aload 8
    //   43: ldc_w 899
    //   46: invokeinterface 905 3 0
    //   51: aload 10
    //   53: invokeinterface 908 1 0
    //   58: istore_2
    //   59: aconst_null
    //   60: astore 6
    //   62: aconst_null
    ...
    //   96: astore_1
    //   97: aload 10
    //   99: invokeinterface 914 1 0
    //   104: ifle +19 -> 123
    //   107: aload 10
    //   109: iconst_0
    //   110: invokeinterface 917 2 0
    //   115: astore_3
    //   116: aload 7
    //   118: astore_1
    //   119: aload 6
    ...
    //   148: aload 4
    //   150: ldc_w 758
    //   153: invokevirtual 920	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   156: ifeq +82 -> 238
    //   159: aload_3
    //   160: astore 5
    //   162: aload 4
    ...
    //   195: astore 7
    //   197: aload_1
    //   198: invokevirtual 618	java/lang/String:length	()I
    //   201: ifeq +37 -> 238
    //   204: aload_3
    //   205: astore 5
    //   207: aload 4
    ...
    //   212: astore 7
    //   214: aload_3
    //   215: invokevirtual 618	java/lang/String:length	()I
    //   218: ifeq +20 -> 238
    //   221: aload 9
    //   223: aload_3
    //   224: aload_1
    ...
    //   290: ifnull -167 -> 123
    //   293: aload 7
    //   295: invokevirtual 928	java/lang/String:trim	()Ljava/lang/String;
    //   298: ldc_w 930
    //   301: ldc_w 932
    //   304: invokevirtual 936	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   307: ldc_w 938
    //   310: ldc_w 781
    //   313: invokevirtual 936	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   316: astore_1
    //   317: aload 5
    //   319: astore_3
    //   320: aload 6
    ...
    //   354: ifnull +8 -> 362
    //   357: aload 8
    //   359: invokevirtual 941	java/io/FileInputStream:close	()V
    //   362: aload 9
    //   364: areturn
    //   365: astore_1
    //   366: ldc_w 606
    //   369: aload_1
    //   370: invokestatic 612	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   373: goto -11 -> 362
    //   376: astore_3
    //   377: aload 4
    //   379: astore_1
    ...
    //   385: ldc_w 606
    //   388: aload 4
    //   390: invokestatic 612	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   393: aload_1
    //   394: ifnull +7 -> 401
    //   397: aload_1
    //   398: invokevirtual 941	java/io/FileInputStream:close	()V
    ...
    //   410: ldc_w 606
    //   413: aload_1
    //   414: invokestatic 612	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   417: goto -16 -> 401
    //   420: astore_1
    //   421: aload_3
    //   422: ifnull +7 -> 429
    //   425: aload_3
    //   426: invokevirtual 941	java/io/FileInputStream:close	()V
    //   429: aload_1
    //   430: athrow
    //   431: astore_3
    //   432: ldc_w 606
    //   435: aload_3
    //   436: invokestatic 612	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   439: goto -10 -> 429
    //   442: astore_1
    //   443: aload 8
    //   445: astore_3
  ...
  public void recreateFormatters()
  {
    ...
    isRTL = ((String)localObject3).toLowerCase().equals("fa");
    int i;
    if (((String)localObject3).toLowerCase().equals("ko"))
    {
      i = 2;
      nameDisplayOrder = i;
      this.formatterMonth = createFormatter((Locale)localObject1, getStringInternal("formatterMonth", 2131166521), "dd MMM");
      this.formatterYear = createFormatter((Locale)localObject1, getStringInternal("formatterYear", 2131166524), "dd.MM.yy");
      this.formatterYearMax = createFormatter((Locale)localObject1, getStringInternal("formatterYearMax", 2131166525), "dd.MM.yyyy");
      this.chatDate = createFormatter((Locale)localObject1, getStringInternal("chatDate", 2131166510), "d MMMM");
      this.chatFullDate = createFormatter((Locale)localObject1, getStringInternal("chatFullDate", 2131166511), "d MMMM yyyy");
      this.formatterWeek = createFormatter((Locale)localObject1, getStringInternal("formatterWeek", 2131166523), "EEE");
      this.formatterMonthYear = createFormatter((Locale)localObject1, getStringInternal("formatterMonthYear", 2131166522), "MMMM yyyy");
      localObject2 = localObject1;
      ...
      localObject1 = getStringInternal("formatterDay24H", 2131166520);
      label282:
      if (!is24HourFormat) {
        break label332;
      }
    ...
    for (localObject3 = "HH:mm";; localObject3 = "h:mm a")
    {
      ...
      break label265;
      localObject1 = getStringInternal("formatterDay12H", 2131166519);
      break label282;
    }
  }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\LocaleController.class
