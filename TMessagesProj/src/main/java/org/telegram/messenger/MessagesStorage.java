...
public class MessagesStorage
{
      ...
      public void run()
      {
        for (;;)
        {
          ...
          try
          {
            ...
            l = localSQLiteCursor.longValue(0);
          ...
          if (localObject != null)
          {
            Utilities.stageQueue.postRunnable(new Runnable()
            {
              public void run()
              {
                MessagesController.getInstance().loadUnknownChannel(localObject, l);
              }
            });
            continue;
            ...
            Utilities.stageQueue.postRunnable(new Runnable()
            {
              public void run()
              {
                MessagesController.getInstance().getChannelDifference(i, j, l);
              }
            });
            continue;
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                MessagesController.getInstance().checkLastDialogMessage(localObject, this.val$peer, l);
              }
            });
            continue;
            label297:
          ...
          for (;;)
          {
            try
            {
              ...
              if (paramArrayList == null)
              {
                ...
                if (paramArrayList != null) {
                  localArrayList3.add(Long.valueOf(j));
                }
                if (k <= 0) {
                  continue;
                }
                k = Math.min(paramInt3, paramInt2) + k;
                i = Math.min(i, k);
                ...
                if (localArrayList2 == null)
                {
                  ...
                  localSparseArray.put(k, localArrayList1);
                }
                if (localStringBuilder.length() != 0) {
                  localStringBuilder.append(",");
                }
          ...
          for (;;)
          {
            ...
            catch (Exception localException2)
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.getInstance().markChannelDialogMessageAsDeleted(localArrayList1, MessagesStorage.21.this.val$channelId);
                }
              });
              ...
              if (!localArrayList1.isEmpty()) {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesDeleted, new Object[] { localArrayList1, Integer.valueOf(MessagesStorage.21.this.val$channelId) });
                  }
                });
              }
              return;
  ...
  public int getChannelPtsSync(final int paramInt)
  {
    ...
    getInstance().getStorageQueue().postRunnable(new Runnable()
    {
      ...
      public void run()
      {
        ...
        //   3: astore_1
        //   4: aload_0
        //   5: getfield 23	org/telegram/messenger/MessagesStorage$81:this$0	Lorg/telegram/messenger/MessagesStorage;
        ...
        //   23: aload_0
        //   24: getfield 25	org/telegram/messenger/MessagesStorage$81:val$channelId	I
        //   27: ineg
        ...
        //   56: astore_2
        //   57: aload_0
        //   58: getfield 27	org/telegram/messenger/MessagesStorage$81:val$pts	[Ljava/lang/Integer;
        //   61: iconst_0
        //   62: aload_3
        //   63: iconst_0
        ...
        //   79: aload_0
        //   80: getfield 29	org/telegram/messenger/MessagesStorage$81:val$semaphore	Ljava/util/concurrent/Semaphore;
        //   83: ifnull +10 -> 93
        //   86: aload_0
        //   87: getfield 29	org/telegram/messenger/MessagesStorage$81:val$semaphore	Ljava/util/concurrent/Semaphore;
    ...
    this.storageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        Utilities.stageQueue.postRunnable(new Runnable()
        {
          public void run()
          {
            MessagesController.getInstance().processLoadedUserPhotos(localphotos_Photos, MessagesStorage.23.this.val$did, MessagesStorage.23.this.val$offset, MessagesStorage.23.this.val$count, MessagesStorage.23.this.val$max_id, true, MessagesStorage.23.this.val$classGuid);
          }
        });
      }
    });
  ...
  public void getDialogs(final int paramInt1, final int paramInt2)
  {
    this.storageQueue.postRunnable(new Runnable()
    {
      ...
      public void run()
      {
        ...
        //   73: astore 12
        //   75: aload_0
        //   76: getfield 20	org/telegram/messenger/MessagesStorage$78:this$0	Lorg/telegram/messenger/MessagesStorage;
        ...
        //   92: iconst_0
        //   93: aload_0
        //   94: getfield 22	org/telegram/messenger/MessagesStorage$78:val$offset	I
        //   97: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   100: aastore
        //   101: dup
        //   102: iconst_1
        //   103: aload_0
        //   104: getfield 24	org/telegram/messenger/MessagesStorage$78:val$count	I
        ...
        //   459: aload 14
        //   461: bipush 13
        //   463: invokevirtual 192	org/telegram/SQLite/SQLiteCursor:isNull	(I)Z
        //   466: ifne +59 -> 525
        //   469: aload 14
        //   471: bipush 13
        //   473: invokevirtual 143	org/telegram/SQLite/SQLiteCursor:byteBufferValue	(I)Lorg/telegram/tgnet/NativeByteBuffer;
        //   476: astore 17
        //   478: aload 17
        //   480: ifnull +45 -> 525
        //   483: aload 16
        ...
        //   487: aload 17
        //   489: iconst_0
        //   490: invokevirtual 149	org/telegram/tgnet/NativeByteBuffer:readInt32	(Z)I
        //   493: iconst_0
        //   494: invokestatic 155	org/telegram/tgnet/TLRPC$Message:TLdeserialize	(Lorg/telegram/tgnet/AbstractSerializedData;IZ)Lorg/telegram/tgnet/TLRPC$Message;
        //   497: putfield 196	org/telegram/tgnet/TLRPC$Message:replyMessage	Lorg/telegram/tgnet/TLRPC$Message;
        //   500: aload 17
        //   502: invokevirtual 158	org/telegram/tgnet/NativeByteBuffer:reuse	()V
        //   505: aload 16
        //   507: getfield 196	org/telegram/tgnet/TLRPC$Message:replyMessage	Lorg/telegram/tgnet/TLRPC$Message;
        //   510: ifnull +15 -> 525
        //   513: aload 16
        //   515: getfield 196	org/telegram/tgnet/TLRPC$Message:replyMessage	Lorg/telegram/tgnet/TLRPC$Message;
        //   518: aload 9
        //   520: aload 10
        //   522: invokestatic 179	org/telegram/messenger/MessagesStorage:addUsersAndChatsFromMessage	(Lorg/telegram/tgnet/TLRPC$Message;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   525: aload 16
        //   527: getfield 196	org/telegram/tgnet/TLRPC$Message:replyMessage	Lorg/telegram/tgnet/TLRPC$Message;
        //   530: ifnonnull +79 -> 609
        //   533: aload 16
        //   535: getfield 182	org/telegram/tgnet/TLRPC$Message:reply_to_msg_id	I
        //   538: i2l
        //   539: lstore 5
        //   541: lload 5
        //   543: lstore_3
        //   544: aload 16
        //   546: getfield 200	org/telegram/tgnet/TLRPC$Message:to_id	Lorg/telegram/tgnet/TLRPC$Peer;
        //   549: getfield 205	org/telegram/tgnet/TLRPC$Peer:channel_id	I
        //   552: ifeq +19 -> 571
        //   555: lload 5
        //   557: aload 16
        //   559: getfield 200	org/telegram/tgnet/TLRPC$Message:to_id	Lorg/telegram/tgnet/TLRPC$Peer;
        //   562: getfield 205	org/telegram/tgnet/TLRPC$Peer:channel_id	I
        //   565: i2l
        //   566: bipush 32
        //   568: lshl
        //   569: lor
        ...
        //   571: aload 13
        //   573: lload_3
        //   574: invokestatic 210	java/lang/Long:valueOf	(J)Ljava/lang/Long;
        //   577: invokevirtual 213	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
        //   580: ifne +13 -> 593
        //   583: aload 13
        //   585: lload_3
        //   586: invokestatic 210	java/lang/Long:valueOf	(J)Ljava/lang/Long;
        //   589: invokevirtual 53	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   592: pop
        //   593: aload 12
        //   595: aload 15
        //   597: getfield 97	org/telegram/tgnet/TLRPC$TL_dialog:id	J
        //   600: invokestatic 210	java/lang/Long:valueOf	(J)Ljava/lang/Long;
        //   603: aload 16
        //   605: invokevirtual 217	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
        //   608: pop
        //   609: aload 15
        //   611: getfield 97	org/telegram/tgnet/TLRPC$TL_dialog:id	J
        //   614: l2i
        //   615: istore_1
        //   616: aload 15
        //   618: getfield 97	org/telegram/tgnet/TLRPC$TL_dialog:id	J
        //   621: bipush 32
        //   623: lshr
        //   624: l2i
        //   625: istore_2
        ...
        //   630: iload_2
        //   631: iconst_1
        //   632: if_icmpne +100 -> 732
        //   635: aload 10
        //   637: iload_1
        //   638: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   641: invokevirtual 213	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
        //   644: ifne -521 -> 123
        //   647: aload 10
        //   649: iload_1
        //   650: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   653: invokevirtual 53	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   656: pop
        //   657: goto -534 -> 123
        //   660: astore 9
        //   662: aload 7
        //   664: getfield 139	org/telegram/tgnet/TLRPC$messages_Dialogs:dialogs	Ljava/util/ArrayList;
        //   667: invokevirtual 220	java/util/ArrayList:clear	()V
        //   670: aload 7
        //   672: getfield 223	org/telegram/tgnet/TLRPC$messages_Dialogs:users	Ljava/util/ArrayList;
        //   675: invokevirtual 220	java/util/ArrayList:clear	()V
        //   678: aload 7
        //   680: getfield 226	org/telegram/tgnet/TLRPC$messages_Dialogs:chats	Ljava/util/ArrayList;
        //   683: invokevirtual 220	java/util/ArrayList:clear	()V
        //   686: aload 8
        //   688: invokevirtual 220	java/util/ArrayList:clear	()V
        //   691: ldc -28
        //   693: aload 9
        //   695: invokestatic 234	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   698: invokestatic 240	org/telegram/messenger/MessagesController:getInstance	()Lorg/telegram/messenger/MessagesController;
        //   701: aload 7
        //   703: aload 8
        //   705: iconst_0
        //   706: bipush 100
        ...
        //   709: iconst_1
        //   710: iconst_0
        //   711: invokevirtual 244	org/telegram/messenger/MessagesController:processLoadedDialogs	(Lorg/telegram/tgnet/TLRPC$messages_Dialogs;Ljava/util/ArrayList;IIIZZ)V
        //   714: return
        //   715: iconst_1
        //   716: istore_1
        //   717: goto -501 -> 216
        ...
        //   722: ldc -28
        //   724: aload 16
        //   726: invokestatic 234	org/telegram/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   729: goto -120 -> 609
        //   732: iload_1
        //   733: ifle +28 -> 761
        //   736: aload 9
        //   738: iload_1
        //   739: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   742: invokevirtual 213	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
        //   745: ifne -622 -> 123
        //   748: aload 9
        //   750: iload_1
        //   751: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   754: invokevirtual 53	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   757: pop
        //   758: goto -635 -> 123
        //   761: aload 10
        //   763: iload_1
        //   764: ineg
        //   765: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   768: invokevirtual 213	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
        //   771: ifne -648 -> 123
        //   774: aload 10
        //   776: iload_1
        //   777: ineg
        //   778: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   781: invokevirtual 53	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   784: pop
        //   785: goto -662 -> 123
        //   788: aload 11
        //   790: iload_2
        //   791: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   794: invokevirtual 213	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
        //   797: ifne -674 -> 123
        //   800: aload 11
        //   802: iload_2
        //   803: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   806: invokevirtual 53	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   809: pop
        //   810: goto -687 -> 123
        //   813: aload 14
        //   815: invokevirtual 247	org/telegram/SQLite/SQLiteCursor:dispose	()V
        //   818: aload 13
        //   820: invokevirtual 250	java/util/ArrayList:isEmpty	()Z
        //   823: ifne +171 -> 994
        //   826: aload_0
        //   827: getfield 20	org/telegram/messenger/MessagesStorage$78:this$0	Lorg/telegram/messenger/MessagesStorage;
        //   830: invokestatic 60	org/telegram/messenger/MessagesStorage:access$000	(Lorg/telegram/messenger/MessagesStorage;)Lorg/telegram/SQLite/SQLiteDatabase;
        //   833: getstatic 66	java/util/Locale:US	Ljava/util/Locale;
        //   836: ldc -4
        //   838: iconst_1
        ...
        //   844: ldc -2
        //   846: aload 13
        //   848: invokestatic 260	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   851: aastore
        //   852: invokestatic 74	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
        //   855: iconst_0
        //   856: anewarray 4	java/lang/Object
        //   859: invokevirtual 80	org/telegram/SQLite/SQLiteDatabase:queryFinalized	(Ljava/lang/String;[Ljava/lang/Object;)Lorg/telegram/SQLite/SQLiteCursor;
        //   862: astore 13
        //   864: aload 13
        //   866: invokevirtual 86	org/telegram/SQLite/SQLiteCursor:next	()Z
        //   869: ifeq +120 -> 989
        //   872: aload 13
        //   874: iconst_0
        //   875: invokevirtual 143	org/telegram/SQLite/SQLiteCursor:byteBufferValue	(I)Lorg/telegram/tgnet/NativeByteBuffer;
        //   878: astore 15
        //   880: aload 15
        //   882: ifnull -18 -> 864
        //   885: aload 15
        //   887: aload 15
        //   889: iconst_0
        //   890: invokevirtual 149	org/telegram/tgnet/NativeByteBuffer:readInt32	(Z)I
        //   893: iconst_0
        //   894: invokestatic 155	org/telegram/tgnet/TLRPC$Message:TLdeserialize	(Lorg/telegram/tgnet/AbstractSerializedData;IZ)Lorg/telegram/tgnet/TLRPC$Message;
        //   897: astore 14
        //   899: aload 15
        //   901: invokevirtual 158	org/telegram/tgnet/NativeByteBuffer:reuse	()V
        //   904: aload 14
        //   906: aload 13
        //   908: iconst_1
        //   909: invokevirtual 101	org/telegram/SQLite/SQLiteCursor:intValue	(I)I
        //   912: putfield 166	org/telegram/tgnet/TLRPC$Message:id	I
        //   915: aload 14
        //   917: aload 13
        //   919: iconst_2
        //   920: invokevirtual 101	org/telegram/SQLite/SQLiteCursor:intValue	(I)I
        //   923: putfield 263	org/telegram/tgnet/TLRPC$Message:date	I
        //   926: aload 14
        //   928: aload 13
        //   930: iconst_3
        //   931: invokevirtual 93	org/telegram/SQLite/SQLiteCursor:longValue	(I)J
        //   934: putfield 172	org/telegram/tgnet/TLRPC$Message:dialog_id	J
        //   937: aload 14
        //   939: aload 9
        //   941: aload 10
        //   943: invokestatic 179	org/telegram/messenger/MessagesStorage:addUsersAndChatsFromMessage	(Lorg/telegram/tgnet/TLRPC$Message;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   946: aload 12
        //   948: aload 14
        //   950: getfield 172	org/telegram/tgnet/TLRPC$Message:dialog_id	J
        //   953: invokestatic 210	java/lang/Long:valueOf	(J)Ljava/lang/Long;
        //   956: invokevirtual 267	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
        //   959: checkcast 151	org/telegram/tgnet/TLRPC$Message
        //   962: astore 15
        //   964: aload 15
        //   966: ifnull -102 -> 864
        //   969: aload 15
        //   971: aload 14
        //   973: putfield 196	org/telegram/tgnet/TLRPC$Message:replyMessage	Lorg/telegram/tgnet/TLRPC$Message;
        //   976: aload 14
        //   978: aload 15
        //   980: getfield 172	org/telegram/tgnet/TLRPC$Message:dialog_id	J
        //   983: putfield 172	org/telegram/tgnet/TLRPC$Message:dialog_id	J
        //   986: goto -122 -> 864
        //   989: aload 13
        //   991: invokevirtual 247	org/telegram/SQLite/SQLiteCursor:dispose	()V
        //   994: aload 11
        //   996: invokevirtual 250	java/util/ArrayList:isEmpty	()Z
        //   999: ifne +21 -> 1020
        //   1002: aload_0
        //   1003: getfield 20	org/telegram/messenger/MessagesStorage$78:this$0	Lorg/telegram/messenger/MessagesStorage;
        //   1006: ldc -2
        //   1008: aload 11
        //   1010: invokestatic 260	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   1013: aload 8
        //   1015: aload 9
        //   1017: invokevirtual 271	org/telegram/messenger/MessagesStorage:getEncryptedChatsInternal	(Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   1020: aload 10
        //   1022: invokevirtual 250	java/util/ArrayList:isEmpty	()Z
        //   1025: ifne +22 -> 1047
        //   1028: aload_0
        //   1029: getfield 20	org/telegram/messenger/MessagesStorage$78:this$0	Lorg/telegram/messenger/MessagesStorage;
        //   1032: ldc -2
        //   1034: aload 10
        //   1036: invokestatic 260	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   1039: aload 7
        //   1041: getfield 226	org/telegram/tgnet/TLRPC$messages_Dialogs:chats	Ljava/util/ArrayList;
        //   1044: invokevirtual 275	org/telegram/messenger/MessagesStorage:getChatsInternal	(Ljava/lang/String;Ljava/util/ArrayList;)V
        //   1047: aload 9
        //   1049: invokevirtual 250	java/util/ArrayList:isEmpty	()Z
        //   1052: ifne +22 -> 1074
        //   1055: aload_0
        //   1056: getfield 20	org/telegram/messenger/MessagesStorage$78:this$0	Lorg/telegram/messenger/MessagesStorage;
        //   1059: ldc -2
        //   1061: aload 9
        //   1063: invokestatic 260	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   1066: aload 7
        //   1068: getfield 223	org/telegram/tgnet/TLRPC$messages_Dialogs:users	Ljava/util/ArrayList;
        //   1071: invokevirtual 278	org/telegram/messenger/MessagesStorage:getUsersInternal	(Ljava/lang/String;Ljava/util/ArrayList;)V
        //   1074: invokestatic 240	org/telegram/messenger/MessagesController:getInstance	()Lorg/telegram/messenger/MessagesController;
        //   1077: aload 7
        //   1079: aload 8
        //   1081: aload_0
        //   1082: getfield 22	org/telegram/messenger/MessagesStorage$78:val$offset	I
        //   1085: aload_0
        //   1086: getfield 24	org/telegram/messenger/MessagesStorage$78:val$count	I
        //   1089: iconst_1
        //   1090: iconst_0
        //   1091: iconst_0
        //   1092: invokevirtual 244	org/telegram/messenger/MessagesController:processLoadedDialogs	(Lorg/telegram/tgnet/TLRPC$messages_Dialogs;Ljava/util/ArrayList;IIIZZ)V
        //   1095: return
        //   1096: iconst_0
        //   1097: istore_1
        //   1098: goto -882 -> 216
        ...
        //   253	333	3	l1	long
        //   539	17	5	l2	long
        //   7	1071	7	localmessages_Dialogs	TLRPC.messages_Dialogs
        //   16	1064	8	localArrayList1	ArrayList
        //   25	494	9	localArrayList2	ArrayList
        //   660	402	9	localException1	Exception
        //   46	989	10	localArrayList3	ArrayList
        //   55	954	11	localArrayList4	ArrayList
        //   73	874	12	localHashMap	HashMap
        //   64	926	13	localObject1	Object
        //   121	856	14	localObject2	Object
        //   138	841	15	localObject3	Object
        //   345	259	16	localMessage	TLRPC.Message
        //   720	5	16	localException2	Exception
        //   326	175	17	localNativeByteBuffer	NativeByteBuffer
        // Exception table:
        //   from	to	target	type
        //   18	123	660	java/lang/Exception
        //   123	213	660	java/lang/Exception
        //   216	254	660	java/lang/Exception
        //   257	269	660	java/lang/Exception
        //   275	309	660	java/lang/Exception
        //   309	328	660	java/lang/Exception
        //   333	352	660	java/lang/Exception
        //   357	388	660	java/lang/Exception
        //   392	398	660	java/lang/Exception
        //   398	440	660	java/lang/Exception
        //   609	626	660	java/lang/Exception
        //   635	657	660	java/lang/Exception
        //   722	729	660	java/lang/Exception
        //   736	758	660	java/lang/Exception
        //   761	785	660	java/lang/Exception
        //   788	810	660	java/lang/Exception
        //   813	864	660	java/lang/Exception
        //   864	880	660	java/lang/Exception
        //   885	964	660	java/lang/Exception
        //   969	986	660	java/lang/Exception
        //   989	994	660	java/lang/Exception
        //   994	1020	660	java/lang/Exception
        //   1020	1047	660	java/lang/Exception
        //   1047	1074	660	java/lang/Exception
        //   1074	1095	660	java/lang/Exception
        //   440	478	720	java/lang/Exception
        //   483	525	720	java/lang/Exception
        //   525	541	720	java/lang/Exception
        //   544	571	720	java/lang/Exception
        //   571	593	720	java/lang/Exception
        //   593	609	720	java/lang/Exception
      }
    });
  }
    ...
    this.storageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            MediaController.getInstance().processDownloadObjects(MessagesStorage.62.this.val$type, localException);
          }
        });
      }
    });
  ...
  public TLObject getSentFile(final String paramString, final int paramInt)
  {
    ...
    this.storageQueue.postRunnable(new Runnable()
    {
      ...
      public void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 27	org/telegram/messenger/MessagesStorage$49:val$path	Ljava/lang/String;
        //   4: invokestatic 46	org/telegram/messenger/Utilities:MD5	(Ljava/lang/String;)Ljava/lang/String;
        //   7: astore_1
        //   8: aload_1
        //   9: ifnull +102 -> 111
        //   12: aload_0
        //   13: getfield 25	org/telegram/messenger/MessagesStorage$49:this$0	Lorg/telegram/messenger/MessagesStorage;
        ...
        //   33: iconst_1
        //   34: aload_0
        //   35: getfield 29	org/telegram/messenger/MessagesStorage$49:val$type	I
        ...
        //   89: ifeq +30 -> 119
        //   92: aload_0
        //   93: getfield 31	org/telegram/messenger/MessagesStorage$49:val$result	Ljava/util/ArrayList;
        //   96: aload_3
        ...
        //   111: aload_0
        //   112: getfield 33	org/telegram/messenger/MessagesStorage$49:val$semaphore	Ljava/util/concurrent/Semaphore;
        ...
        //   123: ifeq -16 -> 107
        //   126: aload_0
        //   127: getfield 31	org/telegram/messenger/MessagesStorage$49:val$result	Ljava/util/ArrayList;
        //   130: aload_3
        ...
        //   151: aload_0
        //   152: getfield 33	org/telegram/messenger/MessagesStorage$49:val$semaphore	Ljava/util/concurrent/Semaphore;
        //   155: invokevirtual 121	java/util/concurrent/Semaphore:release	()V
        //   158: return
        //   159: astore_1
        //   160: aload_0
        //   161: getfield 33	org/telegram/messenger/MessagesStorage$49:val$semaphore	Ljava/util/concurrent/Semaphore;
      ...
      public void run()
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if ((!((SQLiteCursor)localObject2).isNull(2)) && (((SQLiteCursor)localObject2).intValue(2) == 1)) {
              continue;
            }
            l = ((SQLiteCursor)localObject2).longValue(0);
            localHashMap.put(Long.valueOf(l), Integer.valueOf(((SQLiteCursor)localObject2).intValue(1)));
        ...
        if (((StringBuilder)localObject3).length() > 0)
        {
          localObject3 = MessagesStorage.this.database.queryFinalized("SELECT read_state, data, send_state, mid, date, uid FROM messages WHERE uid IN (" + ((StringBuilder)localObject3).toString() + ") AND out = 0 AND read_state IN(0,2) ORDER BY date DESC LIMIT 50", new Object[0]);
          while (((SQLiteCursor)localObject3).next())
          {
            NativeByteBuffer localNativeByteBuffer = ((SQLiteCursor)localObject3).byteBufferValue(1);
            if (localNativeByteBuffer != null)
            {
              TLRPC.Message localMessage = TLRPC.Message.TLdeserialize(localNativeByteBuffer, localNativeByteBuffer.readInt32(false), false);
              localNativeByteBuffer.reuse();
              MessageObject.setUnreadFlags(localMessage, ((SQLiteCursor)localObject3).intValue(0));
              localMessage.id = ((SQLiteCursor)localObject3).intValue(3);
              localMessage.date = ((SQLiteCursor)localObject3).intValue(4);
              localMessage.dialog_id = ((SQLiteCursor)localObject3).longValue(5);
              ((ArrayList)localObject2).add(localMessage);
              i = (int)localMessage.dialog_id;
              MessagesStorage.addUsersAndChatsFromMessage(localMessage, (ArrayList)localObject1, localArrayList1);
              localMessage.send_state = ((SQLiteCursor)localObject3).intValue(2);
              if (((localMessage.to_id.channel_id == 0) && (!MessageObject.isUnread(localMessage)) && (i != 0)) || (localMessage.id > 0)) {
                localMessage.send_state = 0;
              }
              if ((i == 0) && (!((SQLiteCursor)localObject3).isNull(5))) {
                localMessage.random_id = ((SQLiteCursor)localObject3).longValue(5);
              }
            }
          }
          ((SQLiteCursor)localObject3).dispose();
          if (!localArrayList2.isEmpty()) {
            MessagesStorage.this.getEncryptedChatsInternal(TextUtils.join(",", localArrayList2), localArrayList5, (ArrayList)localObject1);
          }
          if (!((ArrayList)localObject1).isEmpty()) {
            MessagesStorage.this.getUsersInternal(TextUtils.join(",", (Iterable)localObject1), localArrayList3);
          }
          if (!localArrayList1.isEmpty()) {
            MessagesStorage.this.getChatsInternal(TextUtils.join(",", localArrayList1), localArrayList4);
          }
        }
        for (int i = 0;; i = j + 1)
        {
          ...
          {
            localObject1 = (TLRPC.Chat)localArrayList4.get(i);
            j = i;
            if (localObject1 != null) {
              if (!((TLRPC.Chat)localObject1).left)
              {
                j = i;
                if (((TLRPC.Chat)localObject1).migrated_to == null) {}
              }
              else
              {
                l = -((TLRPC.Chat)localObject1).id;
                MessagesStorage.this.database.executeFast("UPDATE dialogs SET unread_count = 0, unread_count_i = 0 WHERE did = " + l).stepThis().dispose();
                MessagesStorage.this.database.executeFast(String.format(Locale.US, "UPDATE messages SET read_state = 3 WHERE uid = %d AND mid > 0 AND read_state IN(0,2) AND out = 0", new Object[] { Long.valueOf(l) })).stepThis().dispose();
                localArrayList4.remove(i);
                k = i - 1;
                localException.remove(Long.valueOf(-((TLRPC.Chat)localObject1).id));
              }
            }
          }
          else
          {
            for (i = 0;; i = j + 1)
            {
              ...
              j = i;
              if (((TLRPC.Message)((ArrayList)localObject2).get(i)).dialog_id == -((TLRPC.Chat)localObject1).id)
              {
                ...
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    NotificationsController.getInstance().processLoadedUnreadMessages(localException, localObject2, localArrayList3, localArrayList4, localArrayList5);
                  }
                });
                return;
              }
        ...
        do
        {
          try
          {
            ...
            for (;;)
            {
              ...
              localObject3 = MessagesStorage.this.database.queryFinalized(String.format(Locale.US, "SELECT mid, data FROM messages WHERE mid = %d", new Object[] { Long.valueOf(l1) }), new Object[0]);
  ...
  public void removeWebRecent(final MediaController.SearchImage paramSearchImage)
  {
    if (paramSearchImage == null) {
      return;
    }
    this.storageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        try
        {
          MessagesStorage.this.database.executeFast("DELETE FROM web_recent_v3 WHERE id = '" + paramSearchImage.id + "'").stepThis().dispose();
          return;
        }
        catch (Exception localException)
        {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\messenger\MessagesStorage.class
