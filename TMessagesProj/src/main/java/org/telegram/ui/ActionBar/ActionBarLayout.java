  ...
  extends FrameLayout
{
  ...
  public ActionBarLayout(Context paramContext)
  {
    ...
    {
      layerShadowDrawable = getResources().getDrawable(2130837923);
      headerShadowDrawable = getResources().getDrawable(2130837802);
  ...
  private void startLayoutAnimation(final boolean paramBoolean1, final boolean paramBoolean2)
  {
    ...
    Runnable local2 = new Runnable()
    {
      public void run()
      {
        ...
        ActionBarLayout.access$816(ActionBarLayout.this, (float)l1 / 150.0F);
  ...
  public void showLastFragment()
  {
    ...
    while (i < this.fragmentsStack.size() - 1)
    {
      ...
      if (((BaseFragment)localObject1).actionBar != null)
      {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ActionBar\ActionBarLayout.class
