  ...
  extends FrameLayout
{
  ...
  private void createTitleTextView()
  {
    ...
    this.titleTextView.setTextColor(MihanTheme.contrastColor(MihanTheme.getThemeColor()));
    this.titleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
    addView(this.titleTextView, 0, LayoutHelper.createFrame(-2, -2, 51));
    SharedPreferences localSharedPreferences1 = ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0);
    this.ghostImageView = new ImageView(getContext());
    this.ghostImageView.setImageResource(2130837863);
    SharedPreferences localSharedPreferences2 = ApplicationLoader.applicationContext.getSharedPreferences("Mihantheme", 0);
    MihanTheme.setColorFilter(this.ghostImageView.getDrawable(), MihanTheme.getActionBarIconColor(localSharedPreferences2));
    this.ghostImageView.setScaleType(ImageView.ScaleType.CENTER);
    setGhostImage(localSharedPreferences1.getBoolean("ghost_mode", false));
    addView(this.ghostImageView, LayoutHelper.createFrame(-2, -2.0F, 81, 0.0F, 0.0F, 0.0F, 4.0F));
  }
  ...
  private void createsubtitleTextView()
  {
    ...
    this.subtitleTextView.setTextColor(MihanTheme.contrastColor(MihanTheme.getThemeColor()));
  }
  ...
  public void setBackButtonImage(int paramInt)
  {
    ...
    for (int i = 8;; i = 0)
    {
      ...
      if (this.backButtonImageView.getDrawable() != null)
      {
        paramInt = MihanTheme.contrastColor(MihanTheme.getThemeColor(ApplicationLoader.applicationContext.getSharedPreferences("Mihantheme", 0)));
        MihanTheme.setColorFilter(this.backButtonImageView.getDrawable(), paramInt);
      }
      return;
    }
  }
  ...
  public void setGhostImage(boolean paramBoolean)
  {
    ImageView localImageView;
    if (this.ghostImageView != null)
    {
      localImageView = this.ghostImageView;
      if (!paramBoolean) {
        break label24;
      }
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ActionBar\ActionBar.class
