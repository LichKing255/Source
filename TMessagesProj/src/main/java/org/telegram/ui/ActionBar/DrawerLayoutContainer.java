  ...
  extends FrameLayout
{
  ...
  public DrawerLayoutContainer(Context paramContext)
  {
    ...
    this.shadowLeft = getResources().getDrawable(2130837980);
  }
  ...
  private void setDrawerMenuBG(View paramView)
  {
    int i;
    if (paramView != null)
    {
      SharedPreferences localSharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences("Mihantheme", 0);
      i = localSharedPreferences.getInt("theme_drawer_menu_color", -1);
      int j = localSharedPreferences.getInt("theme_drawer_menu_gradient", 0);
      int k = localSharedPreferences.getInt("theme_drawer_menu_gcolor", i);
      if (j != 0) {
        paramView.setBackgroundDrawable(MihanTheme.setGradiant(i, k, MihanTheme.getGradientOrientation(j)));
      }
    }
    else
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label294:
    setDrawerMenuBG(getDrawerLayout());
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if ((!ApplicationLoader.applicationContext.getSharedPreferences("Mihanconfig", 0).getBoolean("swipe_tabs", false)) || ((int)paramMotionEvent.getX() <= 100)) {
        break;
      }
      bool1 = bool3;
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ActionBar\DrawerLayoutContainer.class
