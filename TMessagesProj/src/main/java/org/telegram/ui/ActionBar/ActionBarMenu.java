  ...
  extends LinearLayout
{
  ...
  public ActionBarMenuItem addItem(int paramInt1, int paramInt2, int paramInt3, Drawable paramDrawable, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      paramInt1 = MihanTheme.contrastColor(MihanTheme.getThemeColor(ApplicationLoader.applicationContext.getSharedPreferences("Mihantheme", 0)));
      MihanTheme.setColorFilter(localActionBarMenuItem.iconView.getDrawable(), paramInt1);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ActionBar\ActionBarMenu.class
