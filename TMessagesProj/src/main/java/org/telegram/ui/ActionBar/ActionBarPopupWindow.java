  ...
  extends PopupWindow
{
  ...
  {
    setFocusable(false);
    if ((animationEnabled) && (paramBoolean))
    {
    ...
    extends FrameLayout
  {
    ...
    public ActionBarPopupWindowLayout(Context paramContext)
    {
      ...
      if (backgroundDrawable == null) {
        backgroundDrawable = getResources().getDrawable(2130838089);
      }
    ...
    private void startChildAnimation(View paramView)
    {
      ...
      if (ActionBarPopupWindow.animationEnabled)
      {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ActionBar\ActionBarPopupWindow.class
