  ...
  extends FrameLayout
{
  ...
  public ActionBarMenuItem(Context paramContext, ActionBarMenu paramActionBarMenu, int paramInt)
  {
    ...
    paramContext = (FrameLayout.LayoutParams)this.iconView.getLayoutParams();
    paramContext.width = -1;
    paramContext.height = -1;
    this.iconView.setLayoutParams(paramContext);
  }
  ...
  public TextView addSubItem(int paramInt1, String paramString, int paramInt2)
  {
    ...
    localTextView.setBackgroundResource(2130837932);
  ...
  public ActionBarMenuItem setIsSearchField(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((Field)localObject).set(this.searchField, Integer.valueOf(2130838114));
      ...
      this.clearButton.setImageResource(2130837840);
      i = ApplicationLoader.applicationContext.getSharedPreferences("Mihantheme", 0).getInt("theme_action_icon_color", -1);
      MihanTheme.setColorFilter(this.clearButton.getDrawable(), i);
  ...
  public void toggleSubMenu()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.popupWindow.setAnimationStyle(2131362066);
      break;
      label236:
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ActionBar\ActionBarMenuItem.class
