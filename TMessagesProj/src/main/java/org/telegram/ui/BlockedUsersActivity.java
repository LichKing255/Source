  ...
  implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("BlockedUsers", 2131165400));
    ...
    this.actionBar.createMenu().addItem(1, 2130838088);
    ...
    this.emptyTextView.setText(LocaleController.getString("NoBlocked", 2131166000));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
      {
        public boolean onItemLongClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          paramAnonymousView = LocaleController.getString("Unblock", 2131166418);
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        if (localUser != null)
        {
          ...
          paramView = LocaleController.getString("Bot", 2131165405).substring(0, 1).toUpperCase() + LocaleController.getString("Bot", 2131165405).substring(1);
      ...
      ((TextInfoCell)paramView).setText(LocaleController.getString("UnblockText", 2131166419));
      return paramView;
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\BlockedUsersActivity.class
