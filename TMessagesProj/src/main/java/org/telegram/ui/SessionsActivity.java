  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("SessionsTitle", 2131166304));
    ...
    this.emptyLayout.setBackgroundResource(2130837800);
    ...
    ((ImageView)localObject2).setImageResource(2130837736);
    ...
    ((TextView)localObject2).setText(LocaleController.getString("NoOtherSessions", 2131166012));
    this.emptyLayout.addView((View)localObject2);
    ...
    ((TextView)localObject2).setText(LocaleController.getString("NoOtherSessionsInfo", 2131166013));
    this.emptyLayout.addView((View)localObject2);
    localObject3 = (LinearLayout.LayoutParams)((TextView)localObject2).getLayoutParams();
    ...
    paramContext.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, final int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        while ((paramAnonymousInt < SessionsActivity.this.otherSessionsStartRow) || (paramAnonymousInt >= SessionsActivity.this.otherSessionsEndRow))
        {
          ...
          paramAnonymousAdapterView.setMessage(LocaleController.getString("AreYouSureSessions", 2131165358));
                  ...
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      ...
                      if ((paramAnonymous3TL_error == null) && ((paramAnonymous3TLObject instanceof TLRPC.TL_boolTrue))) {
                        Toast.makeText(SessionsActivity.this.getParentActivity(), LocaleController.getString("TerminateAllSessions", 2131166389), 0).show();
                      }
                      for (;;)
                      {
                        SessionsActivity.this.finishFragment();
                        return;
                        Toast.makeText(SessionsActivity.this.getParentActivity(), LocaleController.getString("UnknownError", 2131166421), 0).show();
                      }
                    }
                  });
        ...
        paramAnonymousAdapterView = new AlertDialog.Builder(SessionsActivity.this.getParentActivity());
        paramAnonymousAdapterView.setMessage(LocaleController.getString("TerminateSessionQuestion", 2131166391));
        paramAnonymousAdapterView.setTitle(LocaleController.getString("AppName", 2131165338));
        paramAnonymousAdapterView.setPositiveButton(LocaleController.getString("OK", 2131166111), new DialogInterface.OnClickListener()
        {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        if (paramInt == SessionsActivity.this.terminateAllSessionsRow)
        {
          ...
          paramView.setText(LocaleController.getString("TerminateAllSessions", 2131166389), false);
          paramViewGroup = (ViewGroup)localObject;
        }
      }
      for (;;)
      {
        ...
        if (i == 1)
        {
          ...
          {
            ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("ClearOtherSessionsHelp", 2131165548));
          ...
          else
          {
            ...
            {
              ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("TerminateSessionInfo", 2131166390));
        ...
        else if (i == 2)
        {
          ...
          {
            ((HeaderCell)localObject).setText(LocaleController.getString("CurrentSession", 2131165580));
            paramViewGroup = (ViewGroup)localObject;
          }
          else
          {
            ...
            {
              ((HeaderCell)localObject).setText(LocaleController.getString("OtherSessions", 2131166130));
              paramViewGroup = (ViewGroup)localObject;
            }
          }
        }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\SessionsActivity.class
