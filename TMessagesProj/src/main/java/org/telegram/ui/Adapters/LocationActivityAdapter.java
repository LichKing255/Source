  ...
  private void updateCell()
  {
    if (this.sendLocationCell != null)
    {
      if (this.customLocation != null) {
        this.sendLocationCell.setText(LocaleController.getString("SendSelectedLocation", 2131166291), String.format(Locale.US, "(%f,%f)", new Object[] { Double.valueOf(this.customLocation.getLatitude()), Double.valueOf(this.customLocation.getLongitude()) }));
      }
    }
    else {
      return;
    ...
    {
      this.sendLocationCell.setText(LocaleController.getString("SendLocation", 2131166287), LocaleController.formatString("AccurateTo", 2131165250, new Object[] { LocaleController.formatPluralString("Meters", (int)this.gpsLocation.getAccuracy()) }));
      return;
    }
    this.sendLocationCell.setText(LocaleController.getString("SendLocation", 2131166287), LocaleController.getString("Loading", 2131165905));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 2)
      {
        ...
        ((GreySectionCell)paramViewGroup).setText(LocaleController.getString("NearbyPlaces", 2131165981));
      }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Adapters\LocationActivityAdapter.class
