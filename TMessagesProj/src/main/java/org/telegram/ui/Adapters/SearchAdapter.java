  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == this.searchResult.size())
    {
      ...
      if (paramView == null)
      {
        ...
        ((GreySectionCell)localObject1).setText(LocaleController.getString("GlobalSearch", 2131165777));
      }
    }
    label97:
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Adapters\SearchAdapter.class
