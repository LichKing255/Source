  ...
  extends BaseFragment
{
      ...
      if (LocaleController.isRTL)
      {
        ...
        this.problemText.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            {
              ChangePhoneActivity.this.needShowAlert(LocaleController.getString("NoMailInstalled", 2131166007));
            }
          }
        });
    ...
    private void createCodeTimer()
    {
      ...
      this.codeTimer.schedule(new TimerTask()
      {
        public void run()
        {
          ...
          ChangePhoneActivity.LoginActivitySmsView.access$2826(ChangePhoneActivity.LoginActivitySmsView.this, d1 - d2);
    ...
    private void createTimer()
    {
      ...
      this.timeTimer.schedule(new TimerTask()
      {
        public void run()
        {
          ...
          ChangePhoneActivity.LoginActivitySmsView.access$3326(ChangePhoneActivity.LoginActivitySmsView.this, d1 - d2);
            ...
            public void run()
            {
              ...
              if (ChangePhoneActivity.LoginActivitySmsView.this.time >= 1000)
              {
                ...
                if ((ChangePhoneActivity.LoginActivitySmsView.this.nextType == 4) || (ChangePhoneActivity.LoginActivitySmsView.this.nextType == 3)) {
                  ChangePhoneActivity.LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("CallText", 2131165424, new Object[] { Integer.valueOf(i), Integer.valueOf(j) }));
                }
              }
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (ChangePhoneActivity.LoginActivitySmsView.this.nextType == 2) {
                      ChangePhoneActivity.LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("SmsText", 2131166354, new Object[] { Integer.valueOf(i), Integer.valueOf(j) }));
                    }
                  }
                  if (ChangePhoneActivity.LoginActivitySmsView.this.progressView != null) {
                ...
                {
                  ChangePhoneActivity.LoginActivitySmsView.this.timeText.setText(LocaleController.getString("Calling", 2131165425));
            ...
            public void run()
            {
              ...
              for (;;)
              {
                ...
                if (paramAnonymousTL_error.text != null) {
                  ...
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("InvalidPhoneNumber", 2131165825));
                  }
                  else if ((paramAnonymousTL_error.text.contains("PHONE_CODE_EMPTY")) || (paramAnonymousTL_error.text.contains("PHONE_CODE_INVALID")))
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("InvalidCode", 2131165821));
                  }
                  else if (paramAnonymousTL_error.text.contains("PHONE_CODE_EXPIRED"))
                  {
                    ChangePhoneActivity.LoginActivitySmsView.this.onBackPressed();
                    ChangePhoneActivity.this.setPage(0, true, null, true);
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("CodeExpired", 2131165553));
                  }
                  else if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("FloodWait", 2131165691));
                  }
                  else if (paramAnonymousTL_error.code != 64536)
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("ErrorOccurred", 2131165672) + "\n" + paramAnonymousTL_error.text);
                  }
                }
              }
            }
    ...
    implements AdapterView.OnItemSelectedListener
  {
      ...
      if (LocaleController.isRTL)
      {
        ...
        this.codeField.addTextChangedListener(new TextWatcher()
        {
          public void afterTextChanged(Editable paramAnonymousEditable)
          {
            ...
            {
              ChangePhoneActivity.PhoneView.this.countryButton.setText(LocaleController.getString("ChooseCountry", 2131165541));
            ...
            for (;;)
            {
              ...
              localObject1 = null;
              break label447;
              ChangePhoneActivity.PhoneView.this.countryButton.setText(LocaleController.getString("WrongCountry", 2131166481));
              ChangePhoneActivity.PhoneView.this.phoneField.setHintText(null);
        ...
        paramContext = new TextView(paramContext);
        paramContext.setText(LocaleController.getString("ChangePhoneHelp", 2131165435));
    ...
    public String getHeaderName()
    {
      return LocaleController.getString("ChangePhoneNewNumber", 2131165436);
    }
    ...
    public void onNextPressed()
    {
      ...
      {
        ChangePhoneActivity.this.needShowAlert(LocaleController.getString("ChooseCountry", 2131165541));
        return;
      }
      if ((this.countryState == 2) && (!BuildVars.DEBUG_VERSION))
      {
        ChangePhoneActivity.this.needShowAlert(LocaleController.getString("WrongCountry", 2131166481));
        return;
      }
      if (this.codeField.length() == 0)
      {
                  ...
                  for (;;)
                  {
                    ...
                    if (paramAnonymousTL_error.text != null) {
                      if (paramAnonymousTL_error.text.contains("PHONE_NUMBER_INVALID")) {
                        ...
                        ChangePhoneActivity.this.needShowAlert(LocaleController.formatString("ChangePhoneNumberOccupied", 2131165437, new Object[] { ChangePhoneActivity.PhoneView.7.this.val$params.getString("phone") }));
                      } else {
                        ChangePhoneActivity.this.needShowAlert(LocaleController.getString("ErrorOccurred", 2131165672));
                      }
                    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ChangePhoneActivity.class
