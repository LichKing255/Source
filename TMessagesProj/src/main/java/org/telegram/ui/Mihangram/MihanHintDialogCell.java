...
public class MihanHintDialogCell
  extends FrameLayout
{
  ...
  public MihanHintDialogCell(Context paramContext)
  {
    super(paramContext);
    ...
    addView(this.imageView, LayoutHelper.createFrame(52, 52.0F, 49, 0.0F, 7.0F, 0.0F, 0.0F));
    this.nameTextView = new TextView(paramContext);
    this.nameTextView.setTextColor(-14606047);
    this.nameTextView.setTextSize(1, 11.0F);
    this.nameTextView.setMaxLines(2);
    this.nameTextView.setGravity(49);
    this.nameTextView.setLines(2);
    this.nameTextView.setEllipsize(TextUtils.TruncateAt.END);
    this.nameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
    addView(this.nameTextView, LayoutHelper.createFrame(-1, -2.0F, 51, 6.0F, 62.0F, 6.0F, 0.0F));
  ...
  public void setDialog(int paramInt, boolean paramBoolean, CharSequence paramCharSequence)
  {
    ...
    if (paramInt > 0)
    {
      ...
      for (;;)
      {
        ...
        this.imageView.setRoundRadius(paramInt);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Mihangram\MihanHintDialogCell.class
