  ...
  extends RecyclerView.Adapter
{
  ...
  public BatchDialogsAdapter(Context paramContext, int paramInt)
  {
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    {
      paramViewHolder = (BatchDialogCell)paramViewHolder.itemView;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    paramViewGroup = null;
    if (paramInt == 0) {
      paramViewGroup = new BatchDialogCell(this.mContext);
    }
    for (;;)
    {
  ...
  {
    if ((paramViewHolder.itemView instanceof BatchDialogCell)) {
      ((BatchDialogCell)paramViewHolder.itemView).checkCurrentDialogIndex();
    }
  }
