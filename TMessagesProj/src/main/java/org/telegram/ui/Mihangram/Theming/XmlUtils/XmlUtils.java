...
public class XmlUtils
{
  ...
  public static byte[] readByteArrayAttribute(XmlPullParser paramXmlPullParser, String paramString)
  {
    ...
    if (paramString != null) {
      paramXmlPullParser = Base64.decode(paramString, 0);
    }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    localXmlPullParser.setInput(paramInputStream, Charset.forName("UTF-8").name());
    ...
    throws XmlPullParserException, IOException
  {
    ...
    catch (NullPointerException paramXmlPullParser)
    {
      try
      {
        do
        {
          paramArrayOfString[i] = Boolean.parseBoolean(paramXmlPullParser.getAttributeValue(null, "value"));
          k = i;
    ...
    throws XmlPullParserException, IOException
  {
    ...
    try
    {
      ...
      {
        paramXmlPullParser = new Float(paramXmlPullParser.getAttributeValue(null, "value"));
        return paramXmlPullParser;
      }
    }
    catch (NullPointerException paramXmlPullParser)
    {
      ...
      {
        paramXmlPullParser = new Double(paramXmlPullParser.getAttributeValue(null, "value"));
        return paramXmlPullParser;
      }
    }
    catch (NumberFormatException paramXmlPullParser)
    ...
    if (paramString.equals("boolean")) {
      localBoolean = Boolean.valueOf(paramXmlPullParser.getAttributeValue(null, "value"));
    }
    return localBoolean;
  }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    localXmlSerializer.setOutput(paramOutputStream, Charset.forName("UTF-8").name());
    ...
    throws XmlPullParserException, IOException
  {
    ...
    localFastXmlSerializer.setOutput(paramOutputStream, Charset.forName("UTF-8").name());
