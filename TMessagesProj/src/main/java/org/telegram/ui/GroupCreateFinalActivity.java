  ...
  implements NotificationCenter.NotificationCenterDelegate, AvatarUpdater.AvatarUpdaterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.chatType == 1)
    {
      this.actionBar.setTitle(LocaleController.getString("NewBroadcastList", 2131165987));
      this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
      {
        public void onItemClick(final int paramAnonymousInt)
        {
          ...
          GroupCreateFinalActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", 2131165905));
          ...
          GroupCreateFinalActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", 2131165426), new DialogInterface.OnClickListener()
          {
      ...
      localObject = LocaleController.getString("EnterGroupNamePlaceholder", 2131165667);
      label415:
    ...
    for (int i = AndroidUtilities.dp(96.0F);; i = AndroidUtilities.dp(16.0F))
    {
      ...
      this.actionBar.setTitle(LocaleController.getString("NewGroup", 2131165989));
      break;
      bool = false;
      break label194;
      i = AndroidUtilities.dp(16.0F);
      ...
      i = 3;
      break label320;
      localObject = LocaleController.getString("EnterListName", 2131165668);
      break label415;
      i = 3;
      break label467;
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\GroupCreateFinalActivity.class
