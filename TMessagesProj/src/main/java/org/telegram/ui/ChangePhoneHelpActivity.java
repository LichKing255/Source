  ...
  extends BaseFragment
{
  public View createView(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      ((TextView)localObject2).setTypeface(MihanTheme.getMihanTypeFace());
      try
      {
        ((TextView)localObject2).setText(AndroidUtilities.replaceTags(LocaleController.getString("PhoneNumberHelp", 2131166171)));
        ((LinearLayout)localObject1).addView((View)localObject2);
        ...
        paramContext.setText(LocaleController.getString("PhoneNumberChange", 2131166170));
        ...
        paramContext.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            paramAnonymousView.setMessage(LocaleController.getString("PhoneNumberAlert", 2131166169));
        ...
        localObject1 = LocaleController.getString("NumberUnknown", 2131166110);
      }
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          ((TextView)localObject2).setText(LocaleController.getString("PhoneNumberHelp", 2131166171));
        }
      }
    }
  }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ChangePhoneHelpActivity.class
