  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("CacheSettings", 2131165421));
    ...
    paramContext.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if (paramAnonymousInt == CacheControlActivity.this.keepMediaRow)
        {
          ...
          localObject2 = LocaleController.getString("KeepMediaForever", 2131165849);
        ...
        do
        {
          ...
          if (paramAnonymousInt == CacheControlActivity.this.databaseRow)
          {
            ...
            paramAnonymousAdapterView.setMessage(LocaleController.getString("LocalDatabaseClear", 2131165909));
            paramAnonymousAdapterView.setPositiveButton(LocaleController.getString("CacheClear", 2131165419), new DialogInterface.OnClickListener()
            {
        ...
        if (paramAnonymousInt < 6)
        {
          ...
          if (paramAnonymousInt == 0)
          {
            ...
            paramAnonymousAdapterView = LocaleController.getString("LocalPhotoCache", 2131165913);
            label310:
          ...
          for (;;)
          {
            ...
            if (paramAnonymousInt == 1)
            {
              ...
              paramAnonymousAdapterView = LocaleController.getString("LocalVideoCache", 2131165914);
              break label310;
            }
            if (paramAnonymousInt == 2)
            {
              paramAnonymousLong = CacheControlActivity.this.documentsSize;
              paramAnonymousAdapterView = LocaleController.getString("LocalDocumentCache", 2131165911);
              break label310;
            }
            if (paramAnonymousInt == 3)
            {
              paramAnonymousLong = CacheControlActivity.this.musicSize;
              paramAnonymousAdapterView = LocaleController.getString("LocalMusicCache", 2131165912);
              break label310;
            }
            if (paramAnonymousInt == 4)
            {
              paramAnonymousLong = CacheControlActivity.this.audioSize;
              paramAnonymousAdapterView = LocaleController.getString("LocalAudioCache", 2131165906);
              break label310;
            }
            ...
            paramAnonymousAdapterView = LocaleController.getString("LocalCache", 2131165907);
            break label310;
            label530:
        ...
        paramAnonymousAdapterView.setTextAndIcon(LocaleController.getString("ClearMediaCache", 2131165547).toUpperCase(), 0);
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        {
          localTextSettingsCell.setTextAndValue(LocaleController.getString("LocalDatabase", 2131165908), AndroidUtilities.formatFileSize(CacheControlActivity.this.databaseSize), false);
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (paramInt == CacheControlActivity.this.cacheRow)
            {
              ...
              {
                localTextSettingsCell.setTextAndValue(LocaleController.getString("ClearMediaCache", 2131165547), LocaleController.getString("CalculatingSize", 2131165422), false);
                return paramViewGroup;
              }
              localObject = LocaleController.getString("ClearMediaCache", 2131165547);
              if (CacheControlActivity.this.totalSize == 0L) {}
              for (paramView = LocaleController.getString("CacheEmpty", 2131165420);; paramView = AndroidUtilities.formatFileSize(CacheControlActivity.this.totalSize))
              {
          ...
          for (;;)
          {
            localTextSettingsCell.setTextAndValue(LocaleController.getString("KeepMedia", 2131165848), paramView, false);
            return paramViewGroup;
            if (paramInt == 1) {
              paramView = LocaleController.formatPluralString("Months", 1);
            } else {
              paramView = LocaleController.getString("KeepMediaForever", 2131165849);
            }
          }
        ...
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.getString("LocalDatabaseInfo", 2131165910));
      ...
      ((TextInfoPrivacyCell)paramViewGroup).setText(AndroidUtilities.replaceTags(LocaleController.getString("KeepMediaInfo", 2131165850)));
      paramViewGroup.setBackgroundResource(2130837799);
      return paramViewGroup;
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\CacheControlActivity.class
