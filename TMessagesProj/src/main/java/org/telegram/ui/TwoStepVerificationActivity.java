  ...
  implements NotificationCenter.NotificationCenterDelegate
{
    ...
    do
    {
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
                {
                  ...
                  {
                    TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165338), LocaleController.formatString("FloodWaitTime", 2131165692, new Object[] { str }));
                    return;
                  }
                }
                TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165338), paramAnonymousTL_error.text);
              }
            });
          }
        }, 10);
      ...
      if (this.passwordSetState == 1)
      {
        if (!this.firstPassword.equals(this.passwordEditText.getText().toString())) {
          try
          {
            Toast.makeText(getParentActivity(), LocaleController.getString("PasswordDoNotMatch", 2131166152), 0).show();
      ...
      if (this.passwordSetState == 2)
      {
        ...
        if (this.hint.toLowerCase().equals(this.firstPassword.toLowerCase())) {
          try
          {
            Toast.makeText(getParentActivity(), LocaleController.getString("PasswordAsHintError", 2131166150), 0).show();
            onPasscodeError(false);
            return;
          }
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            if (paramAnonymousTL_error == null)
            {
              ...
              ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("PasswordReset", 2131166157));
            ...
            if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
            {
              ...
              {
                TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165338), LocaleController.formatString("FloodWaitTime", 2131165692, new Object[] { localObject }));
                return;
              }
            }
            TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165338), paramAnonymousTL_error.text);
        ...
        public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ...
              do
              {
                do
                {
                  do
                  {
                    ...
                    ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("YourPasswordSuccessText", 2131166508));
                    ((AlertDialog.Builder)localObject).setTitle(LocaleController.getString("YourPasswordSuccess", 2131166507));
                    localObject = TwoStepVerificationActivity.this.showDialog(((AlertDialog.Builder)localObject).create());
                ...
                ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("YourEmailAlmostThereText", 2131166500));
                ((AlertDialog.Builder)localObject).setTitle(LocaleController.getString("YourEmailAlmostThere", 2131166499));
                localObject = TwoStepVerificationActivity.this.showDialog(((AlertDialog.Builder)localObject).create());
              } while (localObject == null);
              ((Dialog)localObject).setCanceledOnTouchOutside(false);
              ((Dialog)localObject).setCancelable(false);
              ...
              {
                TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165338), LocaleController.getString("PasswordEmailInvalid", 2131166153));
                return;
              }
              if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
              {
  ...
  private void setPasswordSetState(int paramInt)
  {
    ...
    if (this.passwordSetState == 0)
    {
      this.actionBar.setTitle(LocaleController.getString("YourPassword", 2131166506));
      if ((this.currentPassword instanceof TLRPC.TL_account_noPassword))
      {
        this.titleTextView.setText(LocaleController.getString("PleaseEnterFirstPassword", 2131166191));
    ...
    for (;;)
    {
      this.passwordEditText.setText("");
      return;
      this.titleTextView.setText(LocaleController.getString("PleaseEnterPassword", 2131166192));
      break;
      if (this.passwordSetState == 1)
      {
        this.actionBar.setTitle(LocaleController.getString("YourPassword", 2131166506));
        this.titleTextView.setText(LocaleController.getString("PleaseReEnterPassword", 2131166193));
        this.passwordEditText.setImeOptions(5);
        this.passwordEditText.setTransformationMethod(PasswordTransformationMethod.getInstance());
        this.bottomTextView.setVisibility(4);
        this.bottomButton.setVisibility(4);
      ...
      {
        this.actionBar.setTitle(LocaleController.getString("PasswordHint", 2131166154));
        this.titleTextView.setText(LocaleController.getString("PasswordHintText", 2131166155));
        this.passwordEditText.setImeOptions(5);
      ...
      else
      {
        if (this.passwordSetState == 3)
        {
          this.actionBar.setTitle(LocaleController.getString("RecoveryEmail", 2131166207));
          this.titleTextView.setText(LocaleController.getString("YourEmail", 2131166498));
        ...
        {
          this.actionBar.setTitle(LocaleController.getString("PasswordRecovery", 2131166156));
          this.titleTextView.setText(LocaleController.getString("PasswordCode", 2131166151));
          this.bottomTextView.setText(LocaleController.getString("RestoreEmailSentInfo", 2131166237));
          this.bottomButton.setText(LocaleController.formatString("RestoreEmailTrouble", 2131166238, new Object[] { this.currentPassword.email_unconfirmed_pattern }));
          this.passwordEditText.setImeOptions(6);
          this.passwordEditText.setTransformationMethod(null);
  ...
  private void updateRows()
  {
    ...
    this.bottomButton.setVisibility(0);
    this.bottomTextView.setVisibility(4);
    this.bottomButton.setText(LocaleController.getString("ForgotPassword", 2131165697));
  ...
  public View createView(Context paramContext)
  {
    ...
    this.doneItem = this.actionBar.createMenu().addItemWithWidth(1, 2130837844, AndroidUtilities.dp(56.0F));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.bottomTextView.setText(LocaleController.getString("YourEmailInfo", 2131166501));
      ...
      this.bottomButton.setText(LocaleController.getString("YourEmailSkip", 2131166502));
      ...
      this.bottomButton.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if (TwoStepVerificationActivity.this.type == 0)
          {
                ...
                public void run(final TLObject paramAnonymous2TLObject, final TLRPC.TL_error paramAnonymous2TL_error)
                {
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      ...
                      TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165338), paramAnonymous2TL_error.text);
                    }
                  });
                }
              }, 10);
            ...
            TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("RestorePasswordNoEmailTitle", 2131166241), LocaleController.getString("RestorePasswordNoEmailText", 2131166240));
            return;
          }
          if (TwoStepVerificationActivity.this.passwordSetState == 4)
          {
            TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("RestorePasswordNoEmailTitle", 2131166241), LocaleController.getString("RestoreEmailTroubleText", 2131166239));
            return;
          }
          paramAnonymousView = new AlertDialog.Builder(TwoStepVerificationActivity.this.getParentActivity());
          paramAnonymousView.setMessage(LocaleController.getString("YourEmailSkipWarningText", 2131166504));
          paramAnonymousView.setTitle(LocaleController.getString("YourEmailSkipWarning", 2131166503));
          paramAnonymousView.setPositiveButton(LocaleController.getString("YourEmailSkip", 2131166502), new DialogInterface.OnClickListener()
          {
      ...
      this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
      {
        public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          paramAnonymousAdapterView.setMessage(LocaleController.getString("TurnPasswordOffQuestion", 2131166414));
      ...
      updateRows();
      this.actionBar.setTitle(LocaleController.getString("TwoStepVerification", 2131166415));
      this.titleTextView.setText(LocaleController.getString("PleaseEnterCurrentPassword", 2131166190));
    }
    for (;;)
    {
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        {
          paramView.setText(LocaleController.getString("ChangePassword", 2131165434), true);
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              paramView.setText(LocaleController.getString("SetAdditionalPassword", 2131166306), true);
              return paramViewGroup;
            }
            if (paramInt == TwoStepVerificationActivity.this.turnPasswordOffRow)
            {
              paramView.setText(LocaleController.getString("TurnPasswordOff", 2131166413), true);
              return paramViewGroup;
            }
            if (paramInt == TwoStepVerificationActivity.this.changeRecoveryEmailRow)
            {
              localObject = LocaleController.getString("ChangeRecoveryEmail", 2131165439);
            ...
            {
              paramView.setText(LocaleController.getString("SetRecoveryEmail", 2131166315), false);
              return paramViewGroup;
            }
            localObject = paramViewGroup;
          } while (paramInt != TwoStepVerificationActivity.this.abortPasswordRow);
          paramView.setTextColor(-2995895);
          paramView.setText(LocaleController.getString("AbortPassword", 2131165248), false);
          return paramViewGroup;
        ...
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.getString("SetAdditionalPasswordInfo", 2131166307));
        ...
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.formatString("EmailPasswordConfirmText", 2131165643, new Object[] { TwoStepVerificationActivity.this.currentPassword.email_unconfirmed_pattern }));
          paramViewGroup.setBackgroundResource(2130837801);
          return paramViewGroup;
        }
        if (paramInt == TwoStepVerificationActivity.this.passwordEnabledDetailRow)
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.getString("EnabledPasswordText", 2131165649));
          paramViewGroup.setBackgroundResource(2130837800);
          return paramViewGroup;
        }
        localObject = paramViewGroup;
      } while (paramInt != TwoStepVerificationActivity.this.passwordEmailVerifyDetailRow);
      ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.formatString("PendingEmailText", 2131166158, new Object[] { TwoStepVerificationActivity.this.currentPassword.email_unconfirmed_pattern }));
      paramViewGroup.setBackgroundResource(2130837800);
      return paramViewGroup;
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\TwoStepVerificationActivity.class
