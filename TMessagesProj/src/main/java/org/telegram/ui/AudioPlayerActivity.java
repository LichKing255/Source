  ...
  implements NotificationCenter.NotificationCenterDelegate, MediaController.FileDownloadProgressListener
{
  ...
  private void updateRepeatButton()
  {
    ...
    if (i == 0) {
      this.repeatButton.setImageResource(2130838068);
    }
    do
    {
      return;
      if (i == 1)
      {
        this.repeatButton.setImageResource(2130838070);
        return;
      }
    } while (i != 2);
    this.repeatButton.setImageResource(2130838069);
  }
  ...
  private void updateShuffleButton()
  {
    ...
    {
      this.shuffleButton.setImageResource(2130838072);
      return;
    }
    this.shuffleButton.setImageResource(2130838071);
  }
  ...
  private void updateTitle(boolean paramBoolean)
  {
    ...
    {
      this.playButton.setImageResource(2130838084);
    ...
    for (localObject1 = String.format("%d:%02d", new Object[] { Integer.valueOf(j / 60), Integer.valueOf(j % 60) });; localObject1 = "-:--")
    {
      ...
      return;
      this.playButton.setImageResource(2130838083);
      break label122;
      this.placeholder.setImageResource(2130838010);
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setBackButtonImage(2130838059);
    ...
    ((View)localObject).setBackgroundResource(2130837803);
    ...
    this.prevButton.setImageResource(2130838085);
    ...
    this.nextButton.setImageResource(2130838082);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\AudioPlayerActivity.class
