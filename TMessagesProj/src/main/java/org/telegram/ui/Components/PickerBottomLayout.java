  ...
  extends FrameLayout
{
  ...
  public PickerBottomLayout(Context paramContext, boolean paramBoolean)
  {
    ...
    if (this.isDarkTheme)
    {
      ...
      this.cancelButton.setText(LocaleController.getString("Cancel", 2131165426).toUpperCase());
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\PickerBottomLayout.class
