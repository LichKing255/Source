  ...
  extends View
{
  ...
  private long frameTimeOffset = 0L;
  ...
  private void init(Context paramContext)
  {
    ...
    this.pickDrawable = getResources().getDrawable(2130838201);
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    int j = (int)(m * this.progressLeft) + AndroidUtilities.dp(16.0F);
    int k = (int)(m * this.progressRight) + AndroidUtilities.dp(16.0F);
    paramCanvas.save();
    paramCanvas.clipRect(AndroidUtilities.dp(16.0F), 0, AndroidUtilities.dp(20.0F) + m, AndroidUtilities.dp(44.0F));
    if ((this.frames.isEmpty()) && (this.currentTask == null)) {
      reloadFrames(0);
    }
    for (;;)
    {
      paramCanvas.drawRect(AndroidUtilities.dp(16.0F), AndroidUtilities.dp(2.0F), j, AndroidUtilities.dp(42.0F), this.paint2);
      paramCanvas.drawRect(AndroidUtilities.dp(4.0F) + k, AndroidUtilities.dp(2.0F), AndroidUtilities.dp(16.0F) + m + AndroidUtilities.dp(4.0F), AndroidUtilities.dp(42.0F), this.paint2);
      paramCanvas.drawRect(j, 0.0F, AndroidUtilities.dp(2.0F) + j, AndroidUtilities.dp(44.0F), this.paint);
      paramCanvas.drawRect(AndroidUtilities.dp(2.0F) + k, 0.0F, AndroidUtilities.dp(4.0F) + k, AndroidUtilities.dp(44.0F), this.paint);
      paramCanvas.drawRect(AndroidUtilities.dp(2.0F) + j, 0.0F, AndroidUtilities.dp(4.0F) + k, AndroidUtilities.dp(2.0F), this.paint);
      paramCanvas.drawRect(AndroidUtilities.dp(2.0F) + j, AndroidUtilities.dp(42.0F), AndroidUtilities.dp(4.0F) + k, AndroidUtilities.dp(44.0F), this.paint);
      paramCanvas.restore();
      int i = this.pickDrawable.getIntrinsicWidth();
      m = this.pickDrawable.getIntrinsicHeight();
      this.pickDrawable.setBounds(j - i / 2, getMeasuredHeight() - m, i / 2 + j, getMeasuredHeight());
      this.pickDrawable.draw(paramCanvas);
      this.pickDrawable.setBounds(k - i / 2 + AndroidUtilities.dp(4.0F), getMeasuredHeight() - m, i / 2 + k + AndroidUtilities.dp(4.0F), getMeasuredHeight());
      this.pickDrawable.draw(paramCanvas);
      return;
      i = 0;
      Iterator localIterator = this.frames.iterator();
      while (localIterator.hasNext())
      {
        Bitmap localBitmap = (Bitmap)localIterator.next();
        if (localBitmap != null) {
          paramCanvas.drawBitmap(localBitmap, AndroidUtilities.dp(16.0F) + this.frameWidth * i, AndroidUtilities.dp(2.0F), null);
        }
        i += 1;
      }
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\VideoTimelineView.class
