    ...
    implements RecyclerView.OnItemTouchListener
  {
    public RecyclerListViewItemClickListener(Context paramContext)
    {
      RecyclerListView.access$002(RecyclerListView.this, new GestureDetector(paramContext, new GestureDetector.SimpleOnGestureListener()
      {
        ...
        {
          if ((RecyclerListView.this.currentChildView != null) && (RecyclerListView.this.onItemLongClickListener != null) && (RecyclerListView.this.onItemLongClickListener.onItemClick(RecyclerListView.this.currentChildView, RecyclerListView.this.currentChildPosition))) {
            RecyclerListView.this.currentChildView.performHapticFeedback(0);
          }
        }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\RecyclerListView.class
