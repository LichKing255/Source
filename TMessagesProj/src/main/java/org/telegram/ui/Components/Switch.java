  ...
  extends CompoundButton
{
  ...
  {
    super(paramContext);
    this.mThumbDrawable = paramContext.getResources().getDrawable(2130838140);
    if (this.mThumbDrawable != null) {
      this.mThumbDrawable.setCallback(this);
    }
    this.mTrackDrawable = paramContext.getResources().getDrawable(2130838143);
  ...
  public void setChecked(boolean paramBoolean)
  {
    ...
    if ((this.attachedToWindow) && (this.wasLayout))
    {
      ...
      j = ((SharedPreferences)localObject).getInt("theme_setting_section_color", MihanTheme.getThemeColor());
      i = MihanTheme.getLighterColor(j, 0.5F);
      k = ((SharedPreferences)localObject).getInt("theme_setting_option_descolor", -6052957);
      m = MihanTheme.getLighterColor(k, 0.5F);
      if (this.mTrackDrawable != null)
      {
        ...
        label105:
        ((Drawable)localObject).setColorFilter(new PorterDuffColorFilter(i, PorterDuff.Mode.MULTIPLY));
      }
      if (this.mThumbDrawable != null)
      {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\Switch.class
