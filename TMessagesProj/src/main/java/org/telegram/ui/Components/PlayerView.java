  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public PlayerView(Context paramContext, BaseFragment paramBaseFragment)
  {
    ...
    paramBaseFragment.setBackgroundResource(2130837802);
    ...
    this.titleTextView.setTypeface(MihanTheme.getMihanTypeFace());
    paramContext = new ImageView(paramContext);
    paramContext.setImageResource(2130837984);
  ...
  private void checkPlayer(boolean paramBoolean)
  {
    ...
    if (MediaController.getInstance().isAudioPaused())
    {
      this.playButton.setImageResource(2130837986);
      label414:
    ...
    for (;;)
    {
      ...
      return;
      this.playButton.setImageResource(2130837985);
      break label414;
      label534:
      break;
      label536:
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\PlayerView.class
