  ...
  extends HorizontalScrollView
{
  ...
  private void addIconTab(final int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      localImageView.setImageDrawable(new MihanStateListDrawable(getResources().getDrawable(paramInt2)));
      return;
      bool = false;
    }
  }
  ...
  class MihanStateListDrawable
    extends StateListDrawable
  {
    public MihanStateListDrawable(Drawable paramDrawable)
    {
    ...
    protected boolean onStateChange(int[] paramArrayOfInt)
    {
      ...
      if (j != 0) {
        super.setColorFilter(localSharedPreferences.getInt("theme_emoji_tab_scolor", -13920542), PorterDuff.Mode.SRC_IN);
      }
      for (;;)
      {
        return super.onStateChange(paramArrayOfInt);
        super.setColorFilter(localSharedPreferences.getInt("theme_emoji_tab_icolor", -5723992), PorterDuff.Mode.SRC_IN);
      }
    }
  }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\PagerSlidingTabStrip.class
