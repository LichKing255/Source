  ...
  extends Drawable
{
  ...
  public SendingFileExDrawable()
  {
    ...
    int i = localSharedPreferences.getInt("theme_chat_action_stcolor", MihanTheme.getLighterColor(localSharedPreferences.getInt("theme_chat_action_tcolor", MihanTheme.getActionBarTitleColor(localSharedPreferences)), 0.8F));
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\SendingFileExDrawable.class
