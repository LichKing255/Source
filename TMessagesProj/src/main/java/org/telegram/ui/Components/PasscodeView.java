  ...
  extends FrameLayout
{
  ...
  public PasscodeView(Context paramContext)
  {
    ...
    ((ImageView)localObject).setImageResource(2130838021);
    ...
    if (AndroidUtilities.density < 1.0F)
    {
      ...
      this.checkImage.setImageResource(2130838019);
      this.checkImage.setScaleType(ImageView.ScaleType.CENTER);
      this.checkImage.setBackgroundResource(2130837616);
    ...
    this.eraseView.setImageResource(2130838020);
    ...
    {
      localObject = new FrameLayout(paramContext);
      ((FrameLayout)localObject).setBackgroundResource(2130837616);
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ((TextView)localObject2).setText(LocaleController.getString("FingerprintInfo", 2131165688));
          ...
          this.fingerprintImageView.setImageResource(2130837857);
          ...
          this.fingerprintStatusTextView.setText(LocaleController.getString("FingerprintHelp", 2131165687));
          ...
          try
          {
            ...
            localFingerprintManagerCompat.authenticate(null, 0, this.cancellationSignal, new FingerprintManagerCompat.AuthenticationCallback()
            {
              ...
              {
                PasscodeView.this.showFingerprintError(LocaleController.getString("FingerprintNotRecognized", 2131165689));
              }
  ...
  {
    this.fingerprintImageView.setImageResource(2130837856);
  ...
  public void onShow()
  {
    ...
    if (ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", 0).getInt("selectedBackground", 1000001) == 1000001)
    {
      ...
      this.passcodeTextView.setText(LocaleController.getString("EnterYourPasscode", 2131165671));
      if (UserConfig.passcodeType != 0) {
        break label271;
      }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\PasscodeView.class
