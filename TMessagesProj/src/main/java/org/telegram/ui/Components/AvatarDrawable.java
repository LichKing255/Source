  ...
  extends Drawable
{
  ...
  public AvatarDrawable()
  {
    if (namePaint == null)
    {
      ...
      broadcastDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(2130837650);
    }
  }
  ...
  public AvatarDrawable(TLRPC.Chat paramChat, boolean paramBoolean)
  {
    ...
    {
      setInfo(i, str, null, paramBoolean);
      return;
    }
  }
  ...
  public AvatarDrawable(TLRPC.User paramUser, boolean paramBoolean)
  {
    ...
    this.isProfile = paramBoolean;
    if (paramUser != null) {
      setInfo(paramUser.id, paramUser.first_name, paramUser.last_name, false);
    }
  }
  ...
  {
    if (paramInt == 5) {
      return MihanTheme.getThemeColor();
    }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawRoundRect(new RectF(new Rect(0, 0, i, i)), getRoundRadius(), getRoundRadius(), paint);
    int j;
  ...
  public void setDrawPhoto(boolean paramBoolean)
  {
    if ((paramBoolean) && (photoDrawable == null)) {
      photoDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(2130838036);
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\AvatarDrawable.class
