...
public class AlertsCreator
{
  public static Dialog createMuteAlert(Context paramContext, long paramLong)
  {
    ...
    paramContext.setTitle(LocaleController.getString("Notifications", 2131166097));
    String str1 = LocaleController.formatString("MuteFor", 2131165978, new Object[] { LocaleController.formatPluralString("Hours", 1) });
    String str2 = LocaleController.formatString("MuteFor", 2131165978, new Object[] { LocaleController.formatPluralString("Hours", 8) });
    String str3 = LocaleController.formatString("MuteFor", 2131165978, new Object[] { LocaleController.formatPluralString("Days", 2) });
    String str4 = LocaleController.getString("MuteDisable", 2131165977);
  ...
  public static Dialog createReportAlert(Context paramContext, long paramLong, BaseFragment paramBaseFragment)
  {
    ...
    paramContext = new BottomSheet.Builder(paramContext);
    paramContext.setTitle(LocaleController.getString("ReportChat", 2131166217));
    String str1 = LocaleController.getString("ReportChatSpam", 2131166221);
    String str2 = LocaleController.getString("ReportChatViolence", 2131166222);
    String str3 = LocaleController.getString("ReportChatPornography", 2131166220);
    String str4 = LocaleController.getString("ReportChatOther", 2131166219);
  ...
  public static void showAddUserAlert(String paramString, BaseFragment paramBaseFragment, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        localBuilder.setMessage(LocaleController.getString("ChannelUserCantAdd", 2131165524));
      }
      else
      {
        localBuilder.setMessage(LocaleController.getString("GroupUserCantAdd", 2131165785));
        continue;
        if (paramBoolean)
        {
          localBuilder.setMessage(LocaleController.getString("ChannelUserAddLimit", 2131165523));
        }
        else
        {
          localBuilder.setMessage(LocaleController.getString("GroupUserAddLimit", 2131165784));
          continue;
          if (paramBoolean)
          {
            localBuilder.setMessage(LocaleController.getString("ChannelUserLeftError", 2131165527));
          }
          else
          {
            localBuilder.setMessage(LocaleController.getString("GroupUserLeftError", 2131165788));
            continue;
            if (paramBoolean)
            {
              localBuilder.setMessage(LocaleController.getString("ChannelUserCantAdmin", 2131165525));
            }
            else
            {
              localBuilder.setMessage(LocaleController.getString("GroupUserCantAdmin", 2131165786));
              continue;
              if (paramBoolean)
              {
                localBuilder.setMessage(LocaleController.getString("ChannelUserCantBot", 2131165526));
              }
              else
              {
                localBuilder.setMessage(LocaleController.getString("GroupUserCantBot", 2131165787));
                continue;
                if (paramBoolean)
                {
                  localBuilder.setMessage(LocaleController.getString("InviteToChannelError", 2131165830));
                }
                else
                {
                  localBuilder.setMessage(LocaleController.getString("InviteToGroupError", 2131165832));
                  continue;
                  localBuilder.setMessage(LocaleController.getString("CreateGroupError", 2131165577));
                  continue;
                  localBuilder.setMessage(LocaleController.getString("UserRestricted", 2131166437));
                }
              }
            }
          }
  ...
  public static void showFloodWaitAlert(String paramString, BaseFragment paramBaseFragment)
  {
    ...
    for (paramString = LocaleController.formatPluralString("Seconds", i);; paramString = LocaleController.formatPluralString("Minutes", i / 60))
    {
      AlertDialog.Builder localBuilder = new AlertDialog.Builder(paramBaseFragment.getParentActivity());
      localBuilder.setTitle(LocaleController.getString("AppName", 2131165338));
      localBuilder.setMessage(LocaleController.formatString("FloodWaitTime", 2131165692, new Object[] { paramString }));
      localBuilder.setPositiveButton(LocaleController.getString("OK", 2131166111), null);
      paramBaseFragment.showDialog(localBuilder.create(), true);
      return;
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\AlertsCreator.class
