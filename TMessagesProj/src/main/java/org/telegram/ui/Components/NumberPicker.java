  ...
  extends LinearLayout
{
  ...
  {
    this.mSolidColor = 0;
    this.mSelectionDivider = getResources().getDrawable(2130838017);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.mVirtualButtonPressedDrawable = getResources().getDrawable(2130837922);
      ...
      this.mInputText.setTypeface(MihanTheme.getMihanTypeFace());
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      case 1: 
        ...
        NumberPicker.access$180(NumberPicker.this, 1);
        NumberPicker.this.invalidate(0, NumberPicker.this.mBottomSelectionDividerBottom, NumberPicker.this.getRight(), NumberPicker.this.getBottom());
        return;
      }
      if (!NumberPicker.this.mDecrementVirtualButtonPressed) {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\NumberPicker.class
