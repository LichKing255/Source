  ...
  extends FrameLayout
{
  ...
  public PhotoFilterView(Context paramContext, Bitmap paramBitmap, int paramInt)
  {
    ...
    this.cancelTextView.setText(LocaleController.getString("Cancel", 2131165426).toUpperCase());
    ...
    this.doneTextView.setText(LocaleController.getString("Done", 2131165634).toUpperCase());
    ...
    this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener()
    {
      public void onItemClick(View paramAnonymousView, int paramAnonymousInt)
      {
        ...
        if (paramAnonymousInt == PhotoFilterView.this.enhanceTool)
        {
          ...
          PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Enhance", 2131165664));
        }
        for (;;)
        {
          ...
          if (paramAnonymousInt == PhotoFilterView.this.highlightsTool)
          {
            ...
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Highlights", 2131165800));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.contrastTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Contrast", 2131165564));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.exposureTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Exposure", 2131165676));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.warmthTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Warmth", 2131166462));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.saturationTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Saturation", 2131166252));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.vignetteTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Vignette", 2131166460));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.shadowsTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Shadows", 2131166319));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.grainTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Grain", 2131165779));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.fadeTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Fade", 2131165678));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.sharpenTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Sharpen", 2131166335));
          }
    ...
    ((ImageView)localObject).setImageResource(2130837760);
    ...
    localObject = new ImageView(paramContext);
    ((ImageView)localObject).setImageResource(2130837761);
    ((ImageView)localObject).setBackgroundDrawable(Theme.createBarSelectorDrawable(-12763843, false));
    ...
    if (AndroidUtilities.isTablet())
    {
      ...
      this.curveTextView[paramInt].setText(LocaleController.getString("CurvesAll", 2131165582).toUpperCase());
      label1535:
    ...
    for (float f = 0.0F;; f = 30.0F)
    {
      ...
      if (paramInt == 1)
      {
        this.curveTextView[paramInt].setText(LocaleController.getString("CurvesRed", 2131165585).toUpperCase());
        break label1535;
      }
      if (paramInt == 2)
      {
        this.curveTextView[paramInt].setText(LocaleController.getString("CurvesGreen", 2131165584).toUpperCase());
        break label1535;
      }
      if (paramInt != 3) {
        break label1535;
      }
      this.curveTextView[paramInt].setText(LocaleController.getString("CurvesBlue", 2131165583).toUpperCase());
      break label1535;
    }
    label1714:
    ...
    this.tintShadowsButton.setText(LocaleController.getString("TintShadows", 2131166405).toUpperCase());
    ...
    this.tintHighlightsButton.setText(LocaleController.getString("TintHighlights", 2131166404).toUpperCase());
    ...
    this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837624, 0, 0);
    ...
    this.blurOffButton.setText(LocaleController.getString("BlurOff", 2131165403));
    ...
    this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837625, 0, 0);
    ...
    this.blurRadialButton.setText(LocaleController.getString("BlurRadial", 2131165404));
    ...
    this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837621, 0, 0);
    ...
    this.blurLinearButton.setText(LocaleController.getString("BlurLinear", 2131165402));
  ...
  private void updateSelectedBlurType()
  {
    ...
    do
    {
      ...
      if (this.blurType == 1)
      {
        this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837623, 0, 0);
        this.blurOffButton.setTextColor(-1);
        this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837626, 0, 0);
    ...
    this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837625, 0, 0);
    this.blurRadialButton.setTextColor(-1);
    this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837622, 0, 0);
  ...
  public void setEditViewFirst()
  {
    ...
    this.paramTextView.setText(LocaleController.getString("Enhance", 2131165664));
  ...
  public void switchToOrFromEditMode()
  {
    ...
    if (this.editView.getVisibility() == 8)
    {
      ...
      if ((this.selectedTool == this.blurTool) || (this.selectedTool == this.tintTool) || (this.selectedTool == this.curvesTool))
      {
        ...
        if (this.selectedTool == this.blurTool)
        {
          ...
          this.infoTextView.setText(LocaleController.getString("Blur", 2131165401));
          if (this.blurType != 0) {
    ...
    for (;;)
    {
      ...
      if (this.selectedTool == this.curvesTool)
      {
        this.infoTextView.setText(LocaleController.getString("Curves", 2131165581));
      ...
      this.infoTextView.setText(LocaleController.getString("Tint", 2131166403));
      break label173;
    ...
    extends RecyclerView.Adapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      if (paramInt == PhotoFilterView.this.enhanceTool) {
        ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838184, LocaleController.getString("Enhance", 2131165664), PhotoFilterView.this.enhanceValue);
      }
      do
      {
        return;
        ...
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838187, LocaleController.getString("Highlights", 2131165800), PhotoFilterView.this.highlightsValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.contrastTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838180, LocaleController.getString("Contrast", 2131165564), PhotoFilterView.this.contrastValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.exposureTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838179, LocaleController.getString("Exposure", 2131165676), PhotoFilterView.this.exposureValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.warmthTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838193, LocaleController.getString("Warmth", 2131166462), PhotoFilterView.this.warmthValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.saturationTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838189, LocaleController.getString("Saturation", 2131166252), PhotoFilterView.this.saturationValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.vignetteTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838192, LocaleController.getString("Vignette", 2131166460), PhotoFilterView.this.vignetteValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.shadowsTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838190, LocaleController.getString("Shadows", 2131166319), PhotoFilterView.this.shadowsValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.grainTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838186, LocaleController.getString("Grain", 2131165779), PhotoFilterView.this.grainValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.sharpenTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838183, LocaleController.getString("Sharpen", 2131166335), PhotoFilterView.this.sharpenValue);
          return;
        }
        String str;
        if (paramInt == PhotoFilterView.this.tintTool)
        {
          ...
          str = LocaleController.getString("Tint", 2131166403);
          if ((PhotoFilterView.this.tintHighlightsColor != 0) || (PhotoFilterView.this.tintShadowsColor != 0)) {}
          for (paramViewHolder = "◆";; paramViewHolder = "")
          {
            ((PhotoEditToolCell)localObject).setIconAndTextAndValue(2130838191, str, paramViewHolder);
            return;
          }
        }
        if (paramInt == PhotoFilterView.this.fadeTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838185, LocaleController.getString("Fade", 2131165678), PhotoFilterView.this.fadeValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.curvesTool)
        {
          localObject = (PhotoEditToolCell)((Holder)localObject).itemView;
          str = LocaleController.getString("Curves", 2131165581);
          if (PhotoFilterView.this.curvesToolValue.shouldBeSkipped()) {}
          for (paramViewHolder = "";; paramViewHolder = "◆")
          {
            ((PhotoEditToolCell)localObject).setIconAndTextAndValue(2130838182, str, paramViewHolder);
            return;
          }
        }
      ...
      for (;;)
      {
        ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838178, LocaleController.getString("Blur", 2131165401), paramViewHolder);
        return;
        if (PhotoFilterView.this.blurType == 2) {
          paramViewHolder = "L";
        }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\PhotoFilterView.class
