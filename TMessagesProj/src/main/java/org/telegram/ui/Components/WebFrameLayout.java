  ...
  extends FrameLayout
{
  ...
  public WebFrameLayout(Context paramContext, BottomSheet paramBottomSheet, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = 22;; paramInt1 = 0)
    {
      ...
      paramString1.setText(LocaleController.getString("Close", 2131165551).toUpperCase());
      ...
      paramString2.setPadding(AndroidUtilities.dp(18.0F), 0, AndroidUtilities.dp(18.0F), 0);
      paramString2.setText(LocaleController.getString("Copy", 2131165572).toUpperCase());
      ...
      paramString2.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          try
          {
            ...
            Toast.makeText(WebFrameLayout.this.getContext(), LocaleController.getString("LinkCopied", 2131165894), 0).show();
            if (WebFrameLayout.this.dialog != null) {
              WebFrameLayout.this.dialog.dismiss();
            }
            return;
      ...
      paramContext.setText(LocaleController.getString("OpenInBrowser", 2131166126).toUpperCase());
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\WebFrameLayout.class
