    ...
    if ((paramTL_replyKeyboardMarkup != null) && (this.botButtons.rows.size() != 0))
    {
      ...
      for (;;)
      {
        ...
        if (i == 0)
        {
          ...
          localTextView.setBackgroundResource(2130837639);
        ...
        for (int k = 10;; k = 0)
        {
          ...
          localTextView.setTypeface(MihanTheme.getMihanTypeFace());
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\BotKeyboardView.class
