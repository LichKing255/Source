  ...
  implements SeekBar.SeekBarDelegate, MediaController.FileDownloadProgressListener
{
  ...
  public PopupAudioView(Context paramContext)
  {
    ...
    {
      backgroundMediaDrawableIn = getResources().getDrawable(2130837996);
      statesDrawable[0][0] = getResources().getDrawable(2130838078);
      statesDrawable[0][1] = getResources().getDrawable(2130838079);
      statesDrawable[1][0] = getResources().getDrawable(2130838025);
      statesDrawable[1][1] = getResources().getDrawable(2130838026);
      statesDrawable[2][0] = getResources().getDrawable(2130837780);
      statesDrawable[2][1] = getResources().getDrawable(2130837781);
      statesDrawable[3][0] = getResources().getDrawable(2130837777);
      statesDrawable[3][1] = getResources().getDrawable(2130837778);
      statesDrawable[4][0] = getResources().getDrawable(2130838074);
      statesDrawable[4][1] = getResources().getDrawable(2130838075);
      statesDrawable[5][0] = getResources().getDrawable(2130838022);
      statesDrawable[5][1] = getResources().getDrawable(2130838023);
      statesDrawable[6][0] = getResources().getDrawable(2130837771);
      statesDrawable[6][1] = getResources().getDrawable(2130837772);
      statesDrawable[7][0] = getResources().getDrawable(2130837768);
      statesDrawable[7][1] = getResources().getDrawable(2130837769);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Components\PopupAudioView.class
