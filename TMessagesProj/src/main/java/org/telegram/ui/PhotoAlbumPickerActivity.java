  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public PhotoAlbumPickerActivity(boolean paramBoolean1, boolean paramBoolean2, ChatActivity paramChatActivity)
  {
  ...
  private void openPhotoPicker(MediaController.AlbumEntry paramAlbumEntry, int paramInt)
  {
    ...
    for (;;)
    {
      paramAlbumEntry = new PhotoPickerActivity(paramInt, paramAlbumEntry, this.selectedPhotos, this.selectedWebPhotos, (ArrayList)localObject1, this.singlePhoto, this.chatActivity);
  ...
  private void sendSelectedPhotos()
  {
    ...
    {
      localObject1 = (MediaController.PhotoEntry)((Map.Entry)((Iterator)localObject2).next()).getValue();
      if (((MediaController.PhotoEntry)localObject1).imagePath != null)
      {
        localArrayList1.add(((MediaController.PhotoEntry)localObject1).imagePath);
        if (((MediaController.PhotoEntry)localObject1).caption != null) {}
        for (localObject1 = ((MediaController.PhotoEntry)localObject1).caption.toString();; localObject1 = null)
        {
          localArrayList2.add(localObject1);
          break;
        }
      }
      if (((MediaController.PhotoEntry)localObject1).path != null)
      {
        localArrayList1.add(((MediaController.PhotoEntry)localObject1).path);
        if (((MediaController.PhotoEntry)localObject1).caption != null) {}
        for (localObject1 = ((MediaController.PhotoEntry)localObject1).caption.toString();; localObject1 = null)
        {
          localArrayList2.add(localObject1);
    ...
    int j = 0;
    int i = 0;
    Iterator localIterator = this.selectedWebPhotos.entrySet().iterator();
    while (localIterator.hasNext())
    {
      MediaController.SearchImage localSearchImage = (MediaController.SearchImage)((Map.Entry)localIterator.next()).getValue();
    ...
    this.delegate.didSelectPhotos(localArrayList1, localArrayList2, (ArrayList)localObject2);
  }
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
    {
      public void onItemClick(int paramAnonymousInt)
      {
        ...
        do
        {
          ...
          PhotoAlbumPickerActivity.this.dropDown.setText(LocaleController.getString("PickerPhotos", 2131166182));
          PhotoAlbumPickerActivity.this.emptyView.setText(LocaleController.getString("NoPhotos", 2131166014));
        ...
        PhotoAlbumPickerActivity.this.dropDown.setText(LocaleController.getString("PickerVideo", 2131166183));
        PhotoAlbumPickerActivity.this.emptyView.setText(LocaleController.getString("NoVideo", 2131166030));
        PhotoAlbumPickerActivity.this.listAdapter.notifyDataSetChanged();
      }
    });
    Object localObject = this.actionBar.createMenu();
    ((ActionBarMenu)localObject).addItem(1, 2130837823);
    ...
    if (!this.singlePhoto)
    {
      ...
      this.dropDownContainer.addSubItem(2, LocaleController.getString("PickerPhotos", 2131166182), 0);
      this.dropDownContainer.addSubItem(3, LocaleController.getString("PickerVideo", 2131166183), 0);
      ...
      if (AndroidUtilities.isTablet())
      {
        ...
        this.dropDown.setText(LocaleController.getString("PickerPhotos", 2131166182));
    ...
    for (;;)
    {
      ...
      break;
      this.actionBar.setTitle(LocaleController.getString("Gallery", 2131165772));
      break label458;
      label1126:
      this.progressView.setVisibility(8);
  ...
  {
    public abstract void didSelectPhotos(ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<MediaController.SearchImage> paramArrayList);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\PhotoAlbumPickerActivity.class
