  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void processSelectedBackground()
  {
    ...
    {
      this.backgroundImage.setImageResource(2130837615);
      this.backgroundImage.setBackgroundColor(0);
      this.selectedColor = 0;
    }
    for (;;)
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("ChatBackground", 2131165531));
    ...
    this.progressViewBackground.setBackgroundResource(2130838145);
    ...
    try
    {
      ((ProgressBar)localObject).setIndeterminateDrawable(paramContext.getResources().getDrawable(2130837938));
      ...
      ((RecyclerListView)localObject).setOnItemClickListener(new RecyclerListView.OnItemClickListener()
      {
        public void onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          while ((paramAnonymousInt - 1 < 0) || (paramAnonymousInt - 1 >= WallpapersActivity.this.wallPapers.size()))
          {
            ...
            String str1 = LocaleController.getString("FromCamera", 2131165763);
            String str2 = LocaleController.getString("FromGalley", 2131165770);
            String str3 = LocaleController.getString("Cancel", 2131165426);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\WallpapersActivity.class
