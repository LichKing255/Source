  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("ChooseCountry", 2131165541));
    ...
    this.actionBar.createMenu().addItem(0, 2130837826).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener()
    {
      public void onSearchCollapse()
      {
        ...
        CountrySelectActivity.this.emptyTextView.setText(LocaleController.getString("ChooseCountry", 2131165541));
      }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\CountrySelectActivity.class
