  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("EncryptionKey", 2131165659));
    ...
    if (localObject2 != null)
    {
      ...
      ((SpannableStringBuilder)localObject3).append(AndroidUtilities.replaceTags(LocaleController.formatString("EncryptionKeyDescription", 2131165660, new Object[] { ((TLRPC.User)localObject1).first_name, ((TLRPC.User)localObject1).first_name })));
      int i = ((SpannableStringBuilder)localObject3).toString().indexOf("telegram.org");
      if (i != -1) {
        ((SpannableStringBuilder)localObject3).setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", 2131165661)), i, "telegram.org".length() + i, 33);
      }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\IdenticonActivity.class
