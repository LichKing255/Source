  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("AttachMusic", 2131165374));
    ...
    this.progressView.setText(LocaleController.getString("NoAudio", 2131165999));
    ...
    if (LocaleController.isRTL)
    {
      ...
      paramContext.setBackgroundResource(2130837803);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\AudioSelectActivity.class
