  ...
  implements AvatarUpdater.AvatarUpdaterDelegate, NotificationCenter.NotificationCenterDelegate
{
  ...
  private void updateAdminCell()
  {
    ...
    if (this.info != null)
    {
      this.adminCell.setTextAndValue(LocaleController.getString("ChannelAdministrators", 2131165447), String.format("%d", new Object[] { Integer.valueOf(this.info.admins_count) }), false);
      return;
    }
    this.adminCell.setText(LocaleController.getString("ChannelAdministrators", 2131165447), false);
  }
  ...
  private void updateTypeCell()
  {
    ...
    {
      str = LocaleController.getString("ChannelTypePrivate", 2131165520);
      if (!this.currentChat.megagroup) {
        break label129;
      }
      this.typeCell.setTextAndValue(LocaleController.getString("GroupType", 2131165783), str, false);
    }
    for (;;)
    {
      ...
      return;
      str = LocaleController.getString("ChannelTypePublic", 2131165521);
      break;
      label129:
      this.typeCell.setTextAndValue(LocaleController.getString("ChannelType", 2131165519), str, false);
    }
    label148:
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
    {
      public void onItemClick(int paramAnonymousInt)
      {
        ...
        if (ChannelEditActivity.this.avatarUpdater.uploadingAvatar != null)
        {
          ...
          ChannelEditActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", 2131165905));
          ...
          ChannelEditActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", 2131165426), new DialogInterface.OnClickListener()
          {
    ...
    this.actionBar.setTitle(LocaleController.getString("ChannelEdit", 2131165464));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.nameTextView.setHint(LocaleController.getString("GroupName", 2131165781));
      label359:
      ...
      this.descriptionTextView.setHint(LocaleController.getString("DescriptionOptionalPlaceholder", 2131165623));
      ...
      if ((this.currentChat.megagroup) || (!this.currentChat.megagroup))
      {
        ...
        updateTypeCell();
        this.typeCell.setBackgroundResource(2130837932);
        ...
        ((TextCheckCell)localObject2).setBackgroundResource(2130837932);
        ((TextCheckCell)localObject2).setTextAndCheck(LocaleController.getString("ChannelSignMessages", 2131165515), this.signMessages, false);
        ...
        ((TextInfoPrivacyCell)localObject1).setBackgroundResource(2130837799);
        ((TextInfoPrivacyCell)localObject1).setText(LocaleController.getString("ChannelSignMessagesInfo", 2131165516));
        localLinearLayout.addView((View)localObject1, LayoutHelper.createLinear(-1, -2));
      }
      label1160:
      if (this.currentChat.creator)
      {
        ...
        ((TextSettingsCell)localObject2).setBackgroundResource(2130837932);
        if (!this.currentChat.megagroup) {
          break label1595;
        }
        ((TextSettingsCell)localObject2).setText(LocaleController.getString("DeleteMega", 2131165615), false);
        label1250:
        ((FrameLayout)localObject1).addView((View)localObject2, LayoutHelper.createFrame(-1, -2.0F));
        ((TextSettingsCell)localObject2).setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            if (ChannelEditActivity.this.currentChat.megagroup) {
              paramAnonymousView.setMessage(LocaleController.getString("MegaDeleteAlert", 2131165923));
            }
            for (;;)
            {
              ...
              return;
              paramAnonymousView.setMessage(LocaleController.getString("ChannelDeleteAlert", 2131165461));
            }
          }
        });
        paramContext = new TextInfoPrivacyCell(paramContext);
        paramContext.setBackgroundResource(2130837800);
        if (!this.currentChat.megagroup) {
          break label1613;
        }
        paramContext.setText(LocaleController.getString("MegaDeleteInfo", 2131165924));
        label1316:
    ...
    for (;;)
    {
      ...
      updateAdminCell();
      this.adminCell.setBackgroundResource(2130837932);
      ...
      ((ShadowSectionCell)localObject1).setBackgroundResource(2130837800);
      break label1160;
      label1595:
      ((TextSettingsCell)localObject2).setText(LocaleController.getString("ChannelDelete", 2131165460), false);
      break label1250;
      label1613:
      paramContext.setText(LocaleController.getString("ChannelDeleteInfo", 2131165462));
      break label1316;
      label1629:
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ChannelEditActivity.class
