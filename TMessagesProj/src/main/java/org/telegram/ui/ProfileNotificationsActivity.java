    ...
    this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, final View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if (paramAnonymousInt == ProfileNotificationsActivity.this.settingsVibrateRow)
        {
          ...
          localObject4 = LocaleController.getString("Long", 2131165918);
        ...
        do
        {
          do
          {
            ...
            localObject1 = LocaleController.getString("Enabled", 2131165648);
            localObject2 = LocaleController.getString("NotificationsDisabled", 2131166099);
          ...
          if (paramAnonymousInt == ProfileNotificationsActivity.this.settingsPriorityRow)
          {
            ...
            paramAnonymousView = LocaleController.getString("SettingsDefault", 2131166318);
            ...
            localObject3 = LocaleController.getString("NotificationsPriorityMax", 2131166105);
        ...
        paramAnonymousView.setText(LocaleController.getString("SmartNotificationsSoundAtMost", 2131166351));
        ...
        ((TextView)localObject2).setText(LocaleController.getString("SmartNotificationsTimes", 2131166352));
        ...
        localObject2 = new TextView(ProfileNotificationsActivity.this.getParentActivity());
        ((TextView)localObject2).setText(LocaleController.getString("SmartNotificationsWithin", 2131166353));
        ((TextView)localObject2).setTextSize(1, 18.0F);
        ((LinearLayout)localObject1).addView((View)localObject2);
        ...
        ((TextView)localObject3).setText(LocaleController.getString("SmartNotificationsMinutes", 2131166350));
        ...
        localObject1 = new AlertDialog.Builder(ProfileNotificationsActivity.this.getParentActivity());
        ((AlertDialog.Builder)localObject1).setTitle(LocaleController.getString("SmartNotifications", 2131166347));
        ((AlertDialog.Builder)localObject1).setView(paramAnonymousAdapterView);
        ...
        ((AlertDialog.Builder)localObject1).setNegativeButton(LocaleController.getString("SmartNotificationsDisabled", 2131166348), new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
          {
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              if (paramInt == 0)
              {
                localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166097), LocaleController.getString("Default", 2131165597), true);
                return paramViewGroup;
              }
              if (paramInt == 1)
              {
                localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166097), LocaleController.getString("Enabled", 2131165648), true);
                return paramViewGroup;
              }
              if (paramInt == 2)
              {
                localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166097), LocaleController.getString("NotificationsDisabled", 2131166099), true);
                return paramViewGroup;
              }
              localObject = paramViewGroup;
            } while (paramInt != 3);
            ...
            if (paramInt <= 0) {
              paramView = LocaleController.getString("Enabled", 2131165648);
            }
            while (paramView != null)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166097), paramView, true);
              return paramViewGroup;
              if (paramInt < 3600) {
                paramView = LocaleController.formatString("WillUnmuteIn", 2131166478, new Object[] { LocaleController.formatPluralString("Minutes", paramInt / 60) });
              } else if (paramInt < 86400) {
                paramView = LocaleController.formatString("WillUnmuteIn", 2131166478, new Object[] { LocaleController.formatPluralString("Hours", (int)Math.ceil(paramInt / 60.0F / 60.0F)) });
              } else if (paramInt < 31536000) {
                paramView = LocaleController.formatString("WillUnmuteIn", 2131166478, new Object[] { LocaleController.formatPluralString("Days", (int)Math.ceil(paramInt / 60.0F / 60.0F / 24.0F)) });
              } else {
                paramView = null;
              }
            }
            ...
            {
              localObject = paramView.getString("sound_" + ProfileNotificationsActivity.this.dialog_id, LocaleController.getString("SoundDefault", 2131166360));
              paramView = (View)localObject;
              if (((String)localObject).equals("NoSound")) {
                paramView = LocaleController.getString("NoSound", 2131166027);
              }
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Sound", 2131166359), paramView, true);
              return paramViewGroup;
            }
            ...
            if (paramInt == 0)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("NotificationsPriorityDefault", 2131166102), true);
              return paramViewGroup;
            }
            if (paramInt == 1)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("NotificationsPriorityHigh", 2131166103), true);
              return paramViewGroup;
            }
            if (paramInt == 2)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("NotificationsPriorityMax", 2131166105), true);
              return paramViewGroup;
            }
            localObject = paramViewGroup;
          } while (paramInt != 3);
          localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("SettingsDefault", 2131166318), true);
          return paramViewGroup;
          localObject = paramViewGroup;
        ...
        if (paramInt == 0)
        {
          localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("SmartNotifications", 2131166347), LocaleController.getString("SmartNotificationsDisabled", 2131166348), true);
          return paramViewGroup;
        }
        paramView = LocaleController.formatPluralString("Times", paramInt);
        localObject = LocaleController.formatPluralString("Minutes", i / 60);
        localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("SmartNotifications", 2131166347), LocaleController.formatString("SmartNotificationsInfo", 2131166349, new Object[] { paramView, localObject }), true);
        return paramViewGroup;
      ...
      {
        paramView.setTextAndColor(LocaleController.getString("LedColor", 2131165890), ((SharedPreferences)localObject).getInt("color_" + ProfileNotificationsActivity.this.dialog_id, -16711936), false);
        return paramViewGroup;
      }
      if ((int)ProfileNotificationsActivity.this.dialog_id < 0)
      {
        paramView.setTextAndColor(LocaleController.getString("LedColor", 2131165890), ((SharedPreferences)localObject).getInt("GroupLed", -16711936), false);
        return paramViewGroup;
      }
      paramView.setTextAndColor(LocaleController.getString("LedColor", 2131165890), ((SharedPreferences)localObject).getInt("MessagesLed", -16711936), false);
      return paramViewGroup;
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ProfileNotificationsActivity.class
