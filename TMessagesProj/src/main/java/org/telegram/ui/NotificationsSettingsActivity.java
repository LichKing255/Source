      ...
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, final View paramAnonymousView, final int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        for (bool1 = true;; bool1 = false)
        {
                ...
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    ...
                    if (NotificationsSettingsActivity.this.getParentActivity() != null) {
                      Toast.makeText(NotificationsSettingsActivity.this.getParentActivity(), LocaleController.getString("ResetNotificationsText", 2131166235), 0).show();
                    }
                  }
                });
              }
          ...
          for (;;)
          {
            ...
            ((AlertDialog.Builder)localObject2).setTitle(LocaleController.getString("LedColor", 2131165890));
            ((AlertDialog.Builder)localObject2).setView(paramAnonymousAdapterView);
            ((AlertDialog.Builder)localObject2).setPositiveButton(LocaleController.getString("Set", 2131166305), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
                ...
                if (paramAnonymousInt == NotificationsSettingsActivity.this.messageLedRow)
                {
                  ...
                  localTextColorCell.setTextAndColor(LocaleController.getString("LedColor", 2131165890), localObject1.getColor(), true);
                }
                for (;;)
                {
            ...
            ((AlertDialog.Builder)localObject2).setNeutralButton(LocaleController.getString("LedDisabled", 2131165891), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
                paramAnonymous2DialogInterface = ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0).edit();
                ...
                if (paramAnonymousInt == NotificationsSettingsActivity.this.messageLedRow)
                {
                  ...
                  localTextColorCell.setTextAndColor(LocaleController.getString("LedColor", 2131165890), 0, true);
                }
                for (;;)
                {
                  paramAnonymous2DialogInterface.commit();
          ...
          if ((paramAnonymousInt == NotificationsSettingsActivity.this.messagePopupNotificationRow) || (paramAnonymousInt == NotificationsSettingsActivity.this.groupPopupNotificationRow))
          {
            ...
            paramAnonymousAdapterView.setTitle(LocaleController.getString("PopupNotification", 2131166194));
            localObject1 = LocaleController.getString("NoPopup", 2131166016);
            localObject2 = LocaleController.getString("OnlyWhenScreenOn", 2131166123);
            str1 = LocaleController.getString("OnlyWhenScreenOff", 2131166122);
            localObject3 = LocaleController.getString("AlwaysShowPopup", 2131165325);
          ...
          if ((paramAnonymousInt == NotificationsSettingsActivity.this.messageVibrateRow) || (paramAnonymousInt == NotificationsSettingsActivity.this.groupVibrateRow))
          {
            ...
            localObject1 = LocaleController.getString("VibrationDisabled", 2131166457);
            localObject2 = LocaleController.getString("VibrationDefault", 2131166456);
            str1 = LocaleController.getString("Short", 2131166336);
            localObject3 = LocaleController.getString("Long", 2131165918);
            localObject4 = LocaleController.getString("OnlyIfSilent", 2131166121);
          ...
          {
            paramAnonymousAdapterView = new AlertDialog.Builder(NotificationsSettingsActivity.this.getParentActivity());
            paramAnonymousAdapterView.setTitle(LocaleController.getString("NotificationsPriority", 2131166101));
            localObject1 = LocaleController.getString("NotificationsPriorityDefault", 2131166102);
            localObject2 = LocaleController.getString("NotificationsPriorityHigh", 2131166103);
            str1 = LocaleController.getString("NotificationsPriorityMax", 2131166105);
          ...
          paramAnonymousAdapterView = new AlertDialog.Builder(NotificationsSettingsActivity.this.getParentActivity());
          paramAnonymousAdapterView.setTitle(LocaleController.getString("RepeatNotifications", 2131166212));
          localObject1 = LocaleController.getString("RepeatDisabled", 2131166211);
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        {
          ((HeaderCell)localObject1).setText(LocaleController.getString("MessageNotifications", 2131165947));
      ...
      else
      {
        ...
        paramViewGroup.setTextAndCheck(LocaleController.getString("Alert", 2131165313), ((SharedPreferences)localObject2).getBoolean("EnableAll", true), true);
        ...
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    ...
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("GroupNotifications", 2131165782));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappSectionRow)
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("InAppNotifications", 2131165813));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.eventsSectionRow)
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("Events", 2131165674));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.otherSectionRow)
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("NotificationsOther", 2131166100));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    paramViewGroup = (ViewGroup)localObject1;
                    ...
                    ((HeaderCell)localObject1).setText(LocaleController.getString("Reset", 2131166228));
                    paramViewGroup = (ViewGroup)localObject1;
                    break;
                    if (paramInt == NotificationsSettingsActivity.this.groupAlertRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("Alert", 2131165313), ((SharedPreferences)localObject2).getBoolean("EnableGroup", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.messagePreviewRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("MessagePreview", 2131165948), ((SharedPreferences)localObject2).getBoolean("EnablePreviewAll", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.groupPreviewRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("MessagePreview", 2131165948), ((SharedPreferences)localObject2).getBoolean("EnablePreviewGroup", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappSoundRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("InAppSounds", 2131165815), ((SharedPreferences)localObject2).getBoolean("EnableInAppSounds", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappVibrateRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("InAppVibrate", 2131165816), ((SharedPreferences)localObject2).getBoolean("EnableInAppVibrate", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappPreviewRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("InAppPreview", 2131165814), ((SharedPreferences)localObject2).getBoolean("EnableInAppPreview", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappPriorityRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("NotificationsPriority", 2131166101), ((SharedPreferences)localObject2).getBoolean("EnableInAppPriority", false), false);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.contactJoinedRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("ContactJoined", 2131165560), ((SharedPreferences)localObject2).getBoolean("EnableContactJoined", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.pinnedMessageRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("PinnedMessages", 2131166188), ((SharedPreferences)localObject2).getBoolean("PinnedMessages", true), false);
                      return (View)localObject1;
                    }
                    ...
                    {
                      paramViewGroup.setTextAndValueAndCheck(LocaleController.getString("NotificationsService", 2131166106), LocaleController.getString("NotificationsServiceInfo", 2131166109), ((SharedPreferences)localObject2).getBoolean("pushService", true), true, true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.notificationsServiceConnectionRow)
                    {
                      paramViewGroup.setTextAndValueAndCheck(LocaleController.getString("NotificationsServiceConnection", 2131166107), LocaleController.getString("NotificationsServiceConnectionInfo", 2131166108), ((SharedPreferences)localObject2).getBoolean("pushConnection", true), true, true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.badgeNumberRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("BadgeNumber", 2131165392), ((SharedPreferences)localObject2).getBoolean("badgeNumber", true), true);
                      return (View)localObject1;
                    }
                    paramView = (View)localObject1;
                  } while (paramInt != NotificationsSettingsActivity.this.inchatSoundRow);
                  paramViewGroup.setTextAndCheck(LocaleController.getString("InChatSound", 2131165817), ((SharedPreferences)localObject2).getBoolean("EnableInChatSound", true), true);
                  return (View)localObject1;
                  if (i != 2) {
                    break label1731;
                  }
                  ...
                  if ((paramInt == NotificationsSettingsActivity.this.messageSoundRow) || (paramInt == NotificationsSettingsActivity.this.groupSoundRow))
                  {
                    ...
                    if (paramInt == NotificationsSettingsActivity.this.messageSoundRow) {
                      paramView = paramViewGroup.getString("GlobalSound", LocaleController.getString("SoundDefault", 2131166360));
                    }
                    for (;;)
                    {
                      paramViewGroup = paramView;
                      if (paramView.equals("NoSound")) {
                        paramViewGroup = LocaleController.getString("NoSound", 2131166027);
                      }
                      ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Sound", 2131166359), paramViewGroup, true);
                      return (View)localObject1;
                      if (paramInt == NotificationsSettingsActivity.this.groupSoundRow) {
                        paramView = paramViewGroup.getString("GroupSound", LocaleController.getString("SoundDefault", 2131166360));
                      }
                    }
                  }
                  if (paramInt == NotificationsSettingsActivity.this.resetNotificationsRow)
                  {
                    ...
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("ResetAllNotifications", 2131166229), LocaleController.getString("UndoAllCustom", 2131166420), false);
                    return (View)localObject1;
                  }
                  if ((paramInt == NotificationsSettingsActivity.this.messagePopupNotificationRow) || (paramInt == NotificationsSettingsActivity.this.groupPopupNotificationRow))
                  {
                    ...
                    if (paramInt == NotificationsSettingsActivity.this.messagePopupNotificationRow)
                    {
                      ...
                      paramView = LocaleController.getString("NoPopup", 2131166016);
                    }
                    for (;;)
                    {
                      ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("PopupNotification", 2131166194), paramView, true);
                      return (View)localObject1;
                      ...
                      break;
                      if (i == 1) {
                        paramView = LocaleController.getString("OnlyWhenScreenOn", 2131166123);
                      } else if (i == 2) {
                        paramView = LocaleController.getString("OnlyWhenScreenOff", 2131166122);
                      } else {
                        paramView = LocaleController.getString("AlwaysShowPopup", 2131165325);
                      }
                    }
                  }
                  ...
                  while (i == 0)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166455), LocaleController.getString("VibrationDefault", 2131166456), true);
                    return (View)localObject1;
                  ...
                  if (i == 1)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166455), LocaleController.getString("Short", 2131166336), true);
                    return (View)localObject1;
                  }
                  if (i == 2)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166455), LocaleController.getString("VibrationDisabled", 2131166457), true);
                    return (View)localObject1;
                  }
                  if (i == 3)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166455), LocaleController.getString("Long", 2131165918), true);
                    return (View)localObject1;
                  }
                  paramView = (View)localObject1;
                } while (i != 4);
                ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166455), LocaleController.getString("OnlyIfSilent", 2131166121), true);
                return (View)localObject1;
                if (paramInt == NotificationsSettingsActivity.this.repeatRow)
                {
                  ...
                  if (paramInt == 0) {
                    paramView = LocaleController.getString("RepeatNotificationsNever", 2131166213);
                  }
                  for (;;)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("RepeatNotifications", 2131166212), paramView, false);
                    return (View)localObject1;
                    if (paramInt < 60) {
              ...
              while (i == 0)
              {
                ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("NotificationsPriorityDefault", 2131166102), false);
                return (View)localObject1;
              ...
              if (i == 1)
              {
                ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("NotificationsPriorityHigh", 2131166103), false);
                return (View)localObject1;
              }
              paramView = (View)localObject1;
            } while (i != 2);
            ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166101), LocaleController.getString("NotificationsPriorityMax", 2131166105), false);
            return (View)localObject1;
            if (i != 3) {
              break label1859;
            }
            ...
            {
              paramViewGroup.setTextAndColor(LocaleController.getString("LedColor", 2131165890), ((SharedPreferences)localObject2).getInt("MessagesLed", -16711936), true);
              return (View)localObject1;
            }
            paramView = (View)localObject1;
          } while (paramInt != NotificationsSettingsActivity.this.groupLedRow);
          paramViewGroup.setTextAndColor(LocaleController.getString("LedColor", 2131165890), ((SharedPreferences)localObject2).getInt("GroupLed", -16711936), true);
          return (View)localObject1;
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\NotificationsSettingsActivity.class
