  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("Language", 2131165854));
    ...
    this.actionBar.createMenu().addItem(0, 2130837826).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener()
    {
    ...
    this.listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
    {
      public boolean onItemLongClick(final AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        paramAnonymousView.setMessage(LocaleController.getString("DeleteLocalization", 2131165614));
        paramAnonymousView.setTitle(LocaleController.getString("AppName", 2131165338));
        paramAnonymousView.setPositiveButton(LocaleController.getString("Delete", 2131165600), new DialogInterface.OnClickListener()
        {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\LanguageSelectActivity.class
