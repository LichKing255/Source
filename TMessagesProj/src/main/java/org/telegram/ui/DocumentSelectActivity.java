  ...
  extends BaseFragment
{
  ...
  private String getRootSubtitle(String paramString)
  {
    try
    {
      ...
      localObject = LocaleController.formatString("FreeOfTotal", 2131165760, new Object[] { AndroidUtilities.formatFileSize(l2 * l3), AndroidUtilities.formatFileSize(l1) });
  ...
  private boolean listFiles(File paramFile)
  {
    if (!paramFile.canRead())
    {
      if (((paramFile.getAbsolutePath().startsWith(Environment.getExternalStorageDirectory().toString())) || (paramFile.getAbsolutePath().startsWith("/sdcard")) || (paramFile.getAbsolutePath().startsWith("/mnt/sdcard"))) && (!Environment.getExternalStorageState().equals("mounted")) && (!Environment.getExternalStorageState().equals("mounted_ro")))
      {
        ...
        if ("shared".equals(Environment.getExternalStorageState())) {
          this.emptyView.setText(LocaleController.getString("UsbActive", 2131166432));
        }
        for (;;)
        {
          ...
          return true;
          this.emptyView.setText(LocaleController.getString("NotMounted", 2131166034));
        }
      }
      showErrorBox(LocaleController.getString("AccessError", 2131165249));
      return false;
    }
    this.emptyView.setText(LocaleController.getString("NoFiles", 2131166005));
    Object localObject;
    try
    {
      ...
      if (localObject == null)
      {
        showErrorBox(LocaleController.getString("UnknownError", 2131166421));
        return false;
      }
    }
    ...
    if (i < localObject.length)
    {
      ...
      for (;;)
      {
        ...
        localListItem.icon = 2130837843;
        localListItem.subtitle = LocaleController.getString("Folder", 2131165693);
    ...
    if (this.history.size() > 0)
    {
      ...
      if (((HistoryEntry)localObject).dir == null) {
        paramFile.subtitle = LocaleController.getString("Folder", 2131165693);
      }
    }
    for (;;)
    {
      paramFile.icon = 2130837843;
      paramFile.file = null;
  ...
  private void showErrorBox(String paramString)
  {
    ...
    new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString("AppName", 2131165338)).setMessage(paramString).setPositiveButton(LocaleController.getString("OK", 2131166111), null).show();
  }
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("SelectFile", 2131166281));
    ...
    this.actionModeViews.add(((ActionBarMenu)localObject).addItem(3, 2130837814, -986896, null, AndroidUtilities.dp(54.0F)));
    int i = ApplicationLoader.applicationContext.getSharedPreferences("Mihantheme", 0).getInt("theme_chat_action_amicolor", -9276814);
    this.selectedMessagesCountTextView.setTextColor(i);
    MihanTheme.setColorFilter(((ActionBarMenu)localObject).getItem(3).getImageView(), i);
    this.fragmentView = getParentActivity().getLayoutInflater().inflate(2130903076, null, false);
    this.listAdapter = new ListAdapter(paramContext);
    this.emptyView = ((TextView)this.fragmentView.findViewById(2131624119));
    ...
    this.listView = ((ListView)this.fragmentView.findViewById(2131624118));
    ...
    this.listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
    {
      public boolean onItemLongClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if ((localObject != null) && (!((File)localObject).isDirectory()))
        {
          ...
          {
            DocumentSelectActivity.this.showErrorBox(LocaleController.getString("AccessError", 2131165249));
            return false;
          }
          if ((DocumentSelectActivity.this.sizeLimit != 0L) && (((File)localObject).length() > DocumentSelectActivity.this.sizeLimit))
          {
            DocumentSelectActivity.this.showErrorBox(LocaleController.formatString("FileUploadLimit", 2131165686, new Object[] { AndroidUtilities.formatFileSize(DocumentSelectActivity.this.sizeLimit) }));
            return false;
          }
      ...
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (localFile == null)
            {
              if (localListItem.icon == 2130837892)
              {
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\DocumentSelectActivity.class
