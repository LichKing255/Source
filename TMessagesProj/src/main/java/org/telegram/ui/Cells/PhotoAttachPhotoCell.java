  ...
  extends FrameLayout
{
  ...
  public PhotoAttachPhotoCell(Context paramContext)
  {
    ...
    this.checkBox = new CheckBox(paramContext, 2130837673);
  ...
  public void setPhotoEntry(MediaController.PhotoEntry paramPhotoEntry, boolean paramBoolean)
  {
    ...
    {
      this.imageView.setImage(this.photoEntry.thumbPath, null, getResources().getDrawable(2130838013));
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      if (this.photoEntry.path != null)
      {
        ...
        this.imageView.setImage("thumb://" + this.photoEntry.imageId + ":" + this.photoEntry.path, null, getResources().getDrawable(2130838013));
        break;
      }
      this.imageView.setImageResource(2130838013);
      break;
    }
  }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\PhotoAttachPhotoCell.class
