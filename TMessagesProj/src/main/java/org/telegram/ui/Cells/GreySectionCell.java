  ...
  extends FrameLayout
{
  ...
  public void setTextAndBGColor(int paramInt1, int paramInt2)
  {
    this.textView.setTextColor(paramInt1);
    setBackgroundColor(paramInt2);
  }
  
  public void setTextAndGColor(int paramInt, GradientDrawable paramGradientDrawable)
  {
    this.textView.setTextColor(paramInt);
    setBackgroundDrawable(paramGradientDrawable);
  }
}


/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\GreySectionCell.class
