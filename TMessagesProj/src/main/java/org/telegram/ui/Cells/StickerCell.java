  ...
  extends FrameLayout
{
  ...
  public void setSticker(TLRPC.Document paramDocument, int paramInt)
  {
    ...
    if (paramInt == -1)
    {
      setBackgroundResource(2130838138);
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        setBackgroundResource(2130838137);
        setPadding(0, 0, 0, 0);
      }
      else if (paramInt == 1)
      {
      ...
      {
        setBackgroundResource(2130838135);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\StickerCell.class
