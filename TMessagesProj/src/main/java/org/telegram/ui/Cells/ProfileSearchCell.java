  ...
  extends BaseCell
{
  ...
  public ProfileSearchCell(Context paramContext)
  {
    ...
    if (namePaint == null)
    {
      ...
      checkDrawable = getResources().getDrawable(2130837670);
    ...
    for (;;)
    {
      ...
      do
      {
        do
        {
          ...
          localObject1 = LocaleController.getString("HiddenName", 2131165794);
          break label188;
          ...
          localObject1 = LocaleController.getString("Online", 2131166113);
          break label523;
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\ProfileSearchCell.class
