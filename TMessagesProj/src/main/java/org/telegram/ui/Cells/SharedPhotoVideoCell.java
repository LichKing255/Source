  ...
  extends FrameLayout
{
  ...
  public void setItem(int paramInt1, int paramInt2, MessageObject paramMessageObject)
  {
    ...
    if (paramMessageObject != null)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          else
          {
            ...
            localPhotoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(2130838032), null, paramMessageObject, "b", null, 0);
            return;
            bool = false;
            break;
          }
        ...
        label253:
        localPhotoVideoView.imageView.setImageResource(2130838032);
        return;
      }
      if (((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto)) && (paramMessageObject.messageOwner.media.photo != null) && (!paramMessageObject.photoThumbs.isEmpty()))
      {
        ...
        localPhotoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(2130838032), null, paramMessageObject.location, "b", null, 0);
        return;
      }
      localPhotoVideoView.videoInfoContainer.setVisibility(4);
      localPhotoVideoView.imageView.setImageResource(2130838032);
    ...
    extends FrameLayout
  {
    ...
    public PhotoVideoView(Context paramContext)
    {
      ...
      this.videoInfoContainer.setBackgroundResource(2130838054);
      ...
      SharedPhotoVideoCell.this.setImageResource(2130837907);
      ...
      this.selector.setBackgroundResource(2130837932);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\SharedPhotoVideoCell.class
