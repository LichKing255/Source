  ...
  extends FrameLayout
{
  ...
  public ChatLoadingCell(Context paramContext)
  {
    ...
    this.frameLayout.setBackgroundResource(2130838145);
    ...
    try
    {
      paramContext.setIndeterminateDrawable(getResources().getDrawable(2130837938));
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\ChatLoadingCell.class
