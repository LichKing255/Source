  ...
  extends LinearLayout
{
  ...
  public PhotoPickerSearchCell(Context paramContext, boolean paramBoolean)
  {
    ...
    ((SearchButton)localObject).textView1.setText(LocaleController.getString("SearchImages", 2131166264));
    ((SearchButton)localObject).textView2.setText(LocaleController.getString("SearchImagesInfo", 2131166265));
    ((SearchButton)localObject).imageView.setImageResource(2130838123);
    ...
    paramContext.textView1.setText(LocaleController.getString("SearchGifs", 2131166262));
    paramContext.textView2.setText("GIPHY");
    paramContext.imageView.setImageResource(2130838118);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\PhotoPickerSearchCell.class
