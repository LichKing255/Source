    ...
    if (paramAlbumEntry != null)
    {
      ...
      if ((paramAlbumEntry.coverPhoto != null) && (paramAlbumEntry.coverPhoto.path != null))
      {
        ...
        if (paramAlbumEntry.coverPhoto.isVideo) {
          localAlbumView.imageView.setImage("vthumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2130838013));
        }
      }
      for (;;)
      {
        ...
        return;
        localAlbumView.imageView.setImage("thumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2130838013));
        continue;
        localAlbumView.imageView.setImageResource(2130838013);
      }
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\Cells\PhotoPickerAlbumsCell.class
