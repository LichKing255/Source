  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.imageView.setImageResource(2130837667);
    ...
    this.whatIsChannelText.setText(LocaleController.getString("ChannelAlertTitle", 2131165451));
    ...
    this.descriptionText.setText(LocaleController.getString("ChannelAlertText", 2131165450));
    ...
    this.createChannelText.setText(LocaleController.getString("ChannelAlertCreate", 2131165449));
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\ChannelIntroActivity.class
