  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.isGroup) {
      if (this.isAlwaysShare)
      {
        ...
        ((TextView)localObject).setText(LocaleController.getString("NoContacts", 2131166004));
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      ((TextInfoCell)paramView).setText(LocaleController.getString("RemoveFromListText", 2131166210));
      return paramView;
    }
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\PrivacyUsersActivity.class
