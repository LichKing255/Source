  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void showErrorAlert()
  {
    ...
    localBuilder.setMessage(LocaleController.getString("PrivacyFloodControlError", 2131166196));
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.isGroup) {
      this.actionBar.setTitle(LocaleController.getString("GroupsAndChannels", 2131165789));
    }
    for (;;)
    {
          ...
          if ((PrivacyControlActivity.this.currentType != 0) && (!PrivacyControlActivity.this.isGroup))
          {
            ...
            if (!localSharedPreferences.getBoolean("privacyAlertShowed", false))
            {
              ...
              if (PrivacyControlActivity.this.isGroup) {
                localBuilder.setMessage(LocaleController.getString("WhoCanAddMeInfo", 2131166474));
              }
              for (;;)
              {
                localBuilder.setTitle(LocaleController.getString("AppName", 2131165338));
                ...
                return;
                localBuilder.setMessage(LocaleController.getString("CustomHelp", 2131165586));
              }
            }
          }
          PrivacyControlActivity.this.applyCurrentPrivacySettings();
      ...
      this.actionBar.setTitle(LocaleController.getString("PrivacyLastSeen", 2131166197));
    }
  }
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        if (paramInt == PrivacyControlActivity.this.alwaysShareRow) {
          if (PrivacyControlActivity.this.currentPlus.size() != 0)
          {
            ...
            paramViewGroup = LocaleController.getString("AlwaysAllow", 2131165320);
      ...
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                ...
                paramView = LocaleController.getString("EmpryUsersPlaceholder", 2131165644);
                break;
                bool1 = false;
                break label120;
                paramViewGroup = LocaleController.getString("AlwaysShareWith", 2131165322);
                if (PrivacyControlActivity.this.neverShareRow != -1) {}
              ...
              for (paramView = LocaleController.formatPluralString("Users", PrivacyControlActivity.this.currentMinus.size()); PrivacyControlActivity.this.isGroup; paramView = LocaleController.getString("EmpryUsersPlaceholder", 2131165644))
              {
                localTextSettingsCell.setTextAndValue(LocaleController.getString("NeverAllow", 2131165982), paramView, false);
                return (View)localObject;
              }
              localTextSettingsCell.setTextAndValue(LocaleController.getString("NeverShareWith", 2131165984), paramView, false);
              return (View)localObject;
              if (i != 1) {
                break label453;
              }
              ...
              {
                if (PrivacyControlActivity.this.isGroup) {
                  ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("WhoCanAddMeInfo", 2131166474));
                }
                for (;;)
                {
                  ((View)localObject).setBackgroundResource(2130837799);
                  return (View)localObject;
                  ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("CustomHelp", 2131165586));
                }
              }
              paramViewGroup = (ViewGroup)localObject;
            } while (paramInt != PrivacyControlActivity.this.shareDetailRow);
            if (PrivacyControlActivity.this.isGroup) {
              ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("CustomShareInfo", 2131165587));
            }
            for (;;)
            {
              ((View)localObject).setBackgroundResource(2130837800);
              return (View)localObject;
              ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("CustomShareSettingsHelp", 2131165588));
            }
            if (i != 2) {
              break label574;
            }
            ...
            if (paramInt == PrivacyControlActivity.this.sectionRow)
            {
              if (PrivacyControlActivity.this.isGroup)
              {
                ((HeaderCell)localObject).setText(LocaleController.getString("WhoCanAddMe", 2131166473));
                return (View)localObject;
              }
              ((HeaderCell)localObject).setText(LocaleController.getString("LastSeenTitle", 2131165883));
              return (View)localObject;
            }
            paramViewGroup = (ViewGroup)localObject;
          } while (paramInt != PrivacyControlActivity.this.shareSectionRow);
          ((HeaderCell)localObject).setText(LocaleController.getString("AddExceptions", 2131165298));
          return (View)localObject;
        ...
        {
          paramViewGroup = LocaleController.getString("LastSeenEverybody", 2131165865);
        ...
        for (;;)
        {
          if (PrivacyControlActivity.this.lastCheckedType == i)
          {
            ...
            {
              paramViewGroup = LocaleController.getString("LastSeenContacts", 2131165860);
            ...
            {
              paramViewGroup = LocaleController.getString("LastSeenNobody", 2131165880);
...
/* Location:              C:\Users\Armandl\Downloads\Compressed\dex2jar-2.0\classes-dex2jar.jar!\org\telegram\ui\PrivacyControlActivity.class
